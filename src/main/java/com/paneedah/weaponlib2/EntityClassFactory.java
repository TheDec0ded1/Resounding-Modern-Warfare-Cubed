...
//        {
//            mv = cw.visitMethod(ACC_PUBLIC, "getConfiguration", "()Lcom/paneedah/weaponlib2/vehicle/EntityVehicleConfiguration;", null, null);
//            mv.visitCode();
//            Label l0 = new Label();
//            mv.visitLabel(l0);
//            mv.visitLineNumber(689, l0);
//            mv.visitVarInsn(ALOAD, 0);
//            mv.visitFieldInsn(GETFIELD, classResourceName, "configuration", "Lcom/paneedah/weaponlib2/vehicle/EntityVehicleConfiguration;");
//            Label l1 = new Label();
...
//            mv.visitVarInsn(ALOAD, 0);
//            mv.visitMethodInsn(INVOKESTATIC, "com/paneedah/weaponlib2/EntityClassFactory", "getInstance", "()Lcom/paneedah/weaponlib2/EntityClassFactory;", false);
//            mv.visitVarInsn(ALOAD, 0);
//            mv.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
//            mv.visitMethodInsn(INVOKEVIRTUAL, "com/paneedah/weaponlib2/EntityClassFactory", "getConfiguration", "(Ljava/lang/Class;)Lcom/paneedah/weaponlib2/EntityConfiguration;", false);
//            mv.visitTypeInsn(CHECKCAST, "com/paneedah/weaponlib2/vehicle/EntityVehicleConfiguration");
//            mv.visitFieldInsn(PUTFIELD, classResourceName, "configuration", "Lcom/paneedah/weaponlib2/vehicle/EntityVehicleConfiguration;");
//            mv.visitLabel(l1);
