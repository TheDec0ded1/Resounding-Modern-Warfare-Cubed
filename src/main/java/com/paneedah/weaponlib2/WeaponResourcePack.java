...
public class WeaponResourcePack implements IResourcePack {
	...
	private static final String weaponlib2_RESOURCE_DOMAIN = "weaponlib2";
	
	private static final Set<String> RESOURCE_DOMAINS = Collections.unmodifiableSet(new HashSet<>(
			Collections.singleton(weaponlib2_RESOURCE_DOMAIN)));
	...
	public boolean resourceExists(ResourceLocation resourceLocation) {
        ...
        boolean value = weaponlib2_RESOURCE_DOMAIN.equals(resourceLocation.getNamespace())
