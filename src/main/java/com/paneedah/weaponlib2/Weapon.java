...
import com.paneedah.weaponlib2.BulletHoleRenderer.BulletHole;
import com.paneedah.weaponlib2.animation.ScreenShakeAnimation;
import com.paneedah.weaponlib2.animation.ScreenShakingAnimationManager;
...
import com.paneedah.weaponlib2.crafting.*;
import com.paneedah.weaponlib2.model.Shell;
import com.paneedah.weaponlib2.render.WeaponSpritesheetBuilder;
...
AttachmentContainer, Reloadable, Inspectable, Modifiable, Updatable, IModernCrafting {
    ...
    public static class Builder {
        ...
        private static final String DEFAULT_SHELL_CASING_TEXTURE_NAME = "weaponlib2:/com/paneedah/weaponlib2/resources/shell.png";
       ...
       // String weight;
        ...
        private com.paneedah.weaponlib2.render.shells.ShellParticleSimulator.Shell.Type shellType = Type.ASSAULT;
...
//        private Map<RenderableState, ScreenShaking> screenShakings = new HashMap<>();
       ...
       /* public Builder withWeight(String weight) {
        ...
        public Weapon build(ModContext modContext) {
            ...
            /*if (weight == null) {
                throw new IllegalStateException("Weapon weight not provided");
            } */
   ...
   /* public int weightInternal = Integer.parseInt(getWeight()); */
   ...
   /* @Override
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
        ...
        if(slot == EntityEquipmentSlot.MAINHAND || slot == EntityEquipmentSlot.OFFHAND){
            map.put(SharedMonsterAttributes.MOVEMENT_SPEED.getName(), new AttributeModifier(UUID.fromString("91AEAA56-376B-4498-935B-2F7F68070635"), "Integral Weight", this.weightInternal, 1));
        }
        return map;
    } */
    ...
    public float getSpawnEntityDamageLocal() {
