package com.paneedah.weaponlib2.render.bgl;
...
import com.paneedah.weaponlib2.particle.ParticleFancyRain;
import com.paneedah.weaponlib2.render.Bloom;
import com.paneedah.weaponlib2.render.DepthTexture;
import com.paneedah.weaponlib2.render.HDRFramebuffer;
import com.paneedah.weaponlib2.render.Shaders;
import com.paneedah.weaponlib2.render.bgl.weather.ModernWeatherRenderer;
...
public class PostProcessPipeline {
	...
	*/
	...
	private static final float BASE_FOG_INTENSITY = 0.1f;
