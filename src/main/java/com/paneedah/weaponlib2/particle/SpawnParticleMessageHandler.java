package com.paneedah.weaponlib2.particle;
...
public class SpawnParticleMessageHandler implements IMessageHandler<SpawnParticleMessage, IMessage> {
    ...
    private static final String REGULAR_SMOKE_TEXTURE = "weaponlib2:/com/paneedah/weaponlib2/resources/large-smoke.png";
    
    private static final String YELLOW_SMOKE_TEXTURE = "weaponlib2:/com/paneedah/weaponlib2/resources/large-yellow-smoke.png";
