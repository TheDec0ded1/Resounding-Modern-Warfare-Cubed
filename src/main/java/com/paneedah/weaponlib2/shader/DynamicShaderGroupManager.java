package com.paneedah.weaponlib2.shader;

import com.google.gson.JsonSyntaxException;
import com.paneedah.weaponlib2.PlayerItemInstance;
import com.paneedah.weaponlib2.TransformingResourceManager;
import com.paneedah.weaponlib2.TransformingTextureManager;
...
public class DynamicShaderGroupManager {
    ...
    private static final String PATH_RESOURCES = "/com/paneedah/weaponlib2/resources/";
    private static final String PATH_SHADER_PROGRAMS = PATH_RESOURCES + "shaders/programs/";

    private static final String RESOURCE_DOMAIN_weaponlib2 = "weaponlib2";
    private static final String RESOURCE_DOMAIN_TEXTURES_EFFECT_weaponlib2 = "textures/effect/" + RESOURCE_DOMAIN_weaponlib2;
    private static final String RESOURCE_DOMAIN_SHADERS_PROGRAM_weaponlib2 = "shaders/program/" + RESOURCE_DOMAIN_weaponlib2;
...
//    }
    ...
    private static ResourceLocation modifyResourceLocation(ResourceLocation resourceLocation) {
        ...
        case RESOURCE_DOMAIN_weaponlib2:
            if(resourceLocation.getPath().startsWith("shaders/program/")) {
                result = new ResourceLocation(RESOURCE_DOMAIN_weaponlib2, PATH_SHADER_PROGRAMS 
            ...
            break;
        case RESOURCE_DOMAIN_SHADERS_PROGRAM_weaponlib2:
            result = new ResourceLocation(RESOURCE_DOMAIN_weaponlib2, PATH_SHADER_PROGRAMS
                    + resourceLocation.getPath());
            break;
        case RESOURCE_DOMAIN_TEXTURES_EFFECT_weaponlib2:
            result = new ResourceLocation(RESOURCE_DOMAIN_weaponlib2, PATH_RESOURCES + resourceLocation.getPath());
            break;
        default:
            result = resourceLocation;
        }
