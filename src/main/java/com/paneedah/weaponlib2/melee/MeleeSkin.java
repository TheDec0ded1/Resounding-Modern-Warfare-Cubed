...
import com.paneedah.weaponlib2.model.FlatModel;
...
public class MeleeSkin extends ItemAttachment<ItemMelee> {
	...
	public MeleeSkin(AttachmentCategory category, ModelBase model, String textureName, String crosshair,
			com.paneedah.weaponlib2.ItemAttachment.ApplyHandler<ItemMelee> apply,
			com.paneedah.weaponlib2.ItemAttachment.ApplyHandler<ItemMelee> remove) {
