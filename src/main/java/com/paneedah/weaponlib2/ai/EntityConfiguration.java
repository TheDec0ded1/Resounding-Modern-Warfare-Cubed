...
import com.paneedah.weaponlib2.config.AIEntity;
...
public class EntityConfiguration {
    ...
    public static class Builder {
        ...
        public void register(ModContext context) {
            ...
            if (entityConfig.getName().equalsIgnoreCase("terrorist") || entityConfig.getName().equalsIgnoreCase("soldier") || entityConfig.getName().equalsIgnoreCase("survivor") || entityConfig.getName().equalsIgnoreCase("swat_officer")) {
