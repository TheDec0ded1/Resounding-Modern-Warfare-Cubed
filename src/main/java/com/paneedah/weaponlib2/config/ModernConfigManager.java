...
//	 Fixing Method
	...
	public static double soldierspawn = 0.5;
	...
	@RangeDouble(min=0, max=1.0)
	@ConfigSync(category = CATEGORY_ENTITIES, comment = "How much should soldiers spawn?")
	public static double survivorspawn = 0.5;

	@RangeDouble(min=0.1, max=2.0)
	@ConfigSync(category = CATEGORY_ENTITIES, comment = "How much health should soldiers have?")
	public static double survivorHealth = 1.0;

	@RangeDouble(min=0, max=1.0)
	@ConfigSync(category = CATEGORY_ENTITIES, comment = "How much should soldiers spawn?")
	public static double swat_officerspawn = 0.5;

	@RangeDouble(min=0.1, max=2.0)
	@ConfigSync(category = CATEGORY_ENTITIES, comment = "How much health should soldiers have?")
	public static double swat_officerHealth = 1.0;
	...
	public static final Map<String, AIEntity> aiEntities = new LinkedHashMap<String, AIEntity>(){{
		...
		put("survivor", new AIEntity("survivor", ModernConfigManager.survivorHealth, ModernConfigManager.survivorspawn));
		put("swat_officer", new AIEntity("swat_officer", ModernConfigManager.swat_officerHealth, ModernConfigManager.swat_officerspawn));
	}};
