...
public class GM6_LynxFactory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.GM6_LynxAction, true, (model) -> {
//        	GL11.glTranslatef(0f, 0f, 0.8f);
        	
//            GL11.glTranslatef(0F, 0F, 1.5F);
        })
        .withCompatibleAttachment(Magazines.M99Mag, (model) -> {
...
//            GL11.glScaled(1.5F, 1.5F, 1.5F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new GM6_Lynx())
            .withActionPiece(AuxiliaryAttachments.GM6_LynxAction)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("m82", AuxiliaryAttachments.GM6_LynxAction)
                .setupModernMagazineAnimations("m82", 
                		Magazines.M99Mag)
            
            .withFirstPersonCustomPositioning(Magazines.M99Mag, (renderContext) -> {
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.GM6_LynxAction.getRenderablePart(),
