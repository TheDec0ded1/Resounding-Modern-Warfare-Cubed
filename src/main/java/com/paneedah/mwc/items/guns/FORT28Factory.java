...
public class FORT28Factory implements GunFactory {
...
//         .withInaccuracy(3)
        ...
        .withCompatibleAttachment(Attachments.Fort28Slide, true, (model) -> {
...
//                GL11.glTranslatef(0F, 0F, 0.5F);
        ...
        .withTextureNames("fort28")
        .withRenderer(new WeaponRenderer.Builder()
            
            .withModel(new Fort28Body())
            .withActionPiece(
            		Attachments.Fort28Slide)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("fiveseven", Attachments.Fort28Slide)
                .setupModernMagazineAnimations("fiveseven", 
                		Magazines.FiveSevenMag, Magazines.FiveSeven30Mag, Magazines.FiveSevenDrumMag)
                
            .withFirstPersonCustomPositioning(Attachments.Fort28Slide.getRenderablePart(), (renderContext) -> {
