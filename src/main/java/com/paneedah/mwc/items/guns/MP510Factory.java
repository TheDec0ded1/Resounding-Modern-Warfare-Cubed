...
public class MP510Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.MP5NavyHandGuard, (model) -> {
        })
        .withCompatibleAttachment(Attachments.MP5A5HandGuard, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MP5A1HandGuard, true, (model) -> {
        })
...
//            GL11.glRotatef(-25F, 0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Magazines.MP510Mag, (model) -> {
//        	GL11.glTranslatef(3.3F, 3.9F, -2F);
//         	 GL11.glRotatef(-35F, 0f, 0f, 1f);
//         	 GL11.glRotatef(30F, 1f, 0f, 0f);
        })
        .withCompatibleAttachment(Magazines.MP510PaleMag, (model) -> {
//        	GL11.glTranslatef(3.3F, 3.9F, -2F);
//         	 GL11.glRotatef(-35F, 0f, 0f, 1f);
//         	 GL11.glRotatef(30F, 1f, 0f, 0f);
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernMagazineAnimations("mp5", 
                		Magazines.MP510Mag, Magazines.MP510PaleMag)
            ...
            .withFirstPersonCustomPositioning(Magazines.MP510Mag, (renderContext) -> {
