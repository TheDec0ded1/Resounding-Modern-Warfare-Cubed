...
public class K1AFactory implements GunFactory {
...
//		.withShellCasingEjectEnabled(false)
        ...
        .withCompatibleAttachment(Attachments.K1AHG, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments.K1AStock, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
