...
public class MP5kPDWFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments2.MP5kNavyHandGuard, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MP5kHandGuard, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MP5kBackplate, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MP5kStock, true, (model) -> {
        })
...
//          GL11.glRotatef(-25F, 0f, 0f, 1f);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.MP5kboltaction, true, (model) -> {
//            GL11.glTranslatef(0.45F, -0.15F, 0.65F);
//            GL11.glRotatef(-25F, 0f, 0f, 1f);
        })
...
//         	 GL11.glRotatef(30F, 1f, 0f, 0f);
        ...
        .withCompatibleAttachment(Magazines.MP5A1Mag, (model) -> {
//        	GL11.glTranslatef(3.3F, 3.9F, -2F);
//         	 GL11.glRotatef(-35F, 0f, 0f, 1f);
//         	 GL11.glRotatef(30F, 1f, 0f, 0f);
        })
...
//            GL11.glScaled(1F, 1F, 1.1F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glTranslatef(-0.043F, -1.15F, -2.47F);
                GL11.glScaled(0.4F, 0.47F, 1.8F);
                GL11.glRotatef(-90F, 1f, 0f, 0f);
                GL11.glRotatef(-180F, 0f, 1f, 0f);
            } else if(model instanceof G36CIron2) {
                GL11.glTranslatef(-0.192F, -1.37F, -2.6F);
        ...
        .withCompatibleAttachment(Attachments3.Silencer9mm, (model) -> {
            GL11.glTranslatef(-0.2F, -1.08F, -4.5F);
            GL11.glScaled(1F, 1F, 1F);
        })
        .withTextureNames("mp5")
        .withRenderer(new WeaponRenderer.Builder()
    
            .withModel(new mp5kpdw())
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("mp5", AuxiliaryAttachments.MP5kboltaction)
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.MP5kboltaction.getRenderablePart(),
