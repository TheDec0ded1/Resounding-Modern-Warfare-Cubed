...
public class VSSKOFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.VSSKOStock, true, (model) -> {
        })
        ...
        .withCompatibleAttachment(Attachments.VSSVintorezHandguard, (model) -> {
        })
        .withCompatibleAttachment(Attachments.ASValHandguard, true, (model) -> {
        })
