...
//          GL11.glScaled(0F, 0F, 0F);
        ...
        .withCompatibleAttachment(Attachments2.M93RBody, true, (model) -> {
//            GL11.glTranslatef(0.01f, -0.19f, -0.4f);
//            GL11.glScaled(0F, 0F, 0F);
        })
        .withCompatibleAttachment(Attachments2.M93RStock, true, (model) -> {
//            GL11.glTranslatef(0.01f, -0.19f, -0.4f);
//            GL11.glScaled(0F, 0F, 0F);
        })
        .withCompatibleAttachment(Attachments2.M93RSlide, true, (model) -> {
            if(model instanceof M93RSlide) {
                GL11.glScaled(1F, 1F, 1F);
//                GL11.glTranslatef(0F, 0F, 0.5F);
            }
            else if(model instanceof M93Rrearsight) {
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("m9", Attachments2.M93RSlide)
                .setupModernMagazineAnimations("m9", Magazines.M9A1Mag)
                
            .withFirstPersonPositioningCustomRecoiled(Attachments2.M93RSlide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(Attachments2.M93RSlide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonCustomPositioning(Attachments2.M93RSlide.getRenderablePart(), (renderContext) -> {
...
//          	 GL11.glRotatef(-20F, 0f, 0f, 1f);
            ...
            .withThirdPersonCustomPositioningReloading(Attachments2.M93RSlide.getRenderablePart(),
