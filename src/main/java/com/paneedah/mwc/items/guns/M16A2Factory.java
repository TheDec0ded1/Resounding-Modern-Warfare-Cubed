...
public class M16A2Factory implements GunFactory {
...
//            GL11.glScaled(1F, 1F, 0.85F);
        ...
        .withCompatibleAttachment(Attachments2.M16A2Receiver, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments3.M16A1RearSights, true, (model) -> {
