...
public class QBU88Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
       ...
       .withUnremovableAttachmentCategories(AttachmentCategory.FRONTSIGHT)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.QBU88Action, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBU88Body, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBU88Upper, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBU97Body, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBU88Dustcover, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBU88IronsUpright, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBU88IronsFolded, (model) -> {
        })
        .withCompatibleAttachment(Magazines.QBU88Mag, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBU88Bipod, true, (model) -> {
        })
        ...
        .withTextureNames("qbu88")
        .withRenderer(new WeaponRenderer.Builder()

            .withModel(new QBU88())
            .withActionPiece(AuxiliaryAttachments.QBU88Action)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("qbu88", AuxiliaryAttachments.QBU88Action)
                .setupModernMagazineAnimations("qbu88", 
                		Magazines.QBU88Mag)
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.QBU88Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.QBU88Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.QBU88Action.getRenderablePart(),
