...
public class ASh12Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        //.withMaxShots(5)
        .withShootSound("ash12")
        .withSilencedShootSound("ash12_silenced")
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.ASh_12Action, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASh_12Silencer, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ShAK_12Silencer, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASh_12MuzzleBrake, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASh_12Handguard, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASh_12Upper, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASh_12Lower, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASh_12Irons, true, (model) -> {
        })
        .withCompatibleAttachment(Magazines.ASh_12Mag10, (model) -> {
        })
        .withCompatibleAttachment(Magazines.ASh_12Mag20, (model) -> {
        })
        .withCompatibleAttachment(Magazines.ShAK_12Mag10, (model) -> {
        })
        .withCompatibleAttachment(Magazines.ShAK_12Mag20, (model) -> {
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new M9A1())
            .withActionPiece(AuxiliaryAttachments.ASh_12Action)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("ash12", AuxiliaryAttachments.ASh_12Action)
                .setupModernMagazineAnimations("ash12", 
                		Magazines.ASh_12Mag10,
                		Magazines.ASh_12Mag20,
                		Magazines.ShAK_12Mag10,
                		Magazines.ShAK_12Mag20   
)
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.ASh_12Action.getRenderablePart(),
...
//                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
             ...
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments2.ASh_12Irons)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.34f, -0.8f);
                } 
