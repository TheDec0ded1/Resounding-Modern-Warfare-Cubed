...
//        .withUnremovableAttachmentCategories(AttachmentCategory.RAILING)
        ...
        .withCompatibleAttachment(Attachments2.AN94Stock, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.AN94GreenStock, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.AN94, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.AN94Green, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
...
//            GL11.glScaled(1.15F, 1.2F, 1.15F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
                ...
                .withModel(new M9A1())
                .withActionPiece(AuxiliaryAttachments.AN94Action)
                ...
                .withFirstPersonPositioning(
                    ...
                    .setupModernAnimations("ak12", AuxiliaryAttachments.AN94Action)
