...
public class FORT500Factory implements GunFactory {
...
//      .withAmmo(CommonProxy.Remington870Mag)
        ...
        .withIteratedLoad()
        .withEjectSpentRoundSound("fort500_pump")
        .withFireRate(0.1f)
        .withRecoil(15f)
        .withZoom(0.9f)
        ...
        .withCompatibleAttachment(Attachments2.FORT500Pump, true, (model) -> {
...
//            GL11.glTranslatef(0F, 0F, 1F);
          ...
          .withCompatibleAttachment(Attachments.Remington870FABDefensePump, (player, stack) -> {
            ...
            .withCompatibleAttachment(Attachments2.FORT500Barrel, true, (player, stack) -> {
      //        GL11.glTranslatef(-0.14F, -0.58F, -4.1F);
      //        GL11.glScaled(1F, 1F, 1F);
            },(model) -> {
            ...
            .withCompatibleAttachment(Attachments2.FORT500MBarrel, (player, stack) -> {
      //        GL11.glTranslatef(-0.14F, -0.58F, -4.1F);
      //        GL11.glScaled(1F, 1F, 1F);
            },(model) -> {
                if(model instanceof M9A1frontsight) {
      ...
      //        GL11.glScaled(1F, 1F, 1F);
            ...
            .withCompatibleAttachment(Attachments2.FORT500Stock, true, (model) -> {
      //        GL11.glTranslatef(-0.14F, -0.58F, -4.1F);
      //        GL11.glScaled(1F, 1F, 1F);
            })
            .withCompatibleAttachment(Attachments2.FORT500Grip, (model) -> {
      //        GL11.glTranslatef(-0.14F, -0.58F, -4.1F);
      //        GL11.glScaled(1F, 1F, 1F);
            })
...
//              GL11.glTranslatef(0F, 0F, 0.75F);
        ...
        .withTextureNames("fort500")
        .withRenderer(new WeaponRenderer.Builder()
    
            .withModel(new FORT500())
...
//              // Holo Zoom
             ...
             // Holo Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments3.HP)) {
                    //System.out.println("Position me for Holo");
            ...
            .withFirstPersonCustomPositioning(Attachments2.FORT500Pump.getRenderablePart(), (renderContext) -> {
//              GL11.glTranslatef(0F, 0F, 0.8F);
                })
                
            .withFirstPersonCustomPositioningLoadIterationCompleted(Attachments2.FORT500Pump.getRenderablePart(), (renderContext) -> {
                })
...
//                GL11.glRotatef(-70F, 1f, 0f, 0f);
            ...
            .withFirstPersonCustomPositioningLoadIterationCompleted(AuxiliaryAttachments.ShotgunShell.getRenderablePart(), (renderContext) -> {
              ...
              .withFirstPersonCustomPositioningEjectSpentRound(Attachments2.FORT500Pump.getRenderablePart(),
                      new Transition((renderContext) -> { // Reload position
                      	GL11.glTranslatef(0F, 0F, 0.8F);
              ...
              .withFirstPersonCustomPositioningEjectSpentRound(Attachments3.Grip2.getRenderablePart(),
                      new Transition((renderContext) -> { // Reload position
                      	GL11.glTranslatef(0F, 0F, 0.75F);
              ...
              .withFirstPersonCustomPositioningEjectSpentRound(Attachments3.StubbyGrip.getRenderablePart(),
                      new Transition((renderContext) -> { // Reload position
                      	GL11.glTranslatef(0F, 0F, 0.75F);
              ...
              .withFirstPersonCustomPositioningEjectSpentRound(Attachments3.VGrip.getRenderablePart(),
                      new Transition((renderContext) -> { // Reload position
                      	GL11.glTranslatef(0F, 0F, 0.75F);
              ...
              .withFirstPersonCustomPositioningEjectSpentRoundAimed(Attachments2.FORT500Pump.getRenderablePart(),
              		new Transition((renderContext) -> { // Reload position
                      	GL11.glTranslatef(0F, 0F, 0.8F);
              ...
              .withFirstPersonCustomPositioningAllLoadIterationsCompleted(Attachments2.FORT500Pump.getRenderablePart(),
                  new Transition((renderContext) -> { // Reload position\
                  }, 250, 50),
              ...
              .withFirstPersonCustomPositioningAllLoadIterationsCompleted(Attachments3.Grip2.getRenderablePart(),
                      new Transition((renderContext) -> { // Reload position\
                      }, 250, 50),
              ...
              .withFirstPersonCustomPositioningAllLoadIterationsCompleted(Attachments3.StubbyGrip.getRenderablePart(),
                      new Transition((renderContext) -> { // Reload position\
                      }, 250, 50),
              ...
              .withFirstPersonCustomPositioningAllLoadIterationsCompleted(Attachments3.VGrip.getRenderablePart(),
                      new Transition((renderContext) -> { // Reload position\
                      }, 250, 50),
            ...
            .withThirdPersonCustomPositioningReloading(Attachments2.FORT500Pump.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
...
//              // Holo Zoom
            ...
            .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         if(activeAttachment == Attachments3.Grip2 || 
                                 activeAttachment == Attachments3.StubbyGrip ||
                                 activeAttachment == Attachments3.VGrip) {
