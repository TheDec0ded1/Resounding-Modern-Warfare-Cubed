...
public class SL8Factory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.SL8CH, true, (model) -> {
        })
        ...
        .withCompatibleAttachment(Attachments.SL8WeatheredBody, true, (model) -> {
        //    GL11.glTranslatef(0.01f, -0.19f, -0.4f);
       //     GL11.glScaled(0F, 0F, 0F);
        })
        .withCompatibleAttachment(Attachments.SL8BlackBody, (model) -> {
        //    GL11.glTranslatef(0.01f, -0.19f, -0.4f);
       //     GL11.glScaled(0F, 0F, 0F);
        })
        .withCompatibleAttachment(Attachments.SL8Body, (model) -> {
        //    GL11.glTranslatef(0.01f, -0.19f, -0.4f);
       //     GL11.glScaled(0F, 0F, 0F);
        })
        .withCompatibleAttachment(Magazines.SL8Mag, (model) -> {
