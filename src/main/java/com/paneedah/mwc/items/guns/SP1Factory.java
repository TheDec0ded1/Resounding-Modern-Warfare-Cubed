...
public class SP1Factory implements GunFactory {
...
//      .withShellCasingForwardOffset(0.001f)
        ...
        .withCompatibleAttachment(Attachments.SP1Body, true, (model) -> {
//            GL11.glTranslatef(0.01f, -0.19f, -0.4f);
//            GL11.glScaled(0F, 0F, 0F);
        })
        .withCompatibleAttachment(Attachments.SP1Slide, true, (model) -> {
...
//            GL11.glTranslatef(0F, 0.2F, 0.12F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("m9", Attachments.SP1Slide)
                .setupModernMagazineAnimations("m9", Magazines.M9A1Mag)
                
            .withFirstPersonPositioningCustomRecoiled(Attachments.SP1Slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(Attachments.SP1Slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonCustomPositioning(Attachments.SP1Slide.getRenderablePart(), (renderContext) -> {
