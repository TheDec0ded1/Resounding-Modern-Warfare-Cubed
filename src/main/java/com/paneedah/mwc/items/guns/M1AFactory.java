...
//        	GL11.glTranslatef(0f, 0f, 0.73f);
        ...
        .withCompatibleAttachment(Attachments.M14Body, (model) -> {
...
//                GL11.glScaled(1F, 1F, 1F);
        ...
        .withCompatibleAttachment(Attachments.M14ClassicBody, true, (model) -> {
...
//                GL11.glScaled(1F, 1F, 1F);
        ...
        .withCompatibleAttachment(Attachments.M14Cover, (model) -> {
...
//          GL11.glScaled(1F, 1F, 1F);
        ...
        .withCompatibleAttachment(Attachments.M14BrownCover, true, (model) -> {
//          GL11.glTranslatef(-0.2F, -1.3F, -9F);
//          GL11.glScaled(1F, 1F, 1F);
        })
...
//            GL11.glRotatef(-15F, 1f, 0f, 0f);
        ...
        .withCompatibleAttachment(Attachments3.Silencer762x51, renderContext -> {
...
//                	GL11.glTranslatef(-0.2F, -1.06F, -8.8F);
        ...
        .withCompatibleAttachment(Attachments3.M14Bipod, (model) -> {
        })
