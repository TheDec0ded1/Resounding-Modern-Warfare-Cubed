...
public class ScarSCFactory implements GunFactory {
	...
	public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments2.SCARSCHandguard, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments.ScarStock, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.MK20Stock, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments.ScarHStock, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
      })
        .withCompatibleAttachment(Attachments.ScarRetractableStock, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.MK20StockB, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.ScarRetractableStockB, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
...
//               GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(Attachments2.SCARSCUpper, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.SCARSCUpperB, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.SCARSCBody, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.SCARSCBodyB, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
...
//            GL11.glTranslatef(0F, 0.35F, 0F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.SCARSCAction, true, (model) -> {
//        	 GL11.glTranslatef(0F, 0F, 0.2F);
         ...
         .withCompatibleAttachment(Attachments3.AKMIron, true, (model) -> {
             if(model instanceof M4Iron1) {
                 ...
                 GL11.glTranslatef(-0.085F, -1.67F, -3.15F);
                 GL11.glScaled(0.45F, 0.45F, 0.45F);
             } else if(model instanceof FALIron) {
                 GL11.glTranslatef(-0.11F, -1.78F, -3.1F);
...
//          GL11.glRotatef(180F, 0f, 1f, 0f);
        ...
        .withCompatibleAttachment(Attachments3.Silencer556x45, (model) -> {
            GL11.glTranslatef(-0.2F, -1.18F, -5.75F);
            GL11.glScaled(1F, 1F, 1F);
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new M9A1())
            .withActionPiece(AuxiliaryAttachments.SCARSCAction)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("scar", AuxiliaryAttachments.SCARSCAction)
