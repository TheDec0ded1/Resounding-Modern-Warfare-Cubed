...
public class PP19VityazFactory {
...
//        .withAmmoCapacity(30)
        ...
        //.withMaxShots(5)
        .withShootSound("pp19vityaz")
        .withSilencedShootSound("pp19v_silenced")
...
//        .withUnremovableAttachmentCategories(AttachmentCategory.RAILING)
        .withCompatibleAttachment(Attachments2.MPIKMHandguard, (model) -> {
        ...
        .withCompatibleAttachment(Attachments2.AIMSHandguard, (model) -> {
            GL11.glTranslatef(0f, 0f, 0.4f);
      })
        .withCompatibleAttachment(Attachments2.AK47BlondeHandguard, (model) -> {
            GL11.glTranslatef(0f, 0f, 0.4f);
      })
        ...
        .withCompatibleAttachment(Attachments2.Type562Handguard, (model) -> {
            GL11.glTranslatef(0f, 0f, 0.4f);
      })
...
//            GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Attachments2.PP19VityazDC, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.PP19VityazSNDC, (model) -> {
        })
...
//          GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.PP19VityazAction, true, (model) -> {
        })
        .withCompatibleAttachment(Magazines.PP19VityazMag, (model) -> {
        })
        .withCompatibleAttachment(Attachments.AKIron, true, (model) -> {
            if(model instanceof AKiron3) {
                GL11.glTranslatef(-0.195F, -1.11F, -4.2F);
                GL11.glScaled(0.9F, 0.55F, 0.5F);
            } else if(model instanceof AKMiron2) {
                GL11.glTranslatef(-0.185F, -1.35F, -4.2F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glTranslatef(-0.184F, -1.32F, -6F);
                GL11.glScaled(0F, 0F, 0F);
            } else if(model instanceof AK47iron) {
                GL11.glTranslatef(-0.25F, -1.65F, -2.55F);
        ...
        .withTextureNames("ak103bp")
        .withRenderer(new WeaponRenderer.Builder()
                
                .withModel(new PP19Vityaz())
                .withActionPiece(AuxiliaryAttachments.PP19VityazAction)
                ...
                .withFirstPersonPositioning(
                    ...
                    .setupModernAnimations("ak47", AuxiliaryAttachments.PP19VityazAction)
                    .setupModernMagazineAnimations("ak47", 
                    		Magazines.PP19VityazMag)
                
                .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.PP19VityazAction.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
                    
                .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.PP19VityazAction.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
...
//                    }, 100, 0)
                ...
                .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.PP19VityazAction.getRenderablePart(),
