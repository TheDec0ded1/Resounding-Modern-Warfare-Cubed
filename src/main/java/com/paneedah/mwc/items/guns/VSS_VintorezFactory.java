...
public class VSS_VintorezFactory {
    ...
    .withCompatibleAttachment(AuxiliaryAttachments.VSS_Action, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.AS_Dustcover, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSS_Dustcover, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.SR3M_Dustcover, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSS_Stock, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSSKO_Stock, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSSM_Stock, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSSM_StockM, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSS_Handguard, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.AS_Handguard, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASM_Handguard, (model) -> {
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new VSS_Vintorez())
            .withActionPiece(AuxiliaryAttachments.VSS_Action)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("asval", AuxiliaryAttachments.VSS_Action)
                ...
                .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.VSS_Action.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.VSS_Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.VSS_Action.getRenderablePart(),
