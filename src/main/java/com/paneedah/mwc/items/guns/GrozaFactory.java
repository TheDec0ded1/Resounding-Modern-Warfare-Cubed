...
public class GrozaFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withSilencedShootSound("groza_silenced")
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Grozaaction, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Magazines.GrozaMag, (model) -> {
        })
...
//          GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(Attachments2.SilencerGroza, renderContext -> {
        })
        .withTextureNames("groza")
        .withRenderer(new WeaponRenderer.Builder()
            
            .withModel(new groza())
            .withActionPiece(AuxiliaryAttachments.Grozaaction)
...
//                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
             ...
             // ACOG Zoom
                ...
                // Everything else
                      ...
                      GL11.glTranslatef(0F, 0.40f, 0.30f);
                }
