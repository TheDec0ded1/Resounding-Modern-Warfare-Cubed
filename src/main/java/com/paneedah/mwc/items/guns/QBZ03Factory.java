...
//        .withSpawnEntityModelTexture(ammoModelTextureName)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.QBZ03Action, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBZ03Handguard, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBZ03Upper, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBZ03Grip, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBZ03Stock, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBZ03_556Handguard, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.QBZ03_556Upper, (model) -> {
        })
        .withCompatibleAttachment(Magazines.QBZ03Mag, (model) -> {
        })
       
        .withTextureNames("qbz03")
        .withRenderer(new WeaponRenderer.Builder()
                
                .withModel(new QBZ03())
                .withActionPiece(AuxiliaryAttachments.QBZ03Action)
                ...
                .withFirstPersonPositioning(
                    ...
                    .setupModernAnimations("qbz03", AuxiliaryAttachments.QBZ03Action)
                    .setupModernMagazineAnimations("qbz03", 
                    		Magazines.QBZ03Mag)
                
                .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.QBZ03Action.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
                    
                .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.QBZ03Action.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
...
//                    }, 100, 0)
                ...
                .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.QBZ03Action.getRenderablePart(),
