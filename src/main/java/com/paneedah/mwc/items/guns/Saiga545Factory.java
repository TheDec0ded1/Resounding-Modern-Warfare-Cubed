...
//        .withSpawnEntityModelTexture(ammoModelTextureName)
        ...
        .withCompatibleAttachment(Attachments2.SaigaSporterPolymerStock, true, (model) -> {
      }) 
       .withCompatibleAttachment(Attachments2.SaigaSporterWoodenStock, (model) -> {
      })
...
//          GL11.glTranslatef(0f, 0f, 1f);
  	...
  	.withCompatibleAttachment(Attachments2.SaigaSporterPolymerHG, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
  	.withCompatibleAttachment(Attachments2.SaigaSporterWoodenHG, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments.AK101DustCover, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.SaigaSporterDC, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.SaigaSporterAction, true, (model) -> {
        })
        .withCompatibleAttachment(Magazines.AK74Mag, (model) -> {
//          GL11.glTranslatef(-0.35F, 0.5F, -1.25F);
//            GL11.glScaled(1.15F, 1.2F, 1.15F);
        })
        .withCompatibleAttachment(Magazines.Saiga545Mag, (model) -> {
//          GL11.glTranslatef(-0.35F, 0.5F, -1.25F);
//            GL11.glScaled(1.15F, 1.2F, 1.15F);
        })
...
//            GL11.glScaled(1.15F, 1.2F, 1.15F);
        ...
        .withTextureNames("saigasporter")
        .withRenderer(new WeaponRenderer.Builder()
                
                .withModel(new SaigaSporter())
                .withActionPiece(AuxiliaryAttachments.SaigaSporterAction)
                ...
                .withFirstPersonPositioning(
                    ...
                    .setupModernAnimations("saigasporter", AuxiliaryAttachments.SaigaSporterAction)
                    .setupModernMagazineAnimations("saigasporter", 
                    		Magazines.AK74Mag,
                    		Magazines.Saiga545Mag,
                    		Magazines.RPK74Mag,
                ...
                .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.SaigaSporterAction.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
                    
                .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.SaigaSporterAction.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
...
//                    }, 100, 0)
                ...
                .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.SaigaSporterAction.getRenderablePart(),
