...
//          GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Attachments2.RPK74Stock, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
...
//          GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Attachments2.RPK74Handguard, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
      })
...
//          GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(Attachments.RPKBarrel, true, (model) -> {
...
//            GL11.glScaled(1.15F, 1.2F, 1.15F);
        ...
        .withCompatibleAttachment(Attachments3.Silencer545x39, renderContext -> {
