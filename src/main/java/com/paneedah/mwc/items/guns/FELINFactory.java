...
public class FELINFactory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()

        .withName("felin_famas")
        .withFireRate(0.8f)
        .withRecoil(2.5f)
        .withZoom(0.9f)
...
//            GL11.glTranslatef(0f, 0f, -0f);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new FELIN())
           .withActionPiece(AuxiliaryAttachments.FELINAction)
          .withActionTransform(new Transform().withPosition(0, 0, 1))
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("famas", AuxiliaryAttachments.FELINAction)
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.FELINAction.getRenderablePart(),
