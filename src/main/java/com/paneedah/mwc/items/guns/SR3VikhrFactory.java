...
public class SR3VikhrFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.SR3VikhrDC, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments.SR3VikhrStock, true, (model) -> {
        })
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.SR3VikhrAction.getRenderablePart(),
