...
public class AK47T2Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments2.AK47T2BlondeStock, (model) -> {
      })
        ...
        .withCompatibleAttachment(Attachments2.AK47T2Stock, true, (model) -> {
