...
public class G36CRALFactory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.G36S, (model) -> {
        })
        .withCompatibleAttachment(Attachments.G36KVS, (model) -> {
        })
        .withCompatibleAttachment(Attachments.G36IDZS, (model) -> {
        })
        .withCompatibleAttachment(Attachments.G36CH, (model) -> {
        })
        .withCompatibleAttachment(Attachments.G36IDZCH, (model) -> {
        })
        .withCompatibleAttachment(Attachments.G36CRHG, (model) -> {
        })
        .withCompatibleAttachment(Attachments.G36SRAL, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments.G36KVSRAL, (model) -> {
        })
        .withCompatibleAttachment(Attachments.G36IDZSRAL, (model) -> {
        })
        ...
        .withCompatibleAttachment(Attachments.G36CHG, (model) -> {
        //    GL11.glTranslatef(0.01f, -0.19f, -0.4f);
       //     GL11.glScaled(0F, 0F, 0F);
        })
        .withCompatibleAttachment(Attachments.G36CHGRAL, true, (model) -> {
        //    GL11.glTranslatef(0.01f, -0.19f, -0.4f);
       //     GL11.glScaled(0F, 0F, 0F);
        })
...
//            GL11.glTranslatef(0F, 0F, 0.75F);
        ...
        .withCompatibleAttachment(Attachments.HKV, (player, stack) -> {
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
             ...
             // ACOG Zoom
                ...
                // HKV Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.HKV)) {
                    //System.out.println("Position me for HKV");
