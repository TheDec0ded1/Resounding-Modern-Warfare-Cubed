...
public class MiniUziFactory implements GunFactory {
...
//         .withInaccuracy(3)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.MiniUziAction, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.MiniUziHandle, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MicroUziGrip, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MiniUziGrip, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.UziGrip, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MiniUziStock, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MiniUziHandguard, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.UziSuppressor, (model) -> {
        })
        .withTextureNames("miniuzi")
        .withRenderer(new WeaponRenderer.Builder()
            
            .withModel(new MiniUzi())
            .withActionPiece(AuxiliaryAttachments.MiniUziAction)
            ...
            .withFirstPersonPositioning(
                ...
                .withFirstPersonHandPositioning(
                        ...
                        // Left hand
			new Transform()
			.withPosition(1.210000f, 0.265000f, 0.920000f)
			...
			.withScale(2.800000f, 2.800000f, 4.000000f),
                ...
                .setupModernAnimations("miniuzi", AuxiliaryAttachments.MiniUziAction)
                .setupCustomKeyedPart(AuxiliaryAttachments.MiniUziHandle, "miniuzi", "handle")
                .setupModernMagazineAnimations("miniuzi", 
                		Magazines.UziMag20,
				Magazines.UziMag25,
				Magazines.UziMag32,
				Magazines.UziMag50)
