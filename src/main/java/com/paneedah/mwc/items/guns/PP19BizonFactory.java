...
//        .withAmmoCapacity(30)
        ...
        //.withMaxShots(5)
        .withShootSound("pp19bizon")
        .withSilencedShootSound("pp19b_silenced")
...
//        .withUnremovableAttachmentCategories(AttachmentCategory.RAILING)
        .withCompatibleAttachment(Attachments2.PP19BizonHG1, true, (model) -> {
      })
...
//            GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Attachments2.PP19BizonDC, true, (model) -> {
        })
...
//          GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(Attachments2.SilencerBizon, (model) -> {
      })
        .withCompatibleAttachment(AuxiliaryAttachments.PP19BizonAction, true, (model) -> {
        })
        .withCompatibleAttachment(Magazines.PP19BizonMag1, (model) -> {
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
                ...
                .withModel(new PP19Bizon())
                .withActionPiece(AuxiliaryAttachments.PP19BizonAction)
                ...
                .withFirstPersonPositioning(
                    ...
                    .setupModernAnimations("bizon", AuxiliaryAttachments.PP19BizonAction)
                    .setupModernMagazineAnimations("bizon", 
                    		Magazines.PP19BizonMag1)
