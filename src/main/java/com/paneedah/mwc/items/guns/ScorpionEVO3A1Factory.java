...
//		.withShellCasingEjectEnabled(false)
        ...
        .withCompatibleAttachment(Attachments3.ScorpionRearSight, true, (model) -> {
            GL11.glTranslatef(-0.117f, -2.37f, -0.8f);
            GL11.glScaled(0.55F, 0.55F, 0.55F);
        })
        .withCompatibleAttachment(Attachments3.ScorpionFrontSight, renderContext -> {
...
//                    GL11.glScaled(0.4F, 0.4F, 0.4F);
		...
		.withCompatibleAttachment(Attachments3.Silencer9mm, renderContext -> {
            PlayerWeaponInstance instance = renderContext.getWeaponInstance();
            if(instance != null) {
                ItemAttachment<Weapon> activeAttachment = WeaponAttachmentAspect.getActiveAttachment(
                        AttachmentCategory.GUARD, instance);
...
//            	 GL11.glRotatef(-20F, 0f, 0f, 1f);
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
				...
				if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments3.ScorpionRearSight)) {
