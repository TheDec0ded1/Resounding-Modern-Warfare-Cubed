...
public class VSSMFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.VSSMDustCover, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments.VSSVintorezStock, (model) -> {
        })
        .withCompatibleAttachment(Attachments.VSSKOStock, (model) -> {
        })
        ...
        .withCompatibleAttachment(Attachments2.VSSMStockB, true, (model) -> {
        })
...
//                GL11.glScaled(0.017F, 0.017F, 0.017F);
        ...
        .withCompatibleAttachment(Attachments.VSSVintorezTriRailMount, true, (model) -> {
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new VSSM())
            .withActionPiece(AuxiliaryAttachments.VSSVintorezAction)
