...
public class ScarHCQCFactory implements GunFactory {
...
//               GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(Attachments2.Mk17Upper, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.Mk17UpperB, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.Mk17CQCBody, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.Mk17CQCBodyB, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
