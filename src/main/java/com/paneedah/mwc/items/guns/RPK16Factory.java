...
public class RPK16Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.RPK16Handguard, true, (model) -> {
...
//                GL11.glScaled(1F, 0.98F, 1);
        ...
        .withCompatibleAttachment(Attachments.RPK16HandguardTan, (model) -> {
            if(model instanceof RPK16handguard) {
//                GL11.glScaled(1F, 0.98F, 1);
            } else if(model instanceof AKRail) {
                GL11.glTranslatef(-0.22F, -1.3F, -4.39f);
        ...
        .withCompatibleAttachment(Attachments.RPK16HandguardGreen, (model) -> {
            if(model instanceof RPK16handguard) {
//                GL11.glScaled(1F, 0.98F, 1);
            } else if(model instanceof AKRail) {
                GL11.glTranslatef(-0.22F, -1.3F, -4.39f);
