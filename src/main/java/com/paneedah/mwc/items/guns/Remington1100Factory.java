...
public class Remington1100Factory implements GunFactory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()

        .withName("remington1100")
//      .withAmmo(CommonProxy.Remington870Mag)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Remington1100Action, true, (model) -> {
...
//          GL11.glScaled(1F, 1F, 1F);
        ...
        .withCompatibleAttachment(Attachments2.Remington1100Handguard, true, (model) -> {
//          GL11.glTranslatef(-0.14F, -0.58F, -4.1F);
//          GL11.glScaled(1F, 1F, 1F);
                })
...
//                GL11.glTranslatef(0F, 0F, 0.3F);
      ...
      .withCompatibleAttachment(Attachments3.Silencer12GaugeImprovised, renderContext -> {
          PlayerWeaponInstance instance = renderContext.getWeaponInstance();
              if(instance != null) {
                  ...
                  if(activeAttachment == Attachments.Remington870SawedOffBarrel) {
                      GL11.glTranslatef(-0.19F, -0.5F, -5.5F);
                      GL11.glScaled(1.4F, 1.4F, 1.4F);
                  } else if(activeAttachment == Attachments.Remington870PoliceMagnumBarrel) {
                      GL11.glTranslatef(-0.19F, -0.5F, -6.8F);
                      GL11.glScaled(1.4F, 1.4F, 1.4F);
                  } else {
                      GL11.glTranslatef(-0.19F, -0.5F, -7.8F);
                      GL11.glScaled(1.4F, 1.4F, 1.4F);
                  }
              }
          },(model) -> {
        ...
        .withRenderer(new WeaponRenderer.Builder()
           ...
           .withModel(new Remington1100())
            .withActionPiece(AuxiliaryAttachments.Remington1100Action)
            ...
            .withThirdPersonPositioning((renderContext) -> {
                ...
                GL11.glRotatef(70F, 1f, 0f, 0f);
                                    ...
                                    .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.Remington1100Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.Remington1100Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })

                .withFirstPersonCustomPositioning(AuxiliaryAttachments.Remington1100Action.getRenderablePart(), (renderContext) -> {
