...
public class ASM_ValFactory {
    ...
    .withCompatibleAttachment(AuxiliaryAttachments.VSSM_Action, true, (model) -> {
        ...
        .withCompatibleAttachment(Attachments2.AS_Stock, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASM_ValStock, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.AS_Grip, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.AS_GripPale, true, (model) -> {
        })
