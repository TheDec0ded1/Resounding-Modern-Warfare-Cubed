...
public class PKMFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withMuzzlePosition(new Vec3d(-0.11200000333786035, -1.0, -8.19600005054473))
        //.withMaxShots(5)
        .withShootSound("pkm")
        .withSilencedShootSound("svd_silenced")
        ...
        .withCompatibleAttachment(Attachments2.PKMGrip, true, (model) -> {
      })
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.PKMFeedTray, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.PKMCover, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.PKMBelt, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.PKMBolt, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.PKMBarrel, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.PKMBipod, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.PKMStock, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.M84Barrel, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.PKPBarrel, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.PKPBipod, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.PKPStock, (model) -> {
        })
        .withCompatibleAttachment(Magazines.PKMBox, (model) -> {
        })
        .withTextureNames("pkm")
        .withRenderer(new WeaponRenderer.Builder()
            
            .withModel(new PKM())
            .withActionPiece(AuxiliaryAttachments.PKMAction)
            ...
            .withFirstPersonPositioning(
                ...
                .setupCustomKeyedPart(AuxiliaryAttachments.PKMCover, "pkm", "cover")
                .setupCustomKeyedPart(AuxiliaryAttachments.PKMFeedTray, "pkm", "feedtray")
                .setupCustomKeyedPart(AuxiliaryAttachments.PKMBolt, "pkm", "bolt")
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.PKMBolt.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.PKMBolt.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.PKMAction.getRenderablePart(),
