...
public class SVDSFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.SVDS_Stock, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments.DragunovDustCover, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments.SVDSDC, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
...
//            GL11.glRotatef(-10F, 1f, 0f, 0f);
        ...
        .withCompatibleAttachment(Attachments3.Silencer762x54, renderContext -> {
