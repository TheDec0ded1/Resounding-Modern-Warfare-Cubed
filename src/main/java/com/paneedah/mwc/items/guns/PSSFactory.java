...
public class PSSFactory implements GunFactory {
...
//      .withShellCasingForwardOffset(0.001f)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.PSSslide, true, (model) -> {
        })
        .withCompatibleAttachment(Magazines.PSSMag, (model) -> {
        })
        .withTextureNames("APSM")
        .withRenderer(new WeaponRenderer.Builder()

            .withModel(new PSS())
            .withActionPiece(
            		AuxiliaryAttachments.PSSslide)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("m9", AuxiliaryAttachments.PSSslide)
                .setupModernMagazineAnimations("m9", Magazines.PSSMag)
                
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.PSSslide.getRenderablePart(), (renderContext) -> {
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.PSSslide.getRenderablePart(),
