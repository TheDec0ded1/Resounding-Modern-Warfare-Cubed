...
public class MP133Factory implements GunFactory {
...
//      .withAmmo(CommonProxy.Remington870Mag)
        ...
        .withCompatibleAttachment(Attachments.Remington870Pump, (model) -> {
//            GL11.glTranslatef(0.007F, -0.5F, 0F);
            GL11.glScaled(1.1F, 1F, 1F);
//            GL11.glTranslatef(0F, 0F, 1F);
        })
        .withCompatibleAttachment(Attachments.MP133Pump, true, (model) -> {
//            GL11.glTranslatef(0.007F, -0.5F, 0F);
            GL11.glScaled(1.1F, 1F, 1F);
//            GL11.glTranslatef(0F, 0F, 1F);
        })
...
//                GL11.glTranslatef(0F, 0F, 0.3F);
        ...
        .withCompatibleAttachment(Attachments3.HP, (player, stack) -> {
...
//              GL11.glTranslatef(0F, 0F, 0.8F);
            ...
            .withFirstPersonCustomPositioning(Attachments.MP133Pump.getRenderablePart(), (renderContext) -> {
//              GL11.glTranslatef(0F, 0F, 0.8F);
                })
                
            .withFirstPersonCustomPositioningLoadIterationCompleted(Attachments.MP133Pump.getRenderablePart(), (renderContext) -> {
                })
...
//                GL11.glRotatef(-70F, 1f, 0f, 0f);
            ...
            .withFirstPersonCustomPositioningLoadIterationCompleted(AuxiliaryAttachments.ShotgunShell.getRenderablePart(), (renderContext) -> {
              ...
              .withFirstPersonCustomPositioningEjectSpentRound(Attachments.MP133Pump.getRenderablePart(),
                      new Transition((renderContext) -> { // Reload position
                      	GL11.glTranslatef(0F, 0F, 0.8F);
              ...
              .withFirstPersonCustomPositioningEjectSpentRoundAimed(Attachments.MP133Pump.getRenderablePart(),
              		new Transition((renderContext) -> { // Reload position
                      	GL11.glTranslatef(0F, 0F, 0.8F);
              ...
              .withFirstPersonCustomPositioningAllLoadIterationsCompleted(Attachments.MP133Pump.getRenderablePart(),
                  new Transition((renderContext) -> { // Reload position\
                  }, 250, 50),
            ...
            .withThirdPersonCustomPositioningReloading(Attachments.MP133Pump.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
