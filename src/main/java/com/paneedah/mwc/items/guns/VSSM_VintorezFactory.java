...
public class VSSM_VintorezFactory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
        
        .withName("vssm_vintorez")
        //.withWeight("-0.15")
        .withFireRate(0.7f)
        .withRecoil(1.5f)
        .withZoom(0.9f)
    ...
    .withCompatibleAttachment(AuxiliaryAttachments.VSSM_Action, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSSM_VintorezDustcover, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSSM_VintorezRails, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSS_Stock, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSSKO_Stock, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSSM_Stock, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSSM_StockM, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.VSS_Handguard, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.AS_Handguard, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.ASM_Handguard, true, (model) -> {
        })
	...
	.withCompatibleAttachment(Attachments3.Laser, (p, s) -> {
        ...
        .withTextureNames("vssmmetal")
        .withRenderer(new WeaponRenderer.Builder()
            
            .withModel(new VSSM_Vintorez())
            .withActionPiece(AuxiliaryAttachments.VSSM_Action)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("asval", AuxiliaryAttachments.VSSM_Action)
                .setupModernMagazineAnimations("asval", Magazines.AS_Mag, Magazines.ASM_Mag, Magazines.VSS_Mag, Magazines.AS_MagP, Magazines.ASM_MagP, Magazines.VSS_MagP, Magazines.AS_MagB, Magazines.ASM_MagB, Magazines.VSS_MagB)
            
                .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.VSSM_Action.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.VSSM_Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.VSSM_Action.getRenderablePart(),
