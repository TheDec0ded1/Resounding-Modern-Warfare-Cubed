...
public class HK416A5Factory implements GunFactory {
...
//        })
        ...
        .withCompatibleAttachment(Attachments.HKSlimStockTan, true, (model) -> {
        	GL11.glTranslatef(0f, -0.28f, -0f);
            GL11.glScaled(1F, 1F, 1F);
        })
        ...
        .withCompatibleAttachment(Attachments.M38HandGuard, (model) -> {
        })
        .withCompatibleAttachment(Attachments.HK416HandGuardBlackAndTan, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments.HK416Receiver, (model) -> {
        })
        .withCompatibleAttachment(Attachments.HK416A5Receiver, true, (model) -> {
        })
