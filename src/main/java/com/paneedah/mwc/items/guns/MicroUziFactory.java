...
public class MicroUziFactory implements GunFactory {
...
//         .withInaccuracy(3)
	...
	.withRecoilParam(new RecoilParam(
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.MicroUziAction, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.MicroUziHandle, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MicroUziGrip, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MiniUziGrip, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.UziGrip, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.MicroUziStock, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.UziSuppressor, (model) -> {
        })
        .withTextureNames("microuzi")
        .withRenderer(new WeaponRenderer.Builder()
            
            .withModel(new MicroUzi())
            .withActionPiece(AuxiliaryAttachments.MicroUziAction)
            ...
            .withFirstPersonPositioning(
                ...
                .withFirstPersonHandPositioning(
                        ...
                        // Left hand
			new Transform()
			.withPosition(1.210000f, 0.265000f, 1.220000f)
			...
			.withScale(2.800000f, 2.800000f, 4.000000f),
                ...
                .setupModernAnimations("microuzi", AuxiliaryAttachments.MicroUziAction)
                .setupCustomKeyedPart(AuxiliaryAttachments.MicroUziHandle, "microuzi", "handle")
                .setupModernMagazineAnimations("microuzi", 
                		Magazines.UziMag20,
				Magazines.UziMag25,
				Magazines.UziMag32,
				Magazines.UziMag50)
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                GL11.glTranslatef(0.14f, 0.86f, -1.6f);
