...
//            GL11.glTranslatef(0f, 0f, -0f);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.LAPAFA03Action, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Magazines.LAPAFA03Mag, (model) -> {
//        	GL11.glRotatef(20.000000f, 1f, 0f, 0f);
//            GL11.glTranslatef(0f, 0f, -0f);
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new LAPAFA03())
//            .withActionPiece(AuxiliaryAttachments.LAPAFA03Action)
//            .withActionTransform(new Transform().withPosition(0, 0, 1))
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("famas", AuxiliaryAttachments.LAPAFA03Action)
                .setupModernMagazineAnimations("famas", 
                		Magazines.LAPAFA03Mag)
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.LAPAFA03Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.LAPAFA03Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.LAPAFA03Action.getRenderablePart(),
