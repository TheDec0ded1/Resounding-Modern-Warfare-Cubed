...
public class Stoner63LMGFactory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()

        .withName("stoner63lmg")
        .withFireRate(0.6f)
        .withRecoil(2f)
        .withZoom(0.9f)
        .withConfigGroup(GunConfigurationGroup.LMG)
        .withMuzzlePosition(new Vec3d(-0.148000004410744, -1.0, -6.900000011920938))
        .withMaxShots(Integer.MAX_VALUE)
        //.withMaxShots(5)
        .withShootSound("stoner63lmg")
...
//        .withDrawSound("mg42_reload")
		...
		1.45
         ...
         .withCompatibleAttachment(Attachments2.Stoner63Handguard, true, (model) -> {
         })
         .withCompatibleAttachment(Attachments2.Stoner63PaintedHandguard, (model) -> {
         })
		...
		.withCompatibleAttachment(Attachments2.Stoner63PaintedGrip, (model) -> {
		 ...
		 .withCompatibleAttachment(Attachments2.Stoner63LMGBarrel, true, (model) -> {
         })
        .withCompatibleAttachment(AuxiliaryAttachments.Stoner63AutoRifleHandle, true, (model) -> {
        })
		.withCompatibleAttachment(AuxiliaryAttachments.Stoner63LMGAction, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.Stoner63LMGCover, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.Stoner63LMGBelt, true, (model) -> {
        })
        .withCompatibleAttachment(Magazines.Stoner63LMGBox, (model) -> {
        })
        .withTextureNames("stoner63lmg")
        .withRenderer(new WeaponRenderer.Builder()
    
            .withModel(new Stoner63LMG())
            //.withTextureName("AK47")
            //.withWeaponProximity(0.99F)
            //.withYOffsetZoom(5F)
			.withActionPiece(AuxiliaryAttachments.Stoner63LMGAction)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("s63lmg", AuxiliaryAttachments.Stoner63LMGAction)
                .setupCustomKeyedPart(AuxiliaryAttachments.Stoner63LMGBelt, "s63lmg", "belt")
                .setupCustomKeyedPart(AuxiliaryAttachments.Stoner63AutoRifleHandle, "s63lmg", "handle")
                .setupCustomKeyedPart(AuxiliaryAttachments.Stoner63LMGCover, "s63lmg", "feedCover")
                .setupModernMagazineAnimations("s63lmg", 
                		Magazines.Stoner63LMGBox)
            
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.Stoner63LMGBelt.getRenderablePart(), (renderContext) -> {
                ...
                .withFirstPersonPositioningZooming((renderContext) -> {
                	GL11.glTranslatef(0.18f, 0.19f, 0.5f);
