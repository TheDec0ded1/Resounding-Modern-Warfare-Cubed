...
public class HK_P2000Factory implements GunFactory {
...
//      .withShellCasingForwardOffset(0.001f)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.P2000_Slide, true, (model) -> {
...
//                GL11.glTranslatef(0F, 0F, 0.5F);
        ...
        .withCompatibleAttachment(Magazines.P2000Mag, (model) -> {
...
//        	GL11.glRotatef(45F, 1f, 0f, 0f);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new P2000())
            .withActionPiece(
            		AuxiliaryAttachments.P2000_Slide)
            ...
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.P2000_Slide.getRenderablePart(), (renderContext) -> {
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.P2000_Slide.getRenderablePart(),
