...
public class Guns {
    ...
    public static Item AS_Val;
    public static Item VSS_Vintorez;
    ...
    public static Item AMD63;
    public static Item QCW05;
    public static Item FORT28;
    public static Item LR300;
    ...
    public static Item SVU;
    public static Item MP133;
    public static Item ASh12;
    public static Item M1A;
    public static Item PKM;
    public static Item ASVal;
    public static Item ASM;
    public static Item ASM_Val;
    public static Item VSSM_Vintorez;
    public static Item Saiga545;
    public static Item AA12;
    public static Item MicroUzi;
    public static Item MiniUzi;
    public static Item M2Carbine;
    public static Item QBZ03;
    public static Item QBU88;
	public static Item Glock26;
	public static Item Maxim9;
	public static Item Stoner63LMG;
    ...
    public static void init(Object mod, CommonProxy proxy) {
     ...
     // Nah, organization first, I'll fix the recipes later... -"Famous Last Words" with Dec0ded1
        ...
        AMD63 = new AMD63Factory().createGun(proxy);
        ...
        Saiga545 = new Saiga545Factory().createGun(proxy);
        ASVal = new ASValFactory().createGun(proxy);
        ASM = new ASMFactory().createGun(proxy);
        AS_Val = new AS_ValFactory().createGun(proxy);
        ASM_Val = new ASM_ValFactory().createGun(proxy);
        ...
        LR300 = new LR300Factory().createGun(proxy);
        ...
        M1A = new M1AFactory().createGun(proxy);
		...
		Stoner63Rifle = new Stoner63RifleFactory().createGun(proxy);
        ...
        SVU = new SVUFactory().createGun(proxy);
        VSSVintorez = new VSSVintorezFactory().createGun(proxy);
        VSS_Vintorez = new VSS_VintorezFactory().createGun(proxy);
        VSSM_Vintorez = new VSSM_VintorezFactory().createGun(proxy);
        VSSM = new VSSMFactory().createGun(proxy);
        VSSKO = new VSSKOFactory().createGun(proxy);
        VSK94 = new VSK94Factory().createGun(proxy);

        QBU88 = new QBU88Factory().createGun(proxy);
		...
		Stoner63LMG = new Stoner63LMGFactory().createGun(proxy);
		Stoner63AutoRifle = new Stoner63AutoRifleFactory().createGun(proxy);
        ...
        QCW05 = new QCW05Factory().createGun(proxy);
        ...
        MiniUzi = new MiniUziFactory().createGun(proxy);
        MicroUzi = new MicroUziFactory().createGun(proxy);
		...
		Glock26 = new Glock26Factory().createGun(proxy);
        ...
        FORT28 = new FORT28Factory().createGun(proxy);
        ...
        MP133 = new MP133Factory().createGun(proxy);
