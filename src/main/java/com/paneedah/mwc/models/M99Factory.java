...
public class M99Factory implements GunFactory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()

        .withName("m99_norinco")
        .withFireRate(0.1f)
        .withRecoil(15f)
        .withZoom(0.8f)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.M99Action, true, (model) -> {
...
//            GL11.glScaled(1.5F, 1.5F, 1.5F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new M99())
            .withActionPiece(AuxiliaryAttachments.M99Action)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("m82", AuxiliaryAttachments.M99Action)
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.M99Action.getRenderablePart(),
