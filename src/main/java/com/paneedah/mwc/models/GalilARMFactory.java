...
public class GalilARMFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        //.withMaxShots(5)
        .withShootSound("galil")
        .withSilencedShootSound("ak101_silenced")
        ...
        .withCompatibleAttachment(Attachments2.GalilARMHandGuard, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.GalilARMDustCover, true, (model) -> {
        })

        .withCompatibleAttachment(Attachments2.GalilStock, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments2.GalilARMGrip, true, (model) -> {
        })
        .withCompatibleAttachment(Attachments3.GalilARMBipod, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.GalilAction, true, (model) -> {
//            GL11.glTranslatef(0F, 0F, 1F);
        })
               .withCompatibleAttachment(Magazines.GalilMag, (model) -> {
...
//            GL11.glScaled(1.15F, 1.2F, 1.15F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
                ...
                .withModel(new GalilARM())
                .withActionPiece(AuxiliaryAttachments.GalilAction)
                ...
                .withFirstPersonPositioning(
                    ...
                    .setupModernAnimations("ak47", AuxiliaryAttachments.GalilAction)
                    .setupModernMagazineAnimations("ak47", 
                    		Magazines.GalilMag)
                
                .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.GalilAction.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
                    
                .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.GalilAction.getRenderablePart(), (renderContext) -> {
                    GL11.glTranslatef(0f, 0f, 1f);
                    })
...
//                    }, 100, 0)
                ...
                .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.GalilAction.getRenderablePart(),
