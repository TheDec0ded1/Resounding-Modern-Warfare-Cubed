...
public class MPIKMHG extends ModelBase {
	...
	public MPIKMHG() {
		...
		gun214.cubeList.add(new ModelBox(gun214, 46, 140, 0.0F, 0.0F, -1.0F, 3, 1, 12, 0.0F, false));
		gun214.cubeList.add(new ModelBox(gun214, 46, 140, 0.0F, -1.0F, -1.0F, 3, 1, 12, 0.0F, false));
		...
		gun164.cubeList.add(new ModelBox(gun164, 41, 57, 0.001F, 0.2F, 0.0F, 5, 1, 12, 0.0F, false));
		gun164.cubeList.add(new ModelBox(gun164, 1, 41, -0.001F, 1.913F, 0.0591F, 5, 1, 12, 0.0F, false));
