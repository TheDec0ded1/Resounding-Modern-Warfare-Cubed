...
public class SR3VikhrHG extends ModelWithAttachments {
	...
	public SR3VikhrHG() {
		...
		gun10.cubeList.add(new ModelBox(gun10, 170, 126, 0.0F, -1.1F, 0.0F, 3, 3, 1, 0.001F, false));
		...
		gun215.cubeList.add(new ModelBox(gun215, 101, 24, 0.2075F, -0.3496F, 2.99F, 1, 3, 5, 0.0F, false));
		gun215.cubeList.add(new ModelBox(gun215, 2, 10, 4.0106F, -0.4538F, 2.99F, 1, 3, 5, 0.0F, false));

		gun19 = new ModelRenderer(this);
		gun19.setRotationPoint(-4.1F, -32.5F, -28.5F);
		sr3m_handguard.addChild(gun19);
		gun19.cubeList.add(new ModelBox(gun19, 103, 26, 0.2075F, -0.3496F, 0.99F, 1, 3, 3, 0.0F, false));
		gun19.cubeList.add(new ModelBox(gun19, 4, 12, 4.0106F, -0.4538F, 0.99F, 1, 3, 3, 0.0F, false));
		...
		setRotationAngle(gun224, 1.3178F, 0.0F, 0.0F);
		

		gun226_r1 = new ModelRenderer(this);
		gun226_r1.setRotationPoint(2.49F, 10.8865F, -1.7922F);
		gun224.addChild(gun226_r1);
		setRotationAngle(gun226_r1, 0.0873F, 0.0F, 0.0F);
		gun226_r1.cubeList.add(new ModelBox(gun226_r1, 3, 28, -0.45F, -9.5F, 2.5F, 3, 7, 2, 0.0F, false));
		gun226_r1.cubeList.add(new ModelBox(gun226_r1, 99, 25, -2.35F, -9.5F, 2.5F, 2, 7, 2, 0.0F, false));
		gun226_r1.cubeList.add(new ModelBox(gun226_r1, 3, 28, -0.45F, -2.5F, 2.5F, 3, 10, 2, 0.0F, false));
		gun226_r1.cubeList.add(new ModelBox(gun226_r1, 102, 22, -2.35F, -2.5F, 2.5F, 2, 10, 2, 0.0F, false));
		...
		gun3.addChild(gun226_r2);
		setRotationAngle(gun226_r2, 0.0873F, 0.0F, 0.0F);
		gun226_r2.cubeList.add(new ModelBox(gun226_r2, 9, 31, 1.55F, -1.4F, 2.3F, 1, 9, 1, 0.0F, false));

		gun225_r1 = new ModelRenderer(this);
		gun225_r1.setRotationPoint(2.49F, 9.2837F, -1.3072F);
		gun3.addChild(gun225_r1);
		setRotationAngle(gun225_r1, 0.0873F, 0.0F, 0.0F);
		gun225_r1.cubeList.add(new ModelBox(gun225_r1, 108, 19, -2.35F, -1.5F, 2.3F, 1, 9, 1, 0.0F, false));
		...
		gun225.cubeList.add(new ModelBox(gun225, 219, 42, 3.5462F, -5.0106F, -0.01F, 2, 1, 1, 0.0F, false));
		gun225.cubeList.add(new ModelBox(gun225, 219, 42, 3.6504F, -1.2075F, -0.01F, 2, 1, 1, 0.0F, false));
		gun225.cubeList.add(new ModelBox(gun225, 219, 42, 3.5462F, -5.0106F, -1.01F, 2, 1, 1, 0.0F, false));
		gun225.cubeList.add(new ModelBox(gun225, 219, 42, 3.6504F, -1.2075F, -1.01F, 2, 1, 1, 0.0F, false));
		...
		gun2.cubeList.add(new ModelBox(gun2, 2, 34, -3.013F, -2.4016F, 0.575F, 2, 3, 2, 0.0F, false));
		gun2.cubeList.add(new ModelBox(gun2, 28, 58, -3.9533F, 0.4016F, 0.4897F, 3, 2, 2, 0.0F, false));
		...
		gun14.cubeList.add(new ModelBox(gun14, 217, 40, 0.0989F, -2.4309F, -2.9404F, 2, 1, 3, 0.0F, false));
		gun14.cubeList.add(new ModelBox(gun14, 4, 34, 0.0989F, 1.4691F, -2.9404F, 2, 1, 3, 0.0F, false));
		...
		gun18.cubeList.add(new ModelBox(gun18, 26, 128, -0.3061F, -2.45F, -1.3807F, 2, 1, 1, 0.0F, false));
		gun18.cubeList.add(new ModelBox(gun18, 101, 23, -0.3061F, 1.45F, -1.3807F, 2, 1, 1, 0.0F, false));
		...
		gun23.cubeList.add(new ModelBox(gun23, 25, 127, 0.366F, -2.45F, -1.366F, 1, 1, 2, 0.0F, false));
		gun23.cubeList.add(new ModelBox(gun23, 100, 22, 0.366F, 1.45F, -1.366F, 1, 1, 2, 0.0F, false));
		...
		gun24.cubeList.add(new ModelBox(gun24, 36, 235, 0.2522F, -2.45F, -1.9153F, 7, 1, 1, 0.0F, false));
		gun24.cubeList.add(new ModelBox(gun24, 23, 128, 0.2522F, 1.45F, -1.9153F, 7, 1, 1, 0.0F, false));

		gun227 = new ModelRenderer(this);
		gun227.setRotationPoint(-4.1F, -36.5F, -41.5F);
		sr3m_handguard.addChild(gun227);
		gun227.cubeList.add(new ModelBox(gun227, 49, 93, 0.2075F, -0.3496F, -0.01F, 2, 4, 15, 0.0F, false));
		gun227.cubeList.add(new ModelBox(gun227, 63, 107, 0.2075F, -0.3496F, -1.01F, 2, 4, 1, 0.0F, false));
		gun227.cubeList.add(new ModelBox(gun227, 57, 101, 0.2075F, -0.3496F, 14.99F, 2, 4, 7, 0.0F, false));

		gun228 = new ModelRenderer(this);
		gun228.setRotationPoint(0.2F, -36.5F, -39.5F);
		sr3m_handguard.addChild(gun228);
		gun228.cubeList.add(new ModelBox(gun228, 30, 219, -1.2894F, -0.4538F, -2.01F, 2, 4, 15, 0.0F, false));
		gun228.cubeList.add(new ModelBox(gun228, 44, 233, -1.2894F, -0.4538F, -3.01F, 2, 4, 1, 0.0F, false));
		gun228.cubeList.add(new ModelBox(gun228, 38, 227, -1.2894F, -0.4538F, 12.99F, 2, 4, 7, 0.0F, false));

		gun229 = new ModelRenderer(this);
		gun229.setRotationPoint(-3.2F, -38.8F, -41.5F);
		sr3m_handguard.addChild(gun229);
		gun229.cubeList.add(new ModelBox(gun229, 205, 0, -0.6925F, 0.9504F, -0.01F, 2, 1, 15, 0.0F, false));
		gun229.cubeList.add(new ModelBox(gun229, 213, 8, -0.6925F, 0.9504F, 14.99F, 2, 1, 7, 0.0F, false));
		gun229.cubeList.add(new ModelBox(gun229, 219, 14, -0.6925F, 0.9504F, -1.01F, 2, 1, 1, 0.0F, false));

		gun230 = new ModelRenderer(this);
		gun230.setRotationPoint(0.2F, -38.9F, -41.5F);
		sr3m_handguard.addChild(gun230);
		gun230.cubeList.add(new ModelBox(gun230, 30, 221, -0.2894F, 0.9462F, -0.01F, 1, 1, 15, 0.0F, false));
		gun230.cubeList.add(new ModelBox(gun230, 132, 225, -0.2894F, 0.9462F, 14.99F, 1, 1, 7, 0.0F, false));
		gun230.cubeList.add(new ModelBox(gun230, 44, 235, -0.2894F, 0.9462F, -1.01F, 1, 1, 1, 0.0F, false));
