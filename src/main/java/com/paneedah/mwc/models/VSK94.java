...
public class VSK94 extends ModelWithAttachments {
	...
	public VSK94() {
		...
		gun41.cubeList.add(new ModelBox(gun41, 9, 9, -3.2F, 2.99F, 35.001F, 4, 1, 29, 0.0F, false));
		gun41.cubeList.add(new ModelBox(gun41, 9, 9, -3.2F, 14.99F, 35.001F, 4, 1, 29, 0.0F, false));
		gun41.cubeList.add(new ModelBox(gun41, 9, 9, -2.2F, 1.99F, 35.001F, 2, 1, 29, 0.0F, false));
		gun41.cubeList.add(new ModelBox(gun41, 9, 9, -2.2F, 3.99F, 35.001F, 2, 1, 29, 0.0F, false));
		gun41.cubeList.add(new ModelBox(gun41, 122, 5, -2.2F, 4.99F, 50.001F, 2, 9, 2, 0.0F, false));
		gun41.cubeList.add(new ModelBox(gun41, 121, 4, -3.2F, 1.99F, 64.001F, 4, 15, 3, 0.0F, false));
		gun41.cubeList.add(new ModelBox(gun41, 120, 6, -3.2F, 1.99F, 67.001F, 4, 15, 3, 0.0F, false));
		gun41.cubeList.add(new ModelBox(gun41, 9, 9, -2.2F, 15.99F, 35.001F, 2, 1, 29, 0.0F, false));
		gun41.cubeList.add(new ModelBox(gun41, 9, 9, -2.2F, 13.99F, 35.001F, 2, 1, 29, 0.0F, false));
