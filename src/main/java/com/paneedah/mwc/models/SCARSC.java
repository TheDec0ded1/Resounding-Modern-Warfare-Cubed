...
public class SCARSC extends ModelWithAttachments {
	...
	public SCARSC() {
		...
		gun51_r1.cubeList.add(new ModelBox(gun51_r1, 10, 84, 0.101F, -0.7194F, 0.798F, 4, 1, 1, 0.0F, false));
		gun51_r1.cubeList.add(new ModelBox(gun51_r1, 159, 116, 3.699F, -0.72F, 0.8F, 1, 1, 1, 0.0F, false));
		...
		gun.addChild(barrel);
		barrel.cubeList.add(new ModelBox(barrel, 122, 99, -2.0F, -38.55F, -49.0F, 1, 1, 6, 0.1F, false));
		barrel.cubeList.add(new ModelBox(barrel, 92, 24, -2.0F, -39.65F, -47.9F, 1, 1, 5, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 131, 0, -2.0F, -39.65F, -49.1F, 1, 1, 2, -0.001F, false));
		barrel.cubeList.add(new ModelBox(barrel, 92, 0, -2.0F, -40.85F, -47.0F, 1, 1, 5, 0.3F, false));
		barrel.cubeList.add(new ModelBox(barrel, 106, 115, -2.4F, -40.85F, -47.2F, 1, 1, 6, 0.099F, false));
		barrel.cubeList.add(new ModelBox(barrel, 106, 108, -1.6F, -40.85F, -47.2F, 1, 1, 6, 0.099F, false));
		barrel.cubeList.add(new ModelBox(barrel, 53, 87, -2.0F, -42.35F, -46.3F, 1, 1, 3, 0.2F, false));
		barrel.cubeList.add(new ModelBox(barrel, 8, 150, -1.4F, -39.25F, -46.4F, 1, 1, 1, -0.101F, false));
		barrel.cubeList.add(new ModelBox(barrel, 4, 150, -2.6F, -39.25F, -46.4F, 1, 1, 1, -0.101F, false));
		barrel.cubeList.add(new ModelBox(barrel, 90, 119, -2.0F, -37.55F, -49.0F, 1, 1, 6, 0.1F, false));
		barrel.cubeList.add(new ModelBox(barrel, 122, 44, -2.3F, -38.35F, -49.0F, 1, 1, 6, 0.099F, false));
		barrel.cubeList.add(new ModelBox(barrel, 53, 121, -2.3F, -37.75F, -49.0F, 1, 1, 6, 0.101F, false));
		barrel.cubeList.add(new ModelBox(barrel, 0, 116, -1.7F, -38.35F, -49.0F, 1, 1, 6, 0.099F, false));
		barrel.cubeList.add(new ModelBox(barrel, 76, 119, -1.7F, -37.75F, -49.0F, 1, 1, 6, 0.101F, false));
		barrel.cubeList.add(new ModelBox(barrel, 183, 22, -2.2F, -38.0F, -53.599F, 1, 1, 25, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 170, 182, -1.8F, -38.0F, -53.601F, 1, 1, 25, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 181, 130, -2.0F, -37.8F, -53.6F, 1, 1, 25, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 181, 74, -2.0F, -38.2F, -53.6F, 1, 1, 25, 0.0F, false));
		...
		gun710_r1.cubeList.add(new ModelBox(gun710_r1, 117, 63, -0.1F, -1.0F, 10.5F, 1, 1, 4, -0.2F, false));
		...
		gun709_r1.cubeList.add(new ModelBox(gun709_r1, 117, 77, -0.9F, -1.0F, 10.5F, 1, 1, 4, -0.2F, false));
		...
		gun708_r1.cubeList.add(new ModelBox(gun708_r1, 126, 130, -0.9F, -1.0F, 10.5F, 1, 1, 2, -0.002F, false));
		...
		gun707_r1.cubeList.add(new ModelBox(gun707_r1, 0, 131, -0.1F, -1.0F, 10.5F, 1, 1, 2, -0.001F, false));
		...
		gun706_r1.cubeList.add(new ModelBox(gun706_r1, 6, 140, -0.1F, -4.5915F, 9.8666F, 2, 1, 1, 0.0F, false));
	}
