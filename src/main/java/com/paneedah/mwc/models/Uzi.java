...
public class Uzi extends ModelWithAttachments {
	...
	public Uzi() {
		...
		gun207_r1.setRotationPoint(0.3F, 0.7314F, 7.7F);
		gun207.addChild(gun207_r1);
		setRotationAngle(gun207_r1, 0.0F, 0.0F, 0.7854F);
		gun207_r1.cubeList.add(new ModelBox(gun207_r1, 154, 107, -0.8F, -0.8F, -5.0F, 1, 1, 31, 0.0F, false));
		...
		gun208_r1.setRotationPoint(0.7243F, 0.7071F, 7.7F);
		gun208.addChild(gun208_r1);
		setRotationAngle(gun208_r1, 0.0F, 0.0F, 0.7854F);
		gun208_r1.cubeList.add(new ModelBox(gun208_r1, 154, 140, -0.8F, -0.2F, -5.0F, 1, 1, 31, 0.0F, false));
		...
		gun209_r1.setRotationPoint(0.7F, 0.2828F, 7.7F);
		gun209.addChild(gun209_r1);
		setRotationAngle(gun209_r1, 0.0F, 0.0F, 0.7854F);
		gun209_r1.cubeList.add(new ModelBox(gun209_r1, 0, 156, -0.2F, -0.2F, -5.0F, 1, 1, 31, 0.0F, false));
		...
		gun210_r1.setRotationPoint(0.2757F, 0.3071F, 7.7F);
		gun210.addChild(gun210_r1);
		setRotationAngle(gun210_r1, 0.0F, 0.0F, 0.7854F);
		gun210_r1.cubeList.add(new ModelBox(gun210_r1, 65, 156, -0.2F, -0.8F, -5.0F, 1, 1, 31, 0.0F, false));

		gun211 = new ModelRenderer(this);
		gun211.setRotationPoint(-2.5F, -26.5F, -8.0F);
		gun.addChild(gun211);
		setRotationAngle(gun211, 2.3562F, 0.0F, 0.0F);
		gun211.cubeList.add(new ModelBox(gun211, 309, 300, 0.0F, 0.0707F, -0.0808F, 2, 3, 1, 0.0F, false));

		gun214 = new ModelRenderer(this);
		gun214.setRotationPoint(-3.0F, -34.0F, 1.5F);
		gun.addChild(gun214);
		gun214.cubeList.add(new ModelBox(gun214, 264, 218, 0.0F, 0.0F, 0.0F, 3, 1, 13, 0.0F, false));

		gun223 = new ModelRenderer(this);
		gun223.setRotationPoint(1.0F, -32.0F, -9.5F);
		gun.addChild(gun223);
		setRotationAngle(gun223, 0.0F, 0.0F, 2.3562F);
		gun223.cubeList.add(new ModelBox(gun223, 63, 328, 0.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));

		gun224 = new ModelRenderer(this);
		gun224.setRotationPoint(1.0F, -33.0F, -9.5F);
		gun.addChild(gun224);
		setRotationAngle(gun224, 0.0F, 0.0F, 2.3562F);
		gun224.cubeList.add(new ModelBox(gun224, 253, 328, 0.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));

		gun225 = new ModelRenderer(this);
		gun225.setRotationPoint(1.0F, -33.0F, -9.5F);
		gun.addChild(gun225);
		setRotationAngle(gun225, 0.0F, -2.3562F, 0.0F);
		gun225.cubeList.add(new ModelBox(gun225, 352, 164, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		gun226 = new ModelRenderer(this);
		gun226.setRotationPoint(1.0F, -33.0F, -2.5F);
		gun.addChild(gun226);
		setRotationAngle(gun226, 0.0F, -2.3562F, 0.0F);
		gun226.cubeList.add(new ModelBox(gun226, 352, 167, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		gun227 = new ModelRenderer(this);
		gun227.setRotationPoint(-4.0F, -33.0F, -9.5F);
		gun.addChild(gun227);
		setRotationAngle(gun227, 0.0F, 0.7854F, 0.0F);
		gun227.cubeList.add(new ModelBox(gun227, 168, 352, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		gun228 = new ModelRenderer(this);
		gun228.setRotationPoint(-4.0F, -33.0F, -2.5F);
		gun.addChild(gun228);
		setRotationAngle(gun228, 0.0F, 0.7854F, 0.0F);
		gun228.cubeList.add(new ModelBox(gun228, 352, 170, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		gun229 = new ModelRenderer(this);
		gun229.setRotationPoint(-4.0F, -32.0F, -9.5F);
		gun.addChild(gun229);
		setRotationAngle(gun229, 0.0F, 0.0F, -0.7854F);
		gun229.cubeList.add(new ModelBox(gun229, 291, 328, 0.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));

		gun230 = new ModelRenderer(this);
		gun230.setRotationPoint(-4.0F, -33.0F, -9.5F);
		gun.addChild(gun230);
		setRotationAngle(gun230, 0.0F, 0.0F, -0.7854F);
		gun230.cubeList.add(new ModelBox(gun230, 19, 330, 0.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));

		gun231 = new ModelRenderer(this);
		gun231.setRotationPoint(-1.0F, -36.3F, -17.0F);
		gun.addChild(gun231);
		gun231.cubeList.add(new ModelBox(gun231, 345, 22, 0.4F, -1.0F, 0.0F, 2, 2, 2, -0.1F, false));

		gun232 = new ModelRenderer(this);
		gun232.setRotationPoint(1.1125F, -36.4983F, -17.9F);
		gun.addChild(gun232);
		setRotationAngle(gun232, 0.0F, 0.0F, -0.2618F);
		gun232.cubeList.add(new ModelBox(gun232, 273, 197, -0.7F, -0.3414F, -0.1F, 1, 1, 4, -0.3F, false));
		gun232.cubeList.add(new ModelBox(gun232, 352, 51, -0.7F, -0.0586F, 3.1828F, 1, 2, 1, -0.3F, false));
		gun232.cubeList.add(new ModelBox(gun232, 352, 59, -0.7F, -0.0586F, -0.3828F, 1, 2, 1, -0.3F, false));
		gun232.cubeList.add(new ModelBox(gun232, 275, 157, -0.7F, 1.2243F, -0.1F, 1, 1, 4, -0.3F, false));

		gun236_r1 = new ModelRenderer(this);
		gun236_r1.setRotationPoint(-0.7F, 0.2414F, 0.1F);
		gun232.addChild(gun236_r1);
		setRotationAngle(gun236_r1, -0.7854F, 0.0F, 0.0F);
		gun236_r1.cubeList.add(new ModelBox(gun236_r1, 242, 353, 0.0F, -0.5707F, -0.4293F, 1, 1, 1, -0.3F, false));

		gun235_r1 = new ModelRenderer(this);
		gun235_r1.setRotationPoint(-0.7F, 0.2414F, 3.5F);
		gun232.addChild(gun235_r1);
		setRotationAngle(gun235_r1, -0.7854F, 0.0F, 0.0F);
		gun235_r1.cubeList.add(new ModelBox(gun235_r1, 247, 353, 0.0F, -0.5707F, -0.4293F, 1, 1, 1, -0.3F, false));

		gun235_r2 = new ModelRenderer(this);
		gun235_r2.setRotationPoint(-0.7F, 1.6414F, 0.1F);
		gun232.addChild(gun235_r2);
		setRotationAngle(gun235_r2, -0.7854F, 0.0F, 0.0F);
		gun235_r2.cubeList.add(new ModelBox(gun235_r2, 237, 353, 0.0F, -0.5707F, -0.4293F, 1, 1, 1, -0.3F, false));

		gun234_r1 = new ModelRenderer(this);
		gun234_r1.setRotationPoint(-0.7F, 1.6414F, 3.5F);
		gun232.addChild(gun234_r1);
		setRotationAngle(gun234_r1, -0.7854F, 0.0F, 0.0F);
		gun234_r1.cubeList.add(new ModelBox(gun234_r1, 183, 353, 0.0F, -0.5707F, -0.4293F, 1, 1, 1, -0.3F, false));

		gun233 = new ModelRenderer(this);
		gun233.setRotationPoint(-3.3F, -39.0F, 4.5F);
		gun.addChild(gun233);
		gun233.cubeList.add(new ModelBox(gun233, 339, 140, 0.0F, 0.0F, 0.0F, 3, 1, 4, 0.0F, false));

		gun234 = new ModelRenderer(this);
		gun234.setRotationPoint(-0.7F, -39.0F, 4.5F);
		gun.addChild(gun234);
		gun234.cubeList.add(new ModelBox(gun234, 198, 341, 0.0F, 0.0F, 0.0F, 1, 1, 4, 0.0F, false));

		gun235 = new ModelRenderer(this);
		gun235.setRotationPoint(0.3F, -39.0F, 1.5F);
		gun.addChild(gun235);
		setRotationAngle(gun235, 0.0F, 0.0F, 1.0085F);
		gun235.cubeList.add(new ModelBox(gun235, 226, 330, 0.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));

		gun236 = new ModelRenderer(this);
		gun236.setRotationPoint(0.3F, -39.0F, 1.5F);
		gun.addChild(gun236);
		setRotationAngle(gun236, 0.0F, 0.0F, 1.0085F);
		gun236.cubeList.add(new ModelBox(gun236, 166, 331, 0.2F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));

		gun237 = new ModelRenderer(this);
		gun237.setRotationPoint(-3.3F, -39.0F, 1.5F);
		gun.addChild(gun237);
		setRotationAngle(gun237, 0.0F, 0.0F, 0.5623F);
		gun237.cubeList.add(new ModelBox(gun237, 36, 332, 0.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));

		gun238 = new ModelRenderer(this);
		gun238.setRotationPoint(-3.3F, -39.0F, 1.5F);
		gun.addChild(gun238);
		setRotationAngle(gun238, 0.0F, 0.0F, 0.5623F);
		gun238.cubeList.add(new ModelBox(gun238, 80, 332, 0.0F, 0.2F, 0.0F, 1, 1, 7, 0.0F, false));

		Irons = new ModelRenderer(this);
		Irons.setRotationPoint(-0.5F, 3.3101F, 10.7899F);
		gun.addChild(Irons);
		Irons.cubeList.add(new ModelBox(Irons, 341, 6, 0.0F, -45.0101F, -39.9899F, 1, 3, 4, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 341, 14, -3.0F, -45.0101F, -39.9899F, 1, 3, 4, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 83, 305, 0.0F, -45.0101F, -40.5899F, 1, 3, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 63, 322, -3.0F, -45.0101F, -40.5899F, 1, 3, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 128, 347, -3.0F, -46.0F, -39.6F, 1, 2, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 163, 347, 0.0F, -46.0F, -39.6F, 1, 2, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 170, 347, -3.0F, -46.0F, -39.0F, 1, 2, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 195, 347, 0.0F, -46.0F, -39.0F, 1, 2, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 41, 341, 0.0F, -45.0101F, -0.5899F, 1, 3, 4, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 30, 341, -3.0F, -45.0101F, -0.5899F, 1, 3, 4, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 243, 330, 0.0F, -46.0F, -0.5799F, 1, 2, 3, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 296, 348, 0.0F, -46.0F, -1.0F, 1, 2, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 308, 328, 0.0F, -45.0101F, -1.9899F, 1, 3, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 56, 238, -3.0F, -46.0F, -0.5799F, 1, 2, 3, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 209, 347, -3.0F, -46.0F, -1.0F, 1, 2, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 270, 328, -3.0F, -45.0101F, -1.9899F, 1, 3, 2, -0.3F, false));
		Irons.cubeList.add(new ModelBox(Irons, 257, 36, -2.4F, -44.0F, -0.1F, 3, 2, 2, 0.0F, false));
		Irons.cubeList.add(new ModelBox(Irons, 349, 291, -2.7F, -44.5F, -0.1F, 1, 1, 2, -0.2F, false));
		Irons.cubeList.add(new ModelBox(Irons, 349, 295, -0.2F, -44.5F, -0.1F, 1, 1, 2, -0.2F, false));

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(-1.0F, -44.7101F, -0.7F);
		Irons.addChild(cube_r1);
		setRotationAngle(cube_r1, -0.7854F, 0.0F, 0.0F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 202, 347, -2.0F, -1.0F, -1.0F, 1, 2, 2, -0.3F, false));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 268, 348, 1.0F, -1.0F, -1.0F, 1, 2, 2, -0.3F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-1.0F, -41.8816F, -0.7083F);
		Irons.addChild(cube_r2);
		setRotationAngle(cube_r2, -0.7854F, 0.0F, 0.0F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 303, 348, -2.0F, -5.0F, -1.0F, 1, 2, 2, -0.3F, false));
		cube_r2.cubeList.add(new ModelBox(cube_r2, 310, 348, 1.0F, -5.0F, -1.0F, 1, 2, 2, -0.3F, false));

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(-1.0F, -41.8816F, -40.1083F);
		Irons.addChild(cube_r3);
		setRotationAngle(cube_r3, -0.7854F, 0.0F, 0.0F);
		cube_r3.cubeList.add(new ModelBox(cube_r3, 121, 347, 1.0F, -5.0F, -1.0F, 1, 2, 2, -0.3F, false));
		cube_r3.cubeList.add(new ModelBox(cube_r3, 104, 347, -2.0F, -5.0F, -1.0F, 1, 2, 2, -0.3F, false));

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-1.0F, -44.7101F, -39.3F);
		Irons.addChild(cube_r4);
		setRotationAngle(cube_r4, -0.7854F, 0.0F, 0.0F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 97, 347, -2.0F, -1.0F, -1.0F, 1, 2, 2, -0.3F, false));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 90, 347, 1.0F, -1.0F, -1.0F, 1, 2, 2, -0.3F, false));

		ironsights = new ModelRenderer(this);
		ironsights.setRotationPoint(0.5F, -42.6101F, -25.5899F);
		Irons.addChild(ironsights);
		ironsights.cubeList.add(new ModelBox(ironsights, 0, 343, -3.5F, -2.01F, 26.02F, 4, 2, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 196, 352, -1.7422F, -2.16F, 26.02F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 197, -2.25F, -2.16F, 26.02F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 206, -1.8836F, -2.5014F, 26.02F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 215, -1.9836F, -2.5014F, 26.02F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 209, -2.1086F, -2.5014F, 26.02F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 201, 352, -2.25F, -2.36F, 26.02F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 200, -1.7422F, -2.36F, 26.02F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 118, 352, -2.3664F, -2.0186F, 26.02F, 1, 1, 1, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 117, -2.3664F, -2.4186F, 26.02F, 1, 1, 1, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 224, -2.0836F, -2.7014F, 26.02F, 1, 1, 1, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 114, -1.9086F, -2.7014F, 26.02F, 1, 1, 1, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 221, -1.6257F, -2.4186F, 26.02F, 1, 1, 1, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 218, -1.6257F, -2.0186F, 26.02F, 1, 1, 1, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 14, -2.0F, -2.2F, -13.2F, 1, 2, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 352, 18, -2.0F, -1.2F, -13.2F, 1, 2, 1, 0.0F, false));

		ironsights_r1 = new ModelRenderer(this);
		ironsights_r1.setRotationPoint(-1.9157F, -1.4115F, 26.52F);
		ironsights.addChild(ironsights_r1);
		setRotationAngle(ironsights_r1, 0.0F, 0.0F, 0.7854F);
		ironsights_r1.cubeList.add(new ModelBox(ironsights_r1, 352, 111, -0.5F, -1.5F, -0.5F, 1, 1, 1, -0.3F, false));

		ironsights_r2 = new ModelRenderer(this);
		ironsights_r2.setRotationPoint(-1.7836F, -2.1186F, 26.52F);
		ironsights.addChild(ironsights_r2);
		setRotationAngle(ironsights_r2, 0.0F, 0.0F, 0.7854F);
		ironsights_r2.cubeList.add(new ModelBox(ironsights_r2, 352, 227, -0.5F, -0.5F, -0.5F, 1, 1, 1, -0.3F, false));

		ironsights_r3 = new ModelRenderer(this);
		ironsights_r3.setRotationPoint(-1.9907F, -1.2529F, 26.52F);
		ironsights.addChild(ironsights_r3);
		setRotationAngle(ironsights_r3, 0.0F, 0.0F, 0.7854F);
		ironsights_r3.cubeList.add(new ModelBox(ironsights_r3, 211, 352, -0.5F, -1.5F, -0.5F, 1, 1, 1, -0.4F, false));

		ironsights_r4 = new ModelRenderer(this);
		ironsights_r4.setRotationPoint(-1.7086F, -1.96F, 26.52F);
		ironsights.addChild(ironsights_r4);
		setRotationAngle(ironsights_r4, 0.0F, 0.0F, 0.7854F);
		ironsights_r4.cubeList.add(new ModelBox(ironsights_r4, 352, 212, -0.5F, -0.5F, -0.5F, 1, 1, 1, -0.4F, false));

		ironsights_r5 = new ModelRenderer(this);
		ironsights_r5.setRotationPoint(-1.9907F, -0.8529F, 26.52F);
		ironsights.addChild(ironsights_r5);
		setRotationAngle(ironsights_r5, 0.0F, 0.0F, 0.7854F);
		ironsights_r5.cubeList.add(new ModelBox(ironsights_r5, 206, 352, -0.5F, -1.5F, -0.5F, 1, 1, 1, -0.4F, false));

		ironsights_r6 = new ModelRenderer(this);
		ironsights_r6.setRotationPoint(-1.7086F, -1.56F, 26.52F);
		ironsights.addChild(ironsights_r6);
		setRotationAngle(ironsights_r6, 0.0F, 0.0F, 0.7854F);
		ironsights_r6.cubeList.add(new ModelBox(ironsights_r6, 352, 203, -0.5F, -0.5F, -0.5F, 1, 1, 1, -0.4F, false));

		gun4 = new ModelRenderer(this);
		gun4.setRotationPoint(-3.0F, -31.5F, -6.5F);
		gun.addChild(gun4);
		gun4.cubeList.add(new ModelBox(gun4, 317, 300, 0.0F, 0.0F, 0.0F, 3, 10, 5, 0.0F, false));

		gun239 = new ModelRenderer(this);
		gun239.setRotationPoint(-3.5F, -20.5F, -6.0F);
		gun.addChild(gun239);
		setRotationAngle(gun239, 2.6025F, 0.0F, 0.0F);
		gun239.cubeList.add(new ModelBox(gun239, 345, 329, 0.5F, 0.0F, 0.0F, 3, 2, 1, 0.0F, false));

		bone5 = new ModelRenderer(this);
		bone5.setRotationPoint(0.0F, 0.0F, 0.0F);
		gun.addChild(bone5);
		bone5.cubeList.add(new ModelBox(bone5, 350, 124, -1.2F, -31.5F, -5.0F, 2, 2, 1, 0.0F, false));

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(1.9979F, -30.5F, -1.8462F);
		bone5.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.0F, 0.6109F, 0.0F);
		cube_r5.cubeList.add(new ModelBox(cube_r5, 62, 277, -0.5F, -1.0F, -4.5F, 1, 2, 1, 0.0F, false));

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(-0.2964F, -30.5F, -3.8772F);
		bone5.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.0F, -0.6109F, 0.0F);
		cube_r6.cubeList.add(new ModelBox(cube_r6, 352, 69, -0.5F, -1.0F, -0.5F, 1, 2, 1, 0.0F, false));

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(0.0F, -22.0F, -3.5F);
		bone5.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.0F, 0.0F, -0.1745F);
		cube_r7.cubeList.add(new ModelBox(cube_r7, 240, 295, -0.4F, -1.3F, -1.5F, 1, 3, 3, 0.0F, false));
	}
