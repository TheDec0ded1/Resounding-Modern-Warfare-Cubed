...
public class SL8 extends ModelWithAttachments {
	...
	private final ModelRenderer gun240_r4_r1;
	private final ModelRenderer gun241_r2;
	private final ModelRenderer gun341_r3_r1;
	private final ModelRenderer bone6;
	private final ModelRenderer gun241_r3;
	private final ModelRenderer gun241_r4_r1;
	...
	public SL8() {
		...
		body.cubeList.add(new ModelBox(body, 151, 110, -4.1957F, 1.1F, -2.7294F, 2, 4, 24, 0.001F, false));
		...
		body.cubeList.add(new ModelBox(body, 0, 130, -4.2209F, 3.0F, -1.7294F, 1, 4, 11, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 0, 130, -4.2209F, 2.6F, -1.7294F, 1, 1, 11, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 10, 140, -4.5209F, 3.0F, -1.4294F, 1, 4, 1, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 10, 140, -4.5209F, 3.6F, -2.4294F, 1, 2, 1, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 9, 139, -4.5209F, 3.0F, 7.2706F, 1, 4, 2, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 4, 134, -4.3447F, 8.001F, 44.3196F, 1, 3, 7, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 134, 4, -1.3427F, 8.001F, 44.3196F, 1, 3, 7, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 139, 9, -1.3427F, 7.801F, 42.6196F, 1, 2, 2, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 9, 139, -4.3447F, 7.801F, 42.6196F, 1, 2, 2, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 127, 103, -4.5207F, 2.45F, 7.2706F, 1, 2, 2, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 127, 103, -4.5207F, 2.45F, -2.4294F, 1, 2, 2, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 127, 103, -4.5207F, 2.45F, -3.7294F, 1, 2, 2, 0.0F, false));
		...
		body.cubeList.add(new ModelBox(body, 21, 151, -1.3427F, 7.601F, 33.3176F, 1, 1, 11, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 59, 6, -4.3447F, 7.601F, 33.3176F, 1, 1, 11, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 64, 11, -4.3447F, 11.003F, 45.3196F, 1, 4, 6, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 26, 156, -1.3427F, 11.003F, 45.3196F, 1, 4, 6, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 66, 13, -4.3447F, 7.303F, 33.5196F, 1, 3, 3, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 28, 158, -1.3427F, 7.303F, 33.5196F, 1, 3, 3, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 67, 14, -4.3447F, 8.403F, 36.5196F, 1, 1, 2, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 29, 159, -1.3427F, 8.403F, 36.5196F, 1, 1, 2, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 31, 161, -1.3427F, 9.803F, 43.8196F, 1, 1, 1, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 69, 16, -4.3447F, 9.803F, 43.8196F, 1, 1, 1, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 50, -3, -4.3447F, 4.003F, 31.3196F, 1, 4, 20, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 12, 142, -1.3427F, 4.003F, 31.3196F, 1, 4, 20, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 31, 161, -1.3427F, 11.003F, 44.3196F, 1, 2, 1, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 69, 16, -4.3447F, 11.003F, 44.3196F, 1, 2, 1, 0.001F, false));
		...
		body.cubeList.add(new ModelBox(body, 98, 139, -4.7694F, 0.2348F, -2.3294F, 1, 2, 2, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 97, 138, -4.7694F, 0.2348F, 7.2706F, 1, 2, 3, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 91, 132, -4.2694F, 0.2348F, -1.7294F, 1, 2, 9, 0.0F, false));
		...
		body.cubeList.add(new ModelBox(body, 173, 85, -4.3957F, 1.1F, -2.7294F, 2, 4, 2, 0.001F, false));
		body.cubeList.add(new ModelBox(body, 161, 73, -4.3957F, 1.1F, 7.2706F, 2, 4, 14, 0.001F, false));
		...
		body_r1.setRotationPoint(-2.3462F, 11.3751F, 29.8825F);
		body.addChild(body_r1);
		setRotationAngle(body_r1, 0.0F, 0.0F, 1.5708F);
		body_r1.cubeList.add(new ModelBox(body_r1, 62, 9, -0.5017F, -0.9985F, -4.6712F, 1, 2, 8, 0.001F, false));
		body_r1.cubeList.add(new ModelBox(body_r1, 66, 13, 1.3983F, -1.9985F, -4.6712F, 1, 4, 4, 0.001F, false));

		body_r2 = new ModelRenderer(this);
		body_r2.setRotationPoint(-2.3477F, 11.6289F, 32.7648F);
		body.addChild(body_r2);
		setRotationAngle(body_r2, 0.0F, -0.4363F, 1.5708F);
		body_r2.cubeList.add(new ModelBox(body_r2, 53, 0, -0.5F, -2.0F, -8.5F, 1, 4, 17, 0.001F, false));
		...
		cube_r14.cubeList.add(new ModelBox(cube_r14, 0, 99, -0.5F, 0.0F, -1.5F, 3, 1, 3, -0.002F, false));
		...
		cube_r15.cubeList.add(new ModelBox(cube_r15, 19, 99, -0.5F, 0.0F, -1.5F, 3, 1, 3, -0.001F, false));
		...
		cube_r16.cubeList.add(new ModelBox(cube_r16, 42, 109, -1.2F, -0.5F, -6.0F, 2, 1, 12, -0.001F, false));
		cube_r16.cubeList.add(new ModelBox(cube_r16, 51, 118, -1.5F, -0.5F, 3.0F, 2, 1, 3, -0.001F, false));
		cube_r16.cubeList.add(new ModelBox(cube_r16, 53, 120, -1.5F, -0.5F, -6.0F, 2, 1, 1, -0.001F, false));
		...
		stock.setRotationPoint(-0.8457F, 35.0F, 39.8206F);
		body.addChild(stock);
		...
		stock.cubeList.add(new ModelBox(stock, 181, 39, -3.5F, -37.0F, -4.5F, 4, 6, 5, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 179, 40, -3.5F, -37.0F, 0.5F, 4, 6, 5, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 134, 18, -3.5F, -31.6F, -11.8F, 4, 1, 6, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 177, 38, -3.5F, -37.0F, 5.5F, 4, 6, 5, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 0, 32, -3.5F, -31.6F, -16.8F, 4, 1, 5, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 0, 32, -2.5F, -30.6F, -10.8F, 2, 1, 5, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 134, 18, -2.5F, -30.6F, -16.8F, 2, 1, 6, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 96, 99, -3.5F, -37.0F, 10.5F, 4, 6, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 151, 110, -3.498F, -37.998F, 11.502F, 4, 18, 3, 0.002F, false));
		stock.cubeList.add(new ModelBox(stock, 47, 65, -3.5F, -38.0F, -4.5F, 4, 1, 16, 0.0F, false));
		...
		cube_r33_r1.setRotationPoint(-1.5005F, -23.6249F, -9.9381F);
		stock.addChild(cube_r33_r1);
		setRotationAngle(cube_r33_r1, 0.0F, 0.0F, 0.0F);
		cube_r33_r1.cubeList.add(new ModelBox(cube_r33_r1, 10, 57, -1.9985F, 0.487F, -4.641F, 4, 1, 6, 0.0F, false));
		...
		cube_r32.cubeList.add(new ModelBox(cube_r32, 138, 56, -2.006F, 5.5527F, -2.9373F, 4, 1, 2, -0.003F, false));

		cube_r33 = new ModelRenderer(this);
		cube_r33.setRotationPoint(-1.5F, -29.1864F, 8.1633F);
		stock.addChild(cube_r33);
		setRotationAngle(cube_r33, -0.3054F, 0.0F, 0.0F);
		cube_r33.cubeList.add(new ModelBox(cube_r33, 15, 62, -2.003F, 4.0098F, -6.837F, 4, 1, 2, 0.0F, false));

		cube_r33_r2 = new ModelRenderer(this);
		cube_r33_r2.setRotationPoint(-0.003F, 7.3225F, -1.3367F);
		cube_r33.addChild(cube_r33_r2);
		setRotationAngle(cube_r33_r2, -0.829F, 0.0F, 0.0F);
		cube_r33_r2.cubeList.add(new ModelBox(cube_r33_r2, 0, 83, -2.0F, -0.5F, -3.4F, 4, 1, 6, 0.0F, false));

		cube_r34_r1 = new ModelRenderer(this);
		cube_r34_r1.setRotationPoint(0.0F, 7.411F, -15.9343F);
		cube_r33.addChild(cube_r34_r1);
		setRotationAngle(cube_r34_r1, 2.4435F, 0.0F, 0.0F);
		cube_r34_r1.cubeList.add(new ModelBox(cube_r34_r1, 18, 11, -1.0F, -0.3646F, 1.8311F, 2, 1, 4, 0.0F, false));

		cube_r33_r3 = new ModelRenderer(this);
		cube_r33_r3.setRotationPoint(-0.0005F, 9.2208F, -16.0727F);
		cube_r33.addChild(cube_r33_r3);
		setRotationAngle(cube_r33_r3, -0.4363F, 0.0F, 0.0F);
		cube_r33_r3.cubeList.add(new ModelBox(cube_r33_r3, 18, 11, -0.9995F, 2.8335F, -3.7694F, 2, 1, 4, 0.0F, false));
		...
		cube_r40.cubeList.add(new ModelBox(cube_r40, 0, 47, -1.999F, -0.5199F, -5.464F, 4, 9, 3, 0.0F, false));

		cube_r41 = new ModelRenderer(this);
		cube_r41.setRotationPoint(-1.5F, -29.0F, 17.0F);
		stock.addChild(cube_r41);
		setRotationAngle(cube_r41, -0.0873F, 0.0F, 0.0F);
		cube_r41.cubeList.add(new ModelBox(cube_r41, 94, 56, -1.999F, -8.7745F, -3.4826F, 4, 9, 1, 0.0F, false));
		...
		grip.setRotationPoint(-1.2372F, 11.9283F, 22.2852F);
		body.addChild(grip);
		...
		grip.cubeList.add(new ModelBox(grip, 47, 65, -2.9835F, -7.3283F, -16.0146F, 2, 4, 4, 0.0F, false));
		grip.cubeList.add(new ModelBox(grip, 48, 66, -3.2835F, -7.3283F, -15.0146F, 2, 4, 3, 0.0F, false));
		...
		grip.cubeList.add(new ModelBox(grip, 102, 102, -2.9835F, -5.3283F, -20.0146F, 0, 1, 4, 0.0F, false));
		...
		gun240_r4_r1 = new ModelRenderer(this);
		gun240_r4_r1.setRotationPoint(0.0F, 0.4496F, 5.7217F);
		gun240_r3.addChild(gun240_r4_r1);
		setRotationAngle(gun240_r4_r1, 2.8798F, 0.0F, 0.0F);
		gun240_r4_r1.cubeList.add(new ModelBox(gun240_r4_r1, 94, 76, -1.0F, -3.9253F, -1.2076F, 2, 11, 2, 0.0F, false));
		...
		gun341_r3_r1 = new ModelRenderer(this);
		gun341_r3_r1.setRotationPoint(-0.003F, -1.0F, 9.525F);
		gun241_r2.addChild(gun341_r3_r1);
		setRotationAngle(gun341_r3_r1, -0.1571F, 0.0F, 0.0F);
		gun341_r3_r1.cubeList.add(new ModelBox(gun341_r3_r1, 22, 17, -2.0F, -2.4F, -1.7F, 4, 8, 3, -0.001F, false));
		...
		gun241_r4_r1 = new ModelRenderer(this);
		gun241_r4_r1.setRotationPoint(0.0F, -3.7416F, 7.9946F);
		gun241_r3.addChild(gun241_r4_r1);
		setRotationAngle(gun241_r4_r1, 2.8798F, 0.0F, 0.0F);
		gun241_r4_r1.cubeList.add(new ModelBox(gun241_r4_r1, 30, 30, -1.0F, -4.1236F, -1.5778F, 2, 3, 1, 0.0F, false));
		...
		handguard.setRotationPoint(-0.8457F, 35.0F, 22.7706F);
		...
		handguard.cubeList.add(new ModelBox(handguard, 95, 0, -2.0F, -39.25F, -64.95F, 1, 1, 14, 0.0F, false));
		...
		handguard.cubeList.add(new ModelBox(handguard, 117, 111, -1.2929F, -36.5429F, -91.7F, 1, 1, 32, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 80, 93, -2.5F, -37.0F, -91.7F, 2, 2, 32, 0.01F, false));
		handguard.cubeList.add(new ModelBox(handguard, 82, 128, -2.0F, -37.25F, -91.7F, 1, 1, 32, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 96, 1, -2.0F, -35.8358F, -91.7F, 1, 1, 32, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 117, 77, -2.7071F, -36.5429F, -91.7F, 1, 1, 32, 0.0F, false));
		...
		cube_r69.cubeList.add(new ModelBox(cube_r69, 95, 15, -1.0F, -0.5F, -20.5F, 2, 1, 13, -0.001F, false));
		cube_r69.cubeList.add(new ModelBox(cube_r69, 106, 26, -1.0F, -0.5F, -22.5F, 2, 1, 2, -0.001F, false));
		cube_r69.cubeList.add(new ModelBox(cube_r69, 107, 27, -1.0F, -0.5F, -7.5F, 2, 1, 1, -0.001F, false));
		...
		cube_r74.cubeList.add(new ModelBox(cube_r74, 71, 65, -0.5F, -3.0F, -20.0F, 1, 1, 1, 0.0F, false));
		cube_r74.cubeList.add(new ModelBox(cube_r74, 16, 17, -0.5F, 1.0F, -21.5F, 1, 2, 1, 0.0F, false));
		...
		cube_r74.cubeList.add(new ModelBox(cube_r74, 0, 17, -0.5F, -2.0F, -13.5F, 1, 5, 9, 0.0F, false));
		cube_r74.cubeList.add(new ModelBox(cube_r74, 2, 19, -0.5F, -2.0F, -20.5F, 1, 5, 7, 0.0F, false));
		...
		cube_r75.cubeList.add(new ModelBox(cube_r75, 71, 67, -0.5F, -6.6229F, -15.2821F, 1, 1, 1, 0.0F, false));
		...
		cube_r76.cubeList.add(new ModelBox(cube_r76, 76, 26, -0.5F, -0.5F, -8.05F, 1, 1, 4, 0.0F, false));
		cube_r76.cubeList.add(new ModelBox(cube_r76, 166, 125, -0.5F, -0.5F, -18.05F, 1, 1, 10, 0.0F, false));
		cube_r76.cubeList.add(new ModelBox(cube_r76, 166, 125, -0.5F, 0.5F, -20.45F, 1, 1, 10, 0.0F, false));
		cube_r76.cubeList.add(new ModelBox(cube_r76, 76, 26, -0.5F, 0.5F, -8.45F, 1, 1, 4, 0.0F, false));
		cube_r76.cubeList.add(new ModelBox(cube_r76, 78, 28, -0.5F, 0.5F, -10.45F, 1, 1, 2, 0.0F, false));
		cube_r76.cubeList.add(new ModelBox(cube_r76, 71, 21, -0.5F, 0.5F, -4.45F, 1, 1, 9, 0.0F, false));
		cube_r76.cubeList.add(new ModelBox(cube_r76, 77, 27, -0.5F, -0.5F, -21.05F, 1, 1, 3, 0.0F, false));
		...
		cube_r77.cubeList.add(new ModelBox(cube_r77, 41, 28, -0.5F, 1.9728F, -15.5349F, 1, 7, 1, 0.001F, false));
		...
		cube_r80.cubeList.add(new ModelBox(cube_r80, 143, 13, -1.5F, -0.5F, -32.5F, 3, 1, 16, -0.001F, false));
		...
		cube_r81.cubeList.add(new ModelBox(cube_r81, 142, 45, -0.5F, -0.5F, -16.625F, 1, 1, 17, 0.0F, false));
		...
		cube_r88.cubeList.add(new ModelBox(cube_r88, 132, 155, -0.5F, -0.5F, -16.625F, 1, 1, 17, 0.0F, false));
		...
		cube_r89.cubeList.add(new ModelBox(cube_r89, 12, 118, -0.5F, -6.6229F, -15.2821F, 1, 1, 1, 0.0F, false));
		...
		cube_r90.cubeList.add(new ModelBox(cube_r90, 65, 8, -0.5F, 1.0F, -23.0F, 1, 2, 1, 0.0F, false));
		cube_r90.cubeList.add(new ModelBox(cube_r90, 69, 113, -0.5F, -2.0F, -6.0F, 1, 5, 1, 0.0F, false));
		cube_r90.cubeList.add(new ModelBox(cube_r90, 34, 118, -0.5F, -3.0F, -21.5F, 1, 1, 1, 0.0F, false));
		cube_r90.cubeList.add(new ModelBox(cube_r90, 23, 65, -0.5F, -2.0F, -5.0F, 1, 5, 9, 0.0F, false));
		cube_r90.cubeList.add(new ModelBox(cube_r90, 23, 65, -0.5F, -2.0F, -15.0F, 1, 5, 9, 0.0F, false));
		cube_r90.cubeList.add(new ModelBox(cube_r90, 25, 67, -0.5F, -2.0F, -22.0F, 1, 5, 7, 0.0F, false));
		...
		cube_r91.cubeList.add(new ModelBox(cube_r91, 54, 100, -0.5F, 1.9728F, -15.5349F, 1, 7, 1, 0.001F, false));
		...
		cube_r93.cubeList.add(new ModelBox(cube_r93, 47, 143, -1.5F, -0.5F, -32.5F, 3, 1, 16, 0.0F, false));
		...
		cube_r97.cubeList.add(new ModelBox(cube_r97, 149, 68, -0.5F, -0.5F, -8.05F, 1, 1, 4, 0.0F, false));
		cube_r97.cubeList.add(new ModelBox(cube_r97, 143, 62, -0.5F, -0.5F, -18.05F, 1, 1, 10, 0.0F, false));
		cube_r97.cubeList.add(new ModelBox(cube_r97, 144, 63, -0.5F, 0.5F, -6.05F, 1, 1, 9, 0.0F, false));
		cube_r97.cubeList.add(new ModelBox(cube_r97, 151, 70, -0.5F, 0.5F, 2.95F, 1, 1, 2, 0.0F, false));
		cube_r97.cubeList.add(new ModelBox(cube_r97, 149, 68, -0.5F, 0.5F, -10.05F, 1, 1, 4, 0.0F, false));
		cube_r97.cubeList.add(new ModelBox(cube_r97, 143, 62, -0.5F, 0.5F, -20.05F, 1, 1, 10, 0.0F, false));
		cube_r97.cubeList.add(new ModelBox(cube_r97, 150, 69, -0.5F, -0.5F, -21.05F, 1, 1, 3, 0.0F, false));
		...
		cube_r99.cubeList.add(new ModelBox(cube_r99, 79, 108, -1.0F, -0.5F, -20.5F, 2, 1, 13, 0.0F, false));
		cube_r99.cubeList.add(new ModelBox(cube_r99, 90, 119, -1.0F, -0.5F, -22.5F, 2, 1, 2, 0.0F, false));
		cube_r99.cubeList.add(new ModelBox(cube_r99, 91, 120, -1.0F, -0.5F, -7.5F, 2, 1, 1, 0.0F, false));
