...
public class SR3M extends ModelWithAttachments {
	...
	public SR3M() {
		...
		ironsights.cubeList.add(new ModelBox(ironsights, 163, 109, -2.1F, -0.9F, 46.8F, 2, 3, 11, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 164, 109, -2.9F, -0.9F, 46.8F, 2, 3, 11, -0.299F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 158, 108, -2.9F, -1.1F, 49.75F, 1, 1, 6, -0.301F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 158, 16, -1.1F, -1.1F, 49.75F, 1, 1, 6, -0.301F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 117, 182, -2.9F, -3.96F, 53.37F, 1, 3, 2, -0.301F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 86, 73, -3.0F, -1.56F, 53.87F, 3, 2, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 86, 60, -3.0F, -1.76F, 53.87F, 3, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 86, 52, -3.0F, -1.96F, 53.87F, 3, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 125, 161, -1.0F, -2.16F, 53.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 67, -1.4F, -2.16F, 53.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 65, -1.6F, -2.16F, 53.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 61, -1.7F, -2.16F, 53.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 45, -1.7F, -2.26F, 53.87F, 1, 1, 1, -0.402F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 47, -1.6F, -2.26F, 53.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 51, -1.4F, -2.26F, 53.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 59, -1.0F, -2.26F, 54.72F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 136, 159, -2.3F, -2.26F, 53.87F, 1, 1, 1, -0.402F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 159, 140, -2.4F, -2.26F, 53.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 159, 142, -2.6F, -2.26F, 53.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 160, 124, -3.0F, -2.26F, 54.72F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 160, 126, -2.3F, -2.16F, 53.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 128, 160, -2.4F, -2.16F, 53.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 139, 160, -3.0F, -2.16F, 53.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 24, -2.6F, -2.16F, 53.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 0, 182, -1.1F, -3.96F, 53.37F, 1, 3, 2, -0.301F, false));
		...
		ironsights.cubeList.add(new ModelBox(ironsights, 73, 81, -2.5F, -1.1F, 32.5F, 2, 1, 2, -0.201F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 2, 183, -2.5F, -0.5F, 32.6F, 2, 7, 2, -0.201F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 2, 183, -3.0F, 1.4F, 30.9F, 3, 3, 2, -0.201F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 2, 183, -2.5F, 1.9F, 29.3F, 2, 2, 2, -0.201F, false));
		...
		cube_r42.cubeList.add(new ModelBox(cube_r42, 116, 182, 0.401F, -1.4259F, -5.2019F, 1, 3, 6, -0.302F, false));
		cube_r42.cubeList.add(new ModelBox(cube_r42, 112, 182, -1.399F, -1.4259F, -5.2019F, 1, 3, 6, -0.302F, false));
		...
		cube_r45.cubeList.add(new ModelBox(cube_r45, 113, 181, 0.398F, 0.2974F, -3.0811F, 1, 3, 5, -0.302F, false));
		cube_r45.cubeList.add(new ModelBox(cube_r45, 114, 182, -1.402F, 0.2974F, -3.0811F, 1, 3, 5, -0.302F, false));
