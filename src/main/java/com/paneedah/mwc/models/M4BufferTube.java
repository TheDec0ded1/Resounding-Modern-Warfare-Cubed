...
public class M4BufferTube extends ModelBase {
	...
	private final ModelRenderer extension_r24;
	private final ModelRenderer extension_r25;
	...
	public M4BufferTube() {
		...
		extension.cubeList.add(new ModelBox(extension, 224, 181, -2.0F, -47.1F, 4.999F, 1, 1, 23, 0.0F, false));
		extension.cubeList.add(new ModelBox(extension, 98, 390, -2.0F, -47.225F, 4.499F, 1, 1, 2, 0.05F, false));
		...
		extension_r1.cubeList.add(new ModelBox(extension_r1, 270, 389, -0.5F, -0.5766F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r2.cubeList.add(new ModelBox(extension_r2, 342, 389, 0.2413F, -0.7241F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r3.cubeList.add(new ModelBox(extension_r3, 348, 389, -1.2413F, -0.7241F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r4.cubeList.add(new ModelBox(extension_r4, 354, 389, -0.5F, -0.5766F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r5.cubeList.add(new ModelBox(extension_r5, 360, 389, 0.2413F, -0.7241F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r6.cubeList.add(new ModelBox(extension_r6, 148, 389, -1.2413F, -0.7241F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r7.cubeList.add(new ModelBox(extension_r7, 366, 389, -0.5F, -0.5766F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r8.cubeList.add(new ModelBox(extension_r8, 80, 390, 0.2413F, -0.7241F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r9.cubeList.add(new ModelBox(extension_r9, 86, 390, -1.2413F, -0.7241F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r10.cubeList.add(new ModelBox(extension_r10, 92, 390, -0.5F, -0.5F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r11.cubeList.add(new ModelBox(extension_r11, 390, 97, -0.5F, -0.5F, -13.5F, 1, 1, 2, 0.05F, false));
		...
		extension_r12.cubeList.add(new ModelBox(extension_r12, 164, 231, -1.2413F, -0.7241F, -13.5F, 1, 1, 23, 0.0F, false));
		...
		extension_r13.cubeList.add(new ModelBox(extension_r13, 48, 233, 0.2413F, -0.7241F, -13.5F, 1, 1, 23, 0.0F, false));
		...
		extension_r14.cubeList.add(new ModelBox(extension_r14, 96, 233, -0.5F, -0.5766F, -13.5F, 1, 1, 23, 0.0F, false));
		...
		extension_r15.cubeList.add(new ModelBox(extension_r15, 0, 239, -1.2413F, -0.7241F, -13.5F, 1, 1, 23, 0.0F, false));
		...
		extension_r16.cubeList.add(new ModelBox(extension_r16, 246, 157, 0.2413F, -0.7241F, -13.5F, 1, 1, 23, 0.0F, false));

		extension_r17 = new ModelRenderer(this);
		extension_r17.setRotationPoint(-2.0F, -43.5696F, 13.101F);
		extension.addChild(extension_r17);
		setRotationAngle(extension_r17, 0.6109F, 0.0F, 3.1416F);
		extension_r17.cubeList.add(new ModelBox(extension_r17, 188, 377, -1.5F, -0.5766F, -1.5F, 2, 2, 3, 0.0F, false));

		extension_r18 = new ModelRenderer(this);
		extension_r18.setRotationPoint(-2.0F, -44.8135F, 18.499F);
		extension.addChild(extension_r18);
		setRotationAngle(extension_r18, 0.0F, 0.0F, 3.1416F);
		extension_r18.cubeList.add(new ModelBox(extension_r18, 388, 368, -1.5F, -0.5766F, 8.5F, 2, 2, 1, 0.0F, false));

		extension_r19 = new ModelRenderer(this);
		extension_r19.setRotationPoint(-2.0F, -42.8135F, 18.499F);
		extension.addChild(extension_r19);
		setRotationAngle(extension_r19, 0.0F, 0.0F, 3.1416F);
		extension_r19.cubeList.add(new ModelBox(extension_r19, 148, 132, -1.5F, -0.5766F, -4.5F, 2, 2, 14, 0.0F, false));

		extension_r20 = new ModelRenderer(this);
		extension_r20.setRotationPoint(-1.5F, -44.0635F, 18.499F);
		extension.addChild(extension_r20);
		setRotationAngle(extension_r20, 0.0F, 0.0F, 3.1416F);
		extension_r20.cubeList.add(new ModelBox(extension_r20, 248, 122, -0.5F, -0.5766F, -13.5F, 1, 1, 23, 0.0F, false));
		...
		setRotationAngle(extension_r21, 0.0F, 0.0F, -1.9635F);
		extension_r21.cubeList.add(new ModelBox(extension_r21, 212, 253, -1.2413F, -0.7241F, -13.5F, 1, 1, 23, 0.0F, false));

		extension_r22 = new ModelRenderer(this);
		extension_r22.setRotationPoint(-2.7299F, -45.2934F, 18.499F);
		extension.addChild(extension_r22);
		setRotationAngle(extension_r22, 0.0F, 0.0F, -1.1781F);
		extension_r22.cubeList.add(new ModelBox(extension_r22, 144, 255, 0.2413F, -0.7241F, -13.5F, 1, 1, 23, 0.0F, false));

		extension_r23 = new ModelRenderer(this);
		extension_r23.setRotationPoint(-2.7299F, -45.2934F, 18.499F);
		extension.addChild(extension_r23);
		setRotationAngle(extension_r23, 0.0F, 0.0F, -1.5708F);
		extension_r23.cubeList.add(new ModelBox(extension_r23, 48, 257, -0.5F, -0.5766F, -13.5F, 1, 1, 23, 0.0F, false));

		extension_r24 = new ModelRenderer(this);
		extension_r24.setRotationPoint(-2.2706F, -46.4467F, 18.499F);
		extension.addChild(extension_r24);
		setRotationAngle(extension_r24, 0.0F, 0.0F, -0.3927F);
		extension_r24.cubeList.add(new ModelBox(extension_r24, 224, 229, -0.5F, -0.5F, -13.5F, 1, 1, 23, 0.0F, false));

		extension_r25 = new ModelRenderer(this);
		extension_r25.setRotationPoint(-0.7294F, -46.4467F, 18.499F);
		extension.addChild(extension_r25);
		setRotationAngle(extension_r25, 0.0F, 0.0F, 0.3927F);
		extension_r25.cubeList.add(new ModelBox(extension_r25, 224, 205, -0.5F, -0.5F, -13.5F, 1, 1, 23, 0.0F, false));
	}
