...
public class ASM_Val extends ModelWithAttachments {
	...
	public ASM_Val() {
		...
		TRIGGER2.cubeList.add(new ModelBox(TRIGGER2, 129, 82, -0.1F, -1.1257F, 1.0687F, 1, 2, 1, 0.0F, false));
		...
		gun13TRIGGER2.cubeList.add(new ModelBox(gun13TRIGGER2, 161, 73, -0.1F, 0.6178F, -0.534F, 1, 1, 1, 0.001F, false));
		...
		gun12TRIGGER2.cubeList.add(new ModelBox(gun12TRIGGER2, 161, 62, -0.099F, 0.3832F, -0.7862F, 1, 1, 1, 0.0F, false));
		...
		val.addChild(gun198);
		gun198.cubeList.add(new ModelBox(gun198, 28, 189, -0.16F, 0.0F, -0.99F, 1, 3, 18, -0.2F, false));
		gun198.cubeList.add(new ModelBox(gun198, 61, 82, -0.16F, 0.0F, -7.99F, 1, 1, 8, -0.2F, false));
		...
		val.addChild(gun201);
		gun201.cubeList.add(new ModelBox(gun201, 160, 141, -0.2F, -0.1F, 1.7F, 1, 1, 1, -0.2F, false));

		gun202 = new ModelRenderer(this);
		gun202.setRotationPoint(-0.6F, -28.3F, -19.5F);
		val.addChild(gun202);
		gun202.cubeList.add(new ModelBox(gun202, 43, 67, 0.02F, -0.9F, -0.9F, 1, 1, 4, -0.2F, false));

		gun203 = new ModelRenderer(this);
		gun203.setRotationPoint(-3.4F, -27.8F, -19.0F);
		val.addChild(gun203);
		gun203.cubeList.add(new ModelBox(gun203, 160, 132, -0.2F, -1.2F, 1.5F, 1, 1, 1, -0.2F, false));
		gun203.cubeList.add(new ModelBox(gun203, 114, 127, -0.2F, -1.2F, -0.9F, 1, 1, 3, -0.2F, false));

		gun204 = new ModelRenderer(this);
		gun204.setRotationPoint(-0.6F, -27.8F, -19.0F);
		val.addChild(gun204);
		gun204.cubeList.add(new ModelBox(gun204, 117, 138, 0.02F, -0.9F, 0.2F, 1, 1, 2, -0.2F, false));

		gun205 = new ModelRenderer(this);
		gun205.setRotationPoint(-0.6F, -29.0F, -23.0F);
		val.addChild(gun205);
		gun205.cubeList.add(new ModelBox(gun205, 19, 107, 0.02F, -1.2F, -1.3F, 1, 1, 8, -0.2F, false));

		gun206 = new ModelRenderer(this);
		gun206.setRotationPoint(-3.4F, -29.0F, -23.0F);
		val.addChild(gun206);
		gun206.cubeList.add(new ModelBox(gun206, 104, 15, -0.2F, -1.2F, -1.3F, 1, 1, 8, -0.2F, false));

		gun207 = new ModelRenderer(this);
		gun207.setRotationPoint(-3.4F, -28.8F, -22.5F);
		val.addChild(gun207);
		gun207.cubeList.add(new ModelBox(gun207, 86, 134, -0.19F, -0.8F, 0.4F, 1, 1, 5, -0.2F, false));
		gun207.cubeList.add(new ModelBox(gun207, 160, 125, -0.19F, -0.8F, 5.0F, 1, 1, 1, -0.2F, false));

		gun208 = new ModelRenderer(this);
		gun208.setRotationPoint(-0.6F, -28.8F, -22.5F);
		val.addChild(gun208);
		gun208.cubeList.add(new ModelBox(gun208, 129, 90, 0.01F, -0.925F, 0.1F, 1, 1, 6, -0.2F, false));

		gun209 = new ModelRenderer(this);
		gun209.setRotationPoint(-3.5F, -26.25F, -17.5F);
		val.addChild(gun209);
		setRotationAngle(gun209, 1.3013F, 0.0F, 0.0F);
		gun209.cubeList.add(new ModelBox(gun209, 102, 48, -0.155F, -0.3267F, 1.0099F, 3, 1, 1, -0.199F, false));
		gun209.cubeList.add(new ModelBox(gun209, 136, 140, 1.995F, -0.3267F, 1.0099F, 2, 1, 1, -0.199F, false));

		gun210 = new ModelRenderer(this);
		gun210.setRotationPoint(-3.5F, -28.8F, -26.5F);
		val.addChild(gun210);
		setRotationAngle(gun210, 1.3013F, 0.0F, 0.0F);
		gun210.cubeList.add(new ModelBox(gun210, 0, 80, -0.155F, -0.3267F, 1.0099F, 3, 10, 1, -0.2F, false));
		gun210.cubeList.add(new ModelBox(gun210, 74, 92, 1.995F, -0.3267F, 1.0099F, 2, 10, 1, -0.2F, false));

		gun211 = new ModelRenderer(this);
		gun211.setRotationPoint(-3.4F, -30.2F, -14.5F);
		val.addChild(gun211);
		setRotationAngle(gun211, 2.3051F, 0.0F, 0.0F);
		gun211.cubeList.add(new ModelBox(gun211, 139, 42, -0.181F, -0.3691F, 1.7021F, 2, 2, 1, -0.201F, false));
		...
		gun213.cubeList.add(new ModelBox(gun213, 129, 140, -1.01F, 0.8485F, -0.6631F, 2, 1, 1, -0.2F, false));

		gun214 = new ModelRenderer(this);
		gun214.setRotationPoint(-3.4F, -31.9F, -15.5F);
		val.addChild(gun214);
		setRotationAngle(gun214, -1.7299F, 0.0F, 0.0F);
		gun214.cubeList.add(new ModelBox(gun214, 21, 27, -0.21F, 0.1584F, -0.5874F, 3, 1, 5, -0.2F, false));

		gun215 = new ModelRenderer(this);
		gun215.setRotationPoint(-0.6F, -31.9F, -15.5F);
		val.addChild(gun215);
		setRotationAngle(gun215, -1.7299F, 0.0F, 0.0F);
		gun215.cubeList.add(new ModelBox(gun215, 129, 105, -0.965F, 0.1584F, -0.5874F, 2, 1, 5, -0.2F, false));

		gun216 = new ModelRenderer(this);
		gun216.setRotationPoint(-3.3F, -30.0F, -7.0F);
		val.addChild(gun216);
		gun216.cubeList.add(new ModelBox(gun216, 124, 160, -0.2F, -1.0F, 0.0F, 1, 1, 1, -0.2F, false));
		...
		val.addChild(gun218);
		gun218.cubeList.add(new ModelBox(gun218, 43, 122, -0.18F, -0.925F, 1.0F, 3, 3, 9, -0.2F, false));
		gun218.cubeList.add(new ModelBox(gun218, 101, 127, -0.18F, -1.0F, 9.5F, 3, 3, 1, -0.2F, false));

		gun219 = new ModelRenderer(this);
		gun219.setRotationPoint(-0.6F, -31.8F, -26.5F);
		val.addChild(gun219);
		gun219.cubeList.add(new ModelBox(gun219, 100, 103, -0.98F, -2.925F, 1.0F, 2, 5, 9, -0.2F, false));
		gun219.cubeList.add(new ModelBox(gun219, 94, 57, 0.02F, -1.5F, 9.6F, 1, 3, 1, -0.2F, false));

		gun220 = new ModelRenderer(this);
		gun220.setRotationPoint(-3.2F, -35.0F, -0.6F);
		val.addChild(gun220);
		gun220.cubeList.add(new ModelBox(gun220, 43, 59, -0.2F, 0.0F, -2.2F, 3, 4, 3, -0.2F, false));

		gun221 = new ModelRenderer(this);
		gun221.setRotationPoint(-0.8F, -35.0F, -0.6F);
		val.addChild(gun221);
		gun221.cubeList.add(new ModelBox(gun221, 22, 135, -1.0F, 0.0F, -2.2F, 2, 4, 3, -0.199F, false));

		gun222 = new ModelRenderer(this);
		gun222.setRotationPoint(-3.3F, -30.8F, -7.7F);
		val.addChild(gun222);
		setRotationAngle(gun222, 0.0F, 0.0F, -0.3961F);
		gun222.cubeList.add(new ModelBox(gun222, 160, 101, 0.2742F, -1.3546F, -0.01F, 1, 1, 1, -0.2F, false));

		gun223 = new ModelRenderer(this);
		gun223.setRotationPoint(0.3F, -30.8F, -7.7F);
		val.addChild(gun223);
		setRotationAngle(gun223, 0.0F, 0.0F, 1.9705F);
		gun223.cubeList.add(new ModelBox(gun223, 37, 160, -1.2748F, 0.4615F, -0.01F, 1, 1, 1, -0.2F, false));

		gun224 = new ModelRenderer(this);
		gun224.setRotationPoint(-0.6F, -31.8F, -16.5F);
		val.addChild(gun224);
		gun224.cubeList.add(new ModelBox(gun224, 0, 18, -1.0F, -1.0F, 0.0F, 2, 1, 16, -0.2F, false));

		gun225 = new ModelRenderer(this);
		gun225.setRotationPoint(-3.4F, -31.8F, -16.5F);
		val.addChild(gun225);
		gun225.cubeList.add(new ModelBox(gun225, 0, 0, -0.19F, -1.0F, 0.0F, 2, 1, 16, -0.2F, false));

		gun226 = new ModelRenderer(this);
		gun226.setRotationPoint(-2.5F, -30.0F, -7.7F);
		val.addChild(gun226);
		gun226.cubeList.add(new ModelBox(gun226, 105, 140, 0.0F, -1.0F, 0.0F, 2, 1, 1, -0.2F, false));

		gun227 = new ModelRenderer(this);
		gun227.setRotationPoint(-3.1F, -31.0F, -7.7F);
		val.addChild(gun227);
		gun227.cubeList.add(new ModelBox(gun227, 129, 42, -0.2F, -1.01F, -0.01F, 1, 5, 1, -0.2F, false));

		gun228 = new ModelRenderer(this);
		gun228.setRotationPoint(-0.9F, -31.0F, -7.7F);
		val.addChild(gun228);
		gun228.cubeList.add(new ModelBox(gun228, 59, 122, 0.0F, -1.01F, -0.01F, 1, 5, 1, -0.2F, false));
		...
		gun234.cubeList.add(new ModelBox(gun234, 98, 140, -0.101F, -0.3301F, -1.6174F, 2, 1, 1, -0.299F, false));
		gun234.cubeList.add(new ModelBox(gun234, 140, 63, -0.101F, -0.3301F, -1.2174F, 2, 1, 1, -0.299F, false));

		gun235 = new ModelRenderer(this);
		gun235.setRotationPoint(-3.0F, -30.5F, -14.5F);
		val.addChild(gun235);
		setRotationAngle(gun235, 2.3051F, 0.0F, 0.0F);
		gun235.cubeList.add(new ModelBox(gun235, 60, 138, -0.071F, 0.3959F, 0.631F, 3, 2, 1, -0.2F, false));

		gun236 = new ModelRenderer(this);
		gun236.setRotationPoint(-0.9F, -27.5F, -16.0F);
		val.addChild(gun236);
		gun236.cubeList.add(new ModelBox(gun236, 32, 160, 0.0F, -1.0F, 0.0F, 1, 1, 1, -0.2F, false));
		...
		val.addChild(gun238);
		gun238.cubeList.add(new ModelBox(gun238, 160, 24, -0.2F, 0.0F, 0.0F, 1, 1, 1, -0.2F, false));

		gun239 = new ModelRenderer(this);
		gun239.setRotationPoint(-2.5F, -26.0F, -16.2F);
		val.addChild(gun239);
		setRotationAngle(gun239, 0.5949F, 0.0F, 0.0F);
		gun239.cubeList.add(new ModelBox(gun239, 140, 60, -0.1F, -0.8257F, 0.921F, 2, 1, 1, -0.3F, false));
		gun239.cubeList.add(new ModelBox(gun239, 139, 105, -0.1F, -1.2257F, 0.921F, 2, 1, 1, -0.3F, false));

		gun240 = new ModelRenderer(this);
		gun240.setRotationPoint(-2.5F, -31.0F, -8.5F);
		val.addChild(gun240);
		setRotationAngle(gun240, 0.9666F, 0.0F, 0.0F);
		gun240.cubeList.add(new ModelBox(gun240, 86, 72, -0.5F, -0.8681F, 0.823F, 3, 2, 2, -0.2F, false));

		gun241 = new ModelRenderer(this);
		gun241.setRotationPoint(-2.5F, -29.2F, -7.8F);
		val.addChild(gun241);
		setRotationAngle(gun241, -0.2231F, 0.0F, 0.0F);
		gun241.cubeList.add(new ModelBox(gun241, 138, 136, 0.0F, -1.2752F, -0.1213F, 2, 2, 1, -0.2F, false));
		...
		val.addChild(gun247);
		gun247.cubeList.add(new ModelBox(gun247, 54, 34, -0.1F, -1.0F, -0.1F, 3, 1, 2, -0.2F, false));
		...
		val.addChild(gun251);
		gun251.cubeList.add(new ModelBox(gun251, 57, 162, -0.2F, 0.0F, 1.0F, 3, 3, 25, -0.2F, false));

		gun252 = new ModelRenderer(this);
		gun252.setRotationPoint(-3.0F, -32.0F, -16.5F);
		val.addChild(gun252);
		gun252.cubeList.add(new ModelBox(gun252, 0, 133, -0.1F, -1.1F, 0.1F, 3, 6, 2, -0.2F, false));
		gun252.cubeList.add(new ModelBox(gun252, 0, 18, 0.2F, -1.1F, 10.5F, 3, 6, 4, -0.3F, false));
		gun252.cubeList.add(new ModelBox(gun252, 43, 17, -0.4F, -1.1F, 10.5F, 2, 6, 4, -0.3F, false));
		gun252.cubeList.add(new ModelBox(gun252, 86, 127, -0.1F, 1.9F, -0.5F, 3, 3, 1, -0.2F, false));

		gun253 = new ModelRenderer(this);
		gun253.setRotationPoint(-2.5F, -27.0F, -14.5F);
		val.addChild(gun253);
		gun253.cubeList.add(new ModelBox(gun253, 129, 23, -0.6F, -0.99F, -0.3F, 3, 1, 9, -0.2F, false));

		gun254 = new ModelRenderer(this);
		gun254.setRotationPoint(-0.8F, -31.0F, -7.5F);
		val.addChild(gun254);
		gun254.cubeList.add(new ModelBox(gun254, 31, 56, 0.01F, -2.0F, 0.0F, 1, 6, 2, -0.2F, false));

		bone4 = new ModelRenderer(this);
		bone4.setRotationPoint(-3.9F, -33.0F, -8.5F);
		val.addChild(bone4);
		setRotationAngle(bone4, 0.5061F, 0.0F, 0.0F);
		bone4.cubeList.add(new ModelBox(bone4, 20, 160, -0.3F, -1.1749F, -0.403F, 1, 1, 1, -0.2F, false));
		bone4.cubeList.add(new ModelBox(bone4, 117, 10, -0.31F, -0.9749F, -0.803F, 1, 2, 2, -0.2F, false));
		bone4.cubeList.add(new ModelBox(bone4, 160, 15, -0.3F, -0.4749F, 0.397F, 1, 1, 1, -0.2F, false));
		bone4.cubeList.add(new ModelBox(bone4, 15, 160, -0.3F, -0.4749F, -1.003F, 1, 1, 1, -0.2F, false));
		bone4.cubeList.add(new ModelBox(bone4, 160, 12, -0.3F, 0.2251F, -0.403F, 1, 1, 1, -0.2F, false));
		...
		gun255.cubeList.add(new ModelBox(gun255, 129, 82, -0.08F, -0.154F, 1.2185F, 1, 1, 6, -0.2F, false));
		...
		gun256.cubeList.add(new ModelBox(gun256, 0, 109, -0.1F, -0.0647F, -0.1892F, 1, 5, 1, -0.2F, false));
		...
		gun257.cubeList.add(new ModelBox(gun257, 104, 0, -0.08F, 0.6945F, -0.0835F, 1, 1, 8, -0.2F, false));
		gun257.cubeList.add(new ModelBox(gun257, 10, 160, -0.08F, 0.5945F, 7.4165F, 1, 1, 1, -0.2F, false));
		gun257.cubeList.add(new ModelBox(gun257, 5, 160, -0.08F, 0.5945F, 8.0165F, 1, 1, 1, -0.2F, false));
		...
		gun173_r1.cubeList.add(new ModelBox(gun173_r1, 0, 160, -0.5F, -0.5F, -0.65F, 1, 1, 1, -0.2F, false));
		...
		gun174_r1.cubeList.add(new ModelBox(gun174_r1, 159, 122, -0.5F, -0.5F, -0.35F, 1, 1, 1, -0.2F, false));
		...
		gun259.cubeList.add(new ModelBox(gun259, 60, 17, -0.08F, -0.0262F, -0.2944F, 1, 3, 2, -0.2F, false));
		gun259.cubeList.add(new ModelBox(gun259, 30, 107, -0.099F, 1.964F, -0.3967F, 1, 5, 1, -0.2F, false));
		gun259.cubeList.add(new ModelBox(gun259, 95, 112, -0.099F, 1.964F, 0.2033F, 1, 4, 1, -0.2F, false));
		...
		gun260.cubeList.add(new ModelBox(gun260, 102, 42, -0.08F, -0.1904F, -0.0614F, 1, 2, 3, -0.2F, false));
		...
		gun261.cubeList.add(new ModelBox(gun261, 159, 114, -0.1F, 0.2668F, -0.0981F, 1, 1, 1, -0.2F, false));
		...
		gun262.cubeList.add(new ModelBox(gun262, 159, 110, -0.08F, 0.3734F, -0.4624F, 1, 1, 1, -0.2F, false));

		gun263 = new ModelRenderer(this);
		gun263.setRotationPoint(-3.2F, -31.0F, -7.5F);
		val.addChild(gun263);
		gun263.cubeList.add(new ModelBox(gun263, 113, 55, -0.21F, -2.0F, 0.0F, 3, 6, 2, -0.2F, false));
		...
		cube_r27.cubeList.add(new ModelBox(cube_r27, 129, 122, -5.9162F, -12.6885F, 7.0F, 2, 1, 38, -0.2F, false));

		cube_r28 = new ModelRenderer(this);
		cube_r28.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone5.addChild(cube_r28);
		setRotationAngle(cube_r28, 0.0F, 0.0F, -0.4363F);
		cube_r28.cubeList.add(new ModelBox(cube_r28, 129, 82, 4.0916F, -12.6067F, 7.0F, 2, 1, 38, -0.2F, false));
		...
		cube_r29.cubeList.add(new ModelBox(cube_r29, 129, 42, 6.1765F, -14.2467F, 7.0F, 2, 1, 38, -0.2F, false));

		cube_r30 = new ModelRenderer(this);
		cube_r30.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone6.addChild(cube_r30);
		setRotationAngle(cube_r30, 0.0F, 0.0F, 0.4363F);
		cube_r30.cubeList.add(new ModelBox(cube_r30, 129, 2, -8.0012F, -14.3285F, 7.0F, 2, 1, 38, -0.2F, false));
		...
		cube_r31.cubeList.add(new ModelBox(cube_r31, 43, 122, -12.966F, 6.2788F, 7.0F, 2, 1, 38, -0.2F, false));

		cube_r32 = new ModelRenderer(this);
		cube_r32.setRotationPoint(0.0F, 70.2F, 0.0F);
		bone7.addChild(cube_r32);
		setRotationAngle(cube_r32, 0.0F, 0.0F, 0.4363F);
		cube_r32.cubeList.add(new ModelBox(cube_r32, 139, 98, -42.647F, -57.4072F, 44.4F, 2, 1, 1, -0.2F, false));

		cube_r33 = new ModelRenderer(this);
		cube_r33.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone7.addChild(cube_r33);
		setRotationAngle(cube_r33, 0.0F, 0.0F, -0.4363F);
		cube_r33.cubeList.add(new ModelBox(cube_r33, 139, 68, -14.9314F, -5.8656F, 44.4F, 2, 1, 1, -0.2F, false));
		cube_r33.cubeList.add(new ModelBox(cube_r33, 86, 120, -14.9692F, -5.814F, 7.0F, 2, 1, 38, -0.2F, false));
		...
		cube_r34.cubeList.add(new ModelBox(cube_r34, 0, 120, 10.8842F, 6.4541F, 7.0F, 2, 1, 38, -0.2F, false));

		cube_r35 = new ModelRenderer(this);
		cube_r35.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone8.addChild(cube_r35);
		setRotationAngle(cube_r35, 0.0F, 0.0F, 0.4363F);
		cube_r35.cubeList.add(new ModelBox(cube_r35, 86, 80, 13.051F, -5.6387F, 7.0F, 2, 1, 38, -0.2F, false));
		...
		cube_r36.cubeList.add(new ModelBox(cube_r36, 28, 125, 6.1836F, -15.2037F, 5.599F, 2, 2, 2, -0.15F, false));

		cube_r37 = new ModelRenderer(this);
		cube_r37.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone9.addChild(cube_r37);
		setRotationAngle(cube_r37, 0.0F, 0.0F, 0.4363F);
		cube_r37.cubeList.add(new ModelBox(cube_r37, 114, 122, -8.0084F, -15.2868F, 5.602F, 2, 2, 2, -0.149F, false));
		...
		cube_r38.cubeList.add(new ModelBox(cube_r38, 101, 122, -13.0019F, 6.2228F, 5.601F, 2, 2, 2, -0.148F, false));

		cube_r39 = new ModelRenderer(this);
		cube_r39.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone10.addChild(cube_r39);
		setRotationAngle(cube_r39, 0.0F, 0.0F, -0.4363F);
		cube_r39.cubeList.add(new ModelBox(cube_r39, 86, 122, -14.993F, -5.9008F, 5.599F, 2, 2, 2, -0.15F, false));
		...
		cube_r40.cubeList.add(new ModelBox(cube_r40, 71, 122, 10.9193F, 6.3957F, 5.601F, 2, 2, 2, -0.15F, false));

		cube_r41 = new ModelRenderer(this);
		cube_r41.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone11.addChild(cube_r41);
		setRotationAngle(cube_r41, 0.0F, 0.0F, 0.4363F);
		cube_r41.cubeList.add(new ModelBox(cube_r41, 43, 122, 13.0746F, -5.7215F, 5.599F, 2, 2, 2, -0.148F, false));
		...
		cube_r42.cubeList.add(new ModelBox(cube_r42, 28, 120, -5.9358F, -12.7897F, 5.6F, 2, 2, 2, -0.149F, false));

		cube_r43 = new ModelRenderer(this);
		cube_r43.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone12.addChild(cube_r43);
		setRotationAngle(cube_r43, 0.0F, 0.0F, -0.4363F);
		cube_r43.cubeList.add(new ModelBox(cube_r43, 16, 120, 4.1128F, -12.7086F, 5.601F, 2, 2, 2, -0.15F, false));
		...
		cube_r44.cubeList.add(new ModelBox(cube_r44, 138, 34, 6.1291F, -14.0859F, 7.0F, 2, 1, 2, -0.1F, false));

		cube_r45 = new ModelRenderer(this);
		cube_r45.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone13.addChild(cube_r45);
		setRotationAngle(cube_r45, 0.0F, 0.0F, 0.4363F);
		cube_r45.cubeList.add(new ModelBox(cube_r45, 137, 129, -7.9961F, -14.1479F, 7.0F, 2, 1, 2, -0.1F, false));
		...
		cube_r91.cubeList.add(new ModelBox(cube_r91, 137, 122, -12.9386F, 6.1452F, 7.0F, 2, 1, 2, -0.1F, false));

		cube_r92 = new ModelRenderer(this);
		cube_r92.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone14.addChild(cube_r92);
		setRotationAngle(cube_r92, 0.0F, 0.0F, -0.4363F);
		cube_r92.cubeList.add(new ModelBox(cube_r92, 129, 136, -14.937F, -5.9198F, 7.0F, 2, 1, 2, -0.1F, false));
		...
		cube_r93.cubeList.add(new ModelBox(cube_r93, 136, 114, 10.8766F, 6.2782F, 7.0F, 2, 1, 2, -0.1F, false));
		...
		cube_r94.cubeList.add(new ModelBox(cube_r94, 110, 136, 12.999F, -5.7868F, 7.0F, 2, 1, 2, -0.1F, false));
		...
		cube_r95.cubeList.add(new ModelBox(cube_r95, 101, 136, -5.9358F, -12.7897F, 7.0F, 2, 1, 2, -0.1F, false));
		...
		cube_r96.cubeList.add(new ModelBox(cube_r96, 52, 135, 4.0688F, -12.7277F, 7.0F, 2, 1, 2, -0.1F, false));
		...
		cube_r97.cubeList.add(new ModelBox(cube_r97, 139, 54, 6.1291F, -14.0859F, 0.0F, 2, 1, 1, -0.1F, false));
		...
		cube_r98.cubeList.add(new ModelBox(cube_r98, 139, 51, -7.9961F, -14.1479F, 0.0F, 2, 1, 1, -0.1F, false));

		bone18 = new ModelRenderer(this);
		bone18.setRotationPoint(2.2F, 1.7F, 0.0F);
		barrelouter4.addChild(bone18);
		setRotationAngle(bone18, 0.0F, 0.0F, 1.5708F);
		bone18.cubeList.add(new ModelBox(bone18, 138, 90, -14.8F, 0.2001F, 1.4F, 1, 1, 2, -0.2F, false));
		...
		cube_r99.cubeList.add(new ModelBox(cube_r99, 50, 139, -12.9386F, 6.1452F, 0.0F, 2, 1, 1, -0.1F, false));
		...
		cube_r100.cubeList.add(new ModelBox(cube_r100, 139, 46, -14.937F, -5.9198F, 0.0F, 2, 1, 1, -0.1F, false));
		...
		cube_r101.cubeList.add(new ModelBox(cube_r101, 30, 135, 10.8766F, 6.2782F, 0.0F, 2, 1, 1, -0.1F, false));
		...
		cube_r102.cubeList.add(new ModelBox(cube_r102, 28, 130, 12.999F, -5.7868F, 0.0F, 2, 1, 1, -0.1F, false));
		...
		cube_r103.cubeList.add(new ModelBox(cube_r103, 129, 55, -5.9358F, -12.7897F, 0.0F, 2, 1, 1, -0.1F, false));
		...
		cube_r104.cubeList.add(new ModelBox(cube_r104, 115, 20, 4.0688F, -12.7277F, 0.0F, 2, 1, 1, -0.1F, false));
		...
		ironsights3.cubeList.add(new ModelBox(ironsights3, 31, 18, 22.0F, -5.8F, 8.5F, 1, 4, 2, -0.3F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 60, 42, 21.0F, -4.6F, 37.5F, 2, 3, 8, -0.3F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 60, 17, 20.2F, -4.6F, 37.5F, 2, 3, 8, -0.299F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 63, 131, 20.2F, -4.8F, 40.5F, 1, 1, 5, -0.301F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 129, 129, 22.0F, -4.8F, 40.5F, 1, 1, 5, -0.301F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 104, 15, 20.2F, -5.66F, 38.42F, 1, 2, 2, -0.301F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 59, 122, 20.6F, -5.46F, 38.82F, 2, 1, 7, -0.301F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 61, 92, 20.1F, -5.26F, 45.12F, 3, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 17, 91, 20.1F, -5.46F, 45.12F, 3, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 29, 86, 20.1F, -5.66F, 45.12F, 3, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 104, 22.1F, -5.86F, 45.12F, 1, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 93, 21.9F, -5.86F, 45.12F, 1, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 70, 21.7F, -5.86F, 45.12F, 1, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 65, 21.5F, -5.86F, 45.12F, 1, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 21, 21.4F, -5.86F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 9, 21.4F, -5.96F, 45.12F, 1, 1, 1, -0.402F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 6, 21.5F, -5.96F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 3, 21.7F, -5.96F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 159, 0, 21.9F, -5.96F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 158, 155, 22.1F, -5.96F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 158, 135, 20.8F, -5.96F, 45.12F, 1, 1, 1, -0.402F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 158, 98, 20.7F, -5.96F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 158, 90, 20.5F, -5.96F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 158, 87, 20.3F, -5.96F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 158, 29, 20.1F, -5.96F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 158, 18, 20.8F, -5.86F, 45.12F, 1, 1, 1, -0.401F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 157, 152, 20.7F, -5.86F, 45.12F, 1, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 157, 146, 20.3F, -5.86F, 45.12F, 1, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 157, 107, 20.1F, -5.86F, 45.12F, 1, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 157, 84, 20.5F, -5.86F, 45.12F, 1, 1, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 104, 0, 22.0F, -5.66F, 38.42F, 1, 2, 2, -0.301F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 31, 0, 20.2F, -5.8F, 8.5F, 1, 4, 2, -0.3F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 129, 68, 21.1F, -5.9F, 8.5F, 1, 2, 1, -0.4F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 94, 42, 22.0F, -5.0F, 8.1F, 1, 3, 1, -0.3F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 86, 82, 20.2F, -5.0F, 8.1F, 1, 3, 1, -0.3F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 43, 135, 20.6F, -4.8F, 8.4F, 2, 1, 2, -0.201F, false));
		ironsights3.cubeList.add(new ModelBox(ironsights3, 94, 134, 20.6F, -3.8F, 8.4F, 2, 1, 2, -0.201F, false));
		...
		cube_r113.cubeList.add(new ModelBox(cube_r113, 100, 97, 22.4F, -5.9543F, 2.0935F, 1, 2, 3, -0.302F, false));
		cube_r113.cubeList.add(new ModelBox(cube_r113, 86, 97, 20.6F, -5.9543F, 2.0935F, 1, 2, 3, -0.302F, false));
		...
		cube_r114.cubeList.add(new ModelBox(cube_r114, 157, 75, 22.7F, -2.3567F, 4.6669F, 1, 1, 1, -0.15F, false));
		cube_r114.cubeList.add(new ModelBox(cube_r114, 157, 60, 23.0F, -2.3567F, 4.6669F, 1, 1, 1, -0.151F, false));
		cube_r114.cubeList.add(new ModelBox(cube_r114, 157, 34, 24.6F, -2.3567F, 4.6669F, 1, 1, 1, -0.151F, false));
		cube_r114.cubeList.add(new ModelBox(cube_r114, 156, 149, 24.9F, -2.3567F, 4.6669F, 1, 1, 1, -0.15F, false));
		...
		cube_r115.cubeList.add(new ModelBox(cube_r115, 18, 75, 20.5F, -1.9984F, 5.6005F, 3, 1, 1, -0.1F, false));
		...
		cube_r116.cubeList.add(new ModelBox(cube_r116, 115, 5, 21.4F, -6.7071F, 0.9706F, 2, 1, 1, -0.302F, false));
		cube_r116.cubeList.add(new ModelBox(cube_r116, 102, 82, 22.8F, -7.7071F, 0.9706F, 1, 2, 2, -0.302F, false));
		cube_r116.cubeList.add(new ModelBox(cube_r116, 102, 57, 21.0F, -7.7071F, 0.9706F, 1, 2, 2, -0.302F, false));
	}
