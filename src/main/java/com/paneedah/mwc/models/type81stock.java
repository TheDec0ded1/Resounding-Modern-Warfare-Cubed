...
public class type81stock extends ModelBase {
	...
	public type81stock() {
		...
		stock.setRotationPoint(0.0F, 24.9F, -17.0F);
		setRotationAngle(stock, 0.0873F, 0.0F, 0.0F);
		

		gun365 = new ModelRenderer(this);
		gun365.setRotationPoint(-2.5F, -36.0F, 24.5F);
		stock.addChild(gun365);
		setRotationAngle(gun365, -0.1859F, 0.0F, 0.0F);
		

		gun365_r1 = new ModelRenderer(this);
		gun365_r1.setRotationPoint(0.999F, 0.9242F, 1.7895F);
		gun365.addChild(gun365_r1);
		setRotationAngle(gun365_r1, -0.3927F, 0.0F, 0.0F);
		gun365_r1.cubeList.add(new ModelBox(gun365_r1, 27, 19, -0.999F, -1.0321F, -2.2394F, 2, 1, 4, 0.0F, false));

		gun349 = new ModelRenderer(this);
		gun349.setRotationPoint(-0.1F, -33.5F, 29.5F);
		...
		gun348.setRotationPoint(-0.4F, -32.6F, 28.5F);
		...
		gun245.setRotationPoint(-1.1F, -33.9F, 51.8F);
		...
		gun245.cubeList.add(new ModelBox(gun245, 35, 19, 0.0F, 10.0F, -0.2997F, 1, 2, 1, 0.0F, false));

		gun244 = new ModelRenderer(this);
		gun244.setRotationPoint(-0.6F, -32.9F, 50.7F);
		...
		gun243.setRotationPoint(-3.4F, -32.9F, 50.7F);
		...
		gun242.setRotationPoint(-2.9F, -33.9F, 51.8F);
		...
		gun242.cubeList.add(new ModelBox(gun242, 6, 80, 0.0F, 9.999F, -0.2987F, 2, 2, 1, 0.0F, false));

		gun241 = new ModelRenderer(this);
		gun241.setRotationPoint(-3.5F, -23.9F, 49.6F);
		stock.addChild(gun241);
		setRotationAngle(gun241, -0.1115F, 0.0F, 0.0F);
		gun241.cubeList.add(new ModelBox(gun241, 79, 70, -0.001F, 0.0918F, -0.0431F, 4, 1, 1, 0.0F, false));
		gun241.cubeList.add(new ModelBox(gun241, 79, 70, 0.999F, 1.0746F, -0.228F, 2, 1, 1, 0.0F, false));
		gun241.cubeList.add(new ModelBox(gun241, 79, 70, 0.999F, 1.0746F, 0.172F, 2, 1, 1, 0.0F, false));
		gun241.cubeList.add(new ModelBox(gun241, 79, 70, -0.001F, 0.0918F, 0.1569F, 4, 1, 1, 0.0F, false));
		gun241.cubeList.add(new ModelBox(gun241, 79, 70, 0.999F, 0.0746F, -0.228F, 2, 1, 1, 0.0F, false));

		gun240 = new ModelRenderer(this);
		gun240.setRotationPoint(-3.5F, -29.7F, 47.4F);
		...
		gun239.setRotationPoint(-3.5F, -33.6F, 24.5F);
		stock.addChild(gun239);
		setRotationAngle(gun239, -0.2974F, 0.0F, 0.0F);
		gun239.cubeList.add(new ModelBox(gun239, 0, 83, 0.999F, 3.0F, 0.0F, 2, 1, 27, 0.0F, false));
		gun239.cubeList.add(new ModelBox(gun239, 0, 83, -0.001F, 0.0F, 0.0F, 4, 3, 27, 0.0F, false));

		gun238 = new ModelRenderer(this);
		gun238.setRotationPoint(-3.5F, -34.6F, 33.75F);
		stock.addChild(gun238);
		setRotationAngle(gun238, -0.0873F, 0.0F, 0.0F);
		gun238.cubeList.add(new ModelBox(gun238, 3, 116, 0.0F, 0.0F, 3.0F, 4, 4, 15, 0.0F, false));

		gun237 = new ModelRenderer(this);
		gun237.setRotationPoint(-3.0F, -35.5F, 33.95F);
		stock.addChild(gun237);
		setRotationAngle(gun237, -0.0873F, 0.0F, 0.0F);
		gun237.cubeList.add(new ModelBox(gun237, 143, 56, 0.0F, 0.0F, 3.0F, 3, 2, 15, 0.0F, false));

		gun236 = new ModelRenderer(this);
		gun236.setRotationPoint(-3.0F, -33.2F, 29.5F);
		stock.addChild(gun236);
		setRotationAngle(gun236, 0.4833F, 0.0F, 0.0F);
		gun236.cubeList.add(new ModelBox(gun236, 0, 144, -0.001F, 1.6203F, 2.5248F, 3, 2, 5, 0.0F, false));

		gun237_r1 = new ModelRenderer(this);
		gun237_r1.setRotationPoint(1.499F, -2.9678F, -2.296F);
		gun236.addChild(gun237_r1);
		setRotationAngle(gun237_r1, -1.1345F, 0.0F, 0.0F);
		gun237_r1.cubeList.add(new ModelBox(gun237_r1, 2, 146, -1.5F, -0.7346F, -2.2491F, 3, 2, 3, 0.0F, false));

		gun235 = new ModelRenderer(this);
		gun235.setRotationPoint(-3.5F, -32.3F, 29.5F);
		stock.addChild(gun235);
		setRotationAngle(gun235, 0.4833F, 0.0F, 0.0F);
		gun235.cubeList.add(new ModelBox(gun235, 0, 123, -0.002F, 1.6203F, 2.5248F, 4, 2, 5, 0.0F, false));

		gun236_r1 = new ModelRenderer(this);
		gun236_r1.setRotationPoint(1.999F, -3.7648F, -1.8778F);
		gun235.addChild(gun236_r1);
		setRotationAngle(gun236_r1, -1.1345F, 0.0F, 0.0F);
		gun236_r1.cubeList.add(new ModelBox(gun236_r1, 2, 125, -2.001F, -0.2049F, -1.8447F, 4, 2, 3, 0.0F, false));

		gun234 = new ModelRenderer(this);
		gun234.setRotationPoint(-3.0F, -35.9F, 24.5F);
		...
		gun233.setRotationPoint(-3.5F, -34.9F, 24.5F);
