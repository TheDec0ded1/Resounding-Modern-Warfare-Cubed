...
public class LAPAFA03Action extends ModelWithAttachments {
	...
	public LAPAFA03Action() {
		...
		cube_r153.cubeList.add(new ModelBox(cube_r153, 50, 136, -2.001F, -1.3908F, -0.6381F, 2, 2, 1, 0.0F, false));
		...
		cube_r154.cubeList.add(new ModelBox(cube_r154, 16, 96, -2.001F, -1.0736F, 0.3191F, 2, 1, 1, 0.0F, false));
		...
		cube_r155.cubeList.add(new ModelBox(cube_r155, 22, 96, -2.0F, -1.3434F, 0.0373F, 2, 1, 1, 0.0F, false));
		...
		cube_r156.cubeList.add(new ModelBox(cube_r156, 28, 96, -2.001F, -1.4848F, -0.3264F, 2, 1, 1, 0.0F, false));
		...
		cube_r157.cubeList.add(new ModelBox(cube_r157, 5, 0, -4.9944F, -24.2437F, 10.3673F, 1, 2, 1, -0.2F, false));
		...
		cube_r158.cubeList.add(new ModelBox(cube_r158, 113, 136, -2.5F, -25.4437F, 11.1696F, 2, 2, 1, 0.0F, false));
		...
		cube_r160.cubeList.add(new ModelBox(cube_r160, 0, 40, -2.601F, -25.6437F, 14.0696F, 2, 1, 2, -0.2F, false));
		cube_r160.cubeList.add(new ModelBox(cube_r160, 107, 67, -2.5F, -24.9437F, 13.5696F, 2, 1, 2, 0.0F, false));
