...
public class I1A1Grip extends ModelBase {
	...
	public I1A1Grip() {
		...
		grip11.cubeList.add(new ModelBox(grip11, 315, 234, 0.0F, 9.0F, -1.0F, 3, 1, 1, 0.0F, false));
		...
		grip5.cubeList.add(new ModelBox(grip5, 291, 229, 0.001F, 2.8223F, 2.547F, 3, 2, 3, 0.0F, false));
		...
		grip4.cubeList.add(new ModelBox(grip4, 281, 236, 0.0F, -4.8492F, -0.5117F, 3, 10, 2, 0.0F, false));
		...
		grip6.cubeList.add(new ModelBox(grip6, 319, 224, -0.001F, -4.8492F, -4.5117F, 3, 16, 6, 0.0F, false));
		...
		grip3.cubeList.add(new ModelBox(grip3, 310, 231, -2.0F, 3.7874F, 3.0476F, 3, 5, 4, 0.0F, false));
		...
		grip2.cubeList.add(new ModelBox(grip2, 323, 242, 0.0F, 8.0F, 0.0F, 3, 2, 6, 0.0F, false));
		...
		grip12.cubeList.add(new ModelBox(grip12, 308, 228, 0.0F, 0.0F, 0.0F, 3, 1, 2, 0.0F, false));

		grip1 = new ModelRenderer(this);
		grip1.setRotationPoint(-3.5F, -31.5F, -7.0F);
		grip9.addChild(grip1);
		grip1.cubeList.add(new ModelBox(grip1, 344, 216, -0.002F, 0.1305F, 5.9914F, 3, 4, 1, 0.0F, false));
		...
		grip10.cubeList.add(new ModelBox(grip10, 350, 247, 2.3F, 9.0F, -1.0F, 1, 1, 1, 0.0F, false));
		...
		grip14.cubeList.add(new ModelBox(grip14, 333, 238, 2.299F, 2.8223F, 2.547F, 1, 2, 3, 0.0F, false));
		...
		grip15.cubeList.add(new ModelBox(grip15, 332, 221, 2.3F, -4.8492F, -0.5117F, 1, 10, 2, 0.0F, false));
		...
		grip16.cubeList.add(new ModelBox(grip16, 281, 234, 2.301F, -4.8492F, -4.5117F, 1, 16, 6, 0.0F, false));
		...
		grip17.cubeList.add(new ModelBox(grip17, 294, 231, 0.3F, 3.7874F, 3.0476F, 1, 5, 4, 0.0F, false));
		...
		grip18.cubeList.add(new ModelBox(grip18, 297, 221, 2.3F, 8.0F, 0.0F, 1, 2, 6, 0.0F, false));
		...
		grip19.cubeList.add(new ModelBox(grip19, 313, 231, 2.3F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));

		grip20 = new ModelRenderer(this);
		grip20.setRotationPoint(-3.5F, -31.5F, -7.0F);
		grip7.addChild(grip20);
		grip20.cubeList.add(new ModelBox(grip20, 317, 243, 2.302F, 0.1305F, 5.9914F, 1, 4, 1, 0.0F, false));
	}
