...
public class AKMmag extends ModelBase {
	...
	public AKMmag() {
		...
		Magazine37.cubeList.add(new ModelBox(Magazine37, 0, 0, 0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F, true));
		...
		Magazine38.cubeList.add(new ModelBox(Magazine38, 0, 0, 0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F, true));
