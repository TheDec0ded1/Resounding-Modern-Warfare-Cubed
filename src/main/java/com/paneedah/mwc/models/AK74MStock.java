...
public class AK74MStock extends ModelBase {
	...
	public AK74MStock() {
		...
		gun233.cubeList.add(new ModelBox(gun233, 3, 3, 0.001F, 0.0F, 3.0F, 3, 4, 24, 0.0F, false));
		gun233.cubeList.add(new ModelBox(gun233, 17, 17, 3.001F, 0.0F, 3.0F, 1, 1, 10, 0.0F, false));
		gun233.cubeList.add(new ModelBox(gun233, 15, 15, 3.001F, 3.0F, 3.0F, 1, 1, 12, 0.0F, false));
		gun233.cubeList.add(new ModelBox(gun233, 24, 24, 0.001F, 0.0F, 0.0F, 4, 4, 3, 0.0F, false));
		gun233.cubeList.add(new ModelBox(gun233, 18, 18, 1.001F, 0.0F, 15.0F, 3, 4, 9, 0.0F, false));
		...
		gun235.cubeList.add(new ModelBox(gun235, 11, 18, -0.001F, 0.0F, 3.0F, 4, 1, 2, 0.0F, false));
		gun235.cubeList.add(new ModelBox(gun235, 11, 18, -0.001F, 0.3F, 3.0F, 4, 1, 2, 0.0F, false));
		gun235.cubeList.add(new ModelBox(gun235, 12, 19, -0.001F, 0.0F, 2.4F, 4, 1, 1, 0.0F, false));

		gun236 = new ModelRenderer(this);
		gun236.setRotationPoint(-3.0F, -9.2F, 8.5F);
		setRotationAngle(gun236, 0.4833F, 0.0F, 0.0F);
		gun236.cubeList.add(new ModelBox(gun236, 11, 11, -0.001F, 0.0F, 1.0F, 3, 1, 4, 0.0F, false));
		...
		gun238.cubeList.add(new ModelBox(gun238, 0, 31, 0.0F, 0.0F, 0.0F, 4, 2, 18, 0.0F, false));
		gun238.cubeList.add(new ModelBox(gun238, 15, 46, 0.0F, 2.0F, 3.0F, 4, 1, 3, 0.0F, false));
		gun238.cubeList.add(new ModelBox(gun238, 6, 37, 0.0F, 2.0F, 6.0F, 4, 3, 12, 0.0F, false));
		...
		gun348.cubeList.add(new ModelBox(gun348, 12, 0, -3.6F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));

		gun349 = new ModelRenderer(this);
		gun349.setRotationPoint(-0.1F, -9.5F, 8.5F);
		setRotationAngle(gun349, -0.1859F, 0.0F, 0.0F);
		gun349.cubeList.add(new ModelBox(gun349, 0, 0, -3.6F, 0.0F, 0.0F, 1, 3, 1, 0.0F, false));
		...
		gun366.cubeList.add(new ModelBox(gun366, 41, 6, -0.002F, 0.0F, 6.0F, 4, 3, 12, 0.0F, false));
		gun366.cubeList.add(new ModelBox(gun366, 47, 12, -0.002F, 2.0F, 0.0F, 4, 1, 6, 0.0F, false));
		gun366.cubeList.add(new ModelBox(gun366, 50, 15, -0.002F, 1.0F, 3.0F, 4, 1, 3, 0.0F, false));
	}
