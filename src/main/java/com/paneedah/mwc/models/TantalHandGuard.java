...
public class TantalHandGuard extends ModelBase {
	...
	public TantalHandGuard() {
		...
		gun232.cubeList.add(new ModelBox(gun232, 0, 2, 0.0F, 0.0F, -0.001F, 1, 1, 14, 0.0F, false));
		...
		gun231.cubeList.add(new ModelBox(gun231, 0, 0, 0.0F, 0.0F, 0.0F, 1, 1, 11, 0.0F, false));
		...
		gun230.cubeList.add(new ModelBox(gun230, 1, 7, 0.0F, 0.0F, 0.0F, 1, 1, 8, 0.0F, false));
		...
		gun229.cubeList.add(new ModelBox(gun229, 0, 0, 0.0F, 0.0F, -0.001F, 1, 1, 11, 0.0F, false));
		...
		gun227.cubeList.add(new ModelBox(gun227, 162, 30, 0.0F, 0.0F, 0.001F, 1, 1, 1, 0.0F, false));
		...
		gun228.cubeList.add(new ModelBox(gun228, 169, 27, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		gun226.cubeList.add(new ModelBox(gun226, 171, 25, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		gun225.cubeList.add(new ModelBox(gun225, 162, 28, 0.0F, 0.0F, 0.001F, 1, 1, 1, 0.0F, false));
		...
		gun224.cubeList.add(new ModelBox(gun224, 162, 18, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		gun223.cubeList.add(new ModelBox(gun223, 146, 19, 0.0F, 0.0F, 0.001F, 1, 1, 1, 0.0F, false));
		...
		gun222.cubeList.add(new ModelBox(gun222, 145, 14, 0.0F, 0.0F, 0.001F, 1, 1, 1, 0.0F, false));
		...
		gun210.cubeList.add(new ModelBox(gun210, 141, 17, 0.0F, 0.1F, 0.0F, 4, 1, 13, 0.0F, false));

		gun209 = new ModelRenderer(this);
		gun209.setRotationPoint(-3.5F, -38.1F, -53.5F);
		handguard.addChild(gun209);
		gun209.cubeList.add(new ModelBox(gun209, 129, 16, 0.0F, -0.2F, 0.0F, 4, 1, 12, 0.0F, false));
		...
		gun191.cubeList.add(new ModelBox(gun191, 8, 15, 0.0F, 0.0F, 0.0F, 5, 2, 1, 0.0F, false));
		...
		gun190.cubeList.add(new ModelBox(gun190, 7, 15, -0.001F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun189.cubeList.add(new ModelBox(gun189, 1, 11, -0.001F, 0.0F, 0.0F, 5, 2, 5, 0.0F, false));

		gun188 = new ModelRenderer(this);
		gun188.setRotationPoint(-4.0F, -33.5F, -38.5F);
		handguard.addChild(gun188);
		gun188.cubeList.add(new ModelBox(gun188, 6, 8, 0.001F, 0.0F, 0.0F, 5, 3, 1, 0.0F, false));
		...
		gun187.cubeList.add(new ModelBox(gun187, 230, 223, 0.0F, 0.0F, -0.002F, 1, 1, 13, 0.0F, false));
		...
		gun186.cubeList.add(new ModelBox(gun186, 234, 224, 0.0F, 0.0F, -0.001F, 1, 1, 13, 0.0F, false));
		...
		gun185.cubeList.add(new ModelBox(gun185, 230, 219, 0.0F, 0.0F, -0.001F, 1, 1, 13, 0.0F, false));
		...
		gun184.cubeList.add(new ModelBox(gun184, 239, 224, 0.0F, 0.0F, -0.002F, 1, 1, 13, 0.0F, false));
		...
		gun183.cubeList.add(new ModelBox(gun183, 228, 222, 0.0F, 0.0F, 0.0F, 3, 1, 13, 0.0F, false));
		...
		gun181.cubeList.add(new ModelBox(gun181, 2, 15, -0.001F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun180.cubeList.add(new ModelBox(gun180, 6, 15, -0.001F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun179.cubeList.add(new ModelBox(gun179, 5, 11, -0.001F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun178.cubeList.add(new ModelBox(gun178, 8, 17, -0.001F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun177.cubeList.add(new ModelBox(gun177, 240, 227, 0.0F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun176.cubeList.add(new ModelBox(gun176, 245, 234, 0.0F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun175.cubeList.add(new ModelBox(gun175, 237, 231, 0.0F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun174.cubeList.add(new ModelBox(gun174, 245, 236, 0.0F, 0.0F, 0.0F, 5, 1, 1, 0.0F, false));
		...
		gun159.cubeList.add(new ModelBox(gun159, 3, 0, 0.0F, 0.0F, 0.0F, 3, 17, 1, 0.0F, false));

		gun2 = new ModelRenderer(this);
		gun2.setRotationPoint(-3.0F, -29.0F, -45.5F);
		handguard.addChild(gun2);
		setRotationAngle(gun2, 3.0143F, 0.0F, 0.0F);
		

		gun3 = new ModelRenderer(this);
		gun3.setRotationPoint(-3.0F, -24.0F, -45.5F);
		handguard.addChild(gun3);
		setRotationAngle(gun3, 2.8397F, 0.0F, 0.0F);
		...
		gun157.cubeList.add(new ModelBox(gun157, 4, 2, 0.002F, 0.0F, 0.0F, 5, 17, 1, 0.0F, false));
		...
		gun156.cubeList.add(new ModelBox(gun156, 173, 19, 0.0F, 0.0F, 0.001F, 1, 1, 1, 0.0F, false));
		...
		gun155.cubeList.add(new ModelBox(gun155, 153, 17, 0.0F, 0.0F, -0.001F, 1, 1, 1, 0.0F, false));
		...
		gun154.cubeList.add(new ModelBox(gun154, 150, 23, 0.0F, 0.0F, -0.001F, 1, 1, 1, 0.0F, false));
		...
		gun153.cubeList.add(new ModelBox(gun153, 143, 13, 0.0F, 0.0F, 0.001F, 1, 1, 1, 0.0F, false));

		gun152 = new ModelRenderer(this);
		gun152.setRotationPoint(-3.0F, -32.0F, -36.5F);
		handguard.addChild(gun152);
		gun152.cubeList.add(new ModelBox(gun152, 141, 13, 0.0F, 0.0F, -0.001F, 3, 1, 1, 0.0F, false));

		gun151 = new ModelRenderer(this);
		gun151.setRotationPoint(-3.9F, -36.9F, -36.5F);
		handguard.addChild(gun151);
		gun151.cubeList.add(new ModelBox(gun151, 157, 24, 0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F, false));

		gun150 = new ModelRenderer(this);
		gun150.setRotationPoint(-0.1F, -36.9F, -36.5F);
		handguard.addChild(gun150);
		gun150.cubeList.add(new ModelBox(gun150, 158, 20, 0.0F, 0.0F, 0.0F, 1, 5, 1, 0.0F, false));

		gun149 = new ModelRenderer(this);
		gun149.setRotationPoint(-4.0F, -36.5F, -53.5F);
		handguard.addChild(gun149);
		gun149.cubeList.add(new ModelBox(gun149, 23, 9, 0.001F, 0.0F, 0.0F, 5, 2, 12, 0.0F, false));

		gun148 = new ModelRenderer(this);
		gun148.setRotationPoint(-4.0F, -37.0F, -41.5F);
		handguard.addChild(gun148);
		gun148.cubeList.add(new ModelBox(gun148, 5, 9, 0.0F, 0.0F, 0.0F, 5, 4, 5, 0.0F, false));
	}
