...
public class ScarLCQC extends ModelWithAttachments {
	...
	public ScarLCQC() {
		...
		barrel.cubeList.add(new ModelBox(barrel, 173, 12, -2.2F, -38.0F, -62.599F, 1, 1, 34, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 160, 172, -1.8F, -38.0F, -62.601F, 1, 1, 34, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 171, 120, -2.0F, -37.8F, -62.6F, 1, 1, 34, 0.0F, false));
		barrel.cubeList.add(new ModelBox(barrel, 171, 64, -2.0F, -38.2F, -62.6F, 1, 1, 34, 0.0F, false));
