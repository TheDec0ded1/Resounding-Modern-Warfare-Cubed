...
public class QBU88Action extends ModelWithAttachments {
	...
	public QBU88Action() {
		...
		action.cubeList.add(new ModelBox(action, 146, 504, -2.081F, 1.3362F, 11.66F, 2, 2, 9, 0.0F, false));
		...
		cube_r17.setRotationPoint(0.6098F, 0.458F, -34.04F);
		action.addChild(cube_r17);
		setRotationAngle(cube_r17, 0.0F, 0.0F, -0.7854F);
		cube_r17.cubeList.add(new ModelBox(cube_r17, 201, 385, -1.0F, -1.0F, 14.0F, 1, 1, 32, -0.2F, false));

		cube_r18 = new ModelRenderer(this);
		cube_r18.setRotationPoint(1.2098F, 0.458F, -34.04F);
		action.addChild(cube_r18);
		setRotationAngle(cube_r18, 0.0F, 0.0F, -0.7854F);
		cube_r18.cubeList.add(new ModelBox(cube_r18, 134, 385, -1.0F, -1.0F, 14.0F, 1, 1, 32, -0.2F, false));

		cube_r23 = new ModelRenderer(this);
		cube_r23.setRotationPoint(-0.1801F, -0.2248F, -31.74F);
		action.addChild(cube_r23);
		setRotationAngle(cube_r23, 0.0F, 0.0F, -0.7854F);
		cube_r23.cubeList.add(new ModelBox(cube_r23, 375, 379, -0.5F, -0.3828F, 11.7F, 1, 1, 32, -0.2F, false));

		cube_r24 = new ModelRenderer(this);
		cube_r24.setRotationPoint(1.2098F, -0.142F, -34.04F);
		action.addChild(cube_r24);
		setRotationAngle(cube_r24, 0.0F, 0.0F, -0.7854F);
		cube_r24.cubeList.add(new ModelBox(cube_r24, 308, 379, -1.0F, -1.0F, 14.0F, 1, 1, 32, -0.2F, false));

		cube_r25 = new ModelRenderer(this);
		cube_r25.setRotationPoint(-0.7521F, 0.8525F, 12.06F);
		action.addChild(cube_r25);
		setRotationAngle(cube_r25, 0.0F, 0.0F, 0.4363F);
		cube_r25.cubeList.add(new ModelBox(cube_r25, 54, 504, -1.0F, -2.0F, -0.4F, 2, 3, 9, 0.0F, false));
		...
		Action7.cubeList.add(new ModelBox(Action7, 303, 533, 0.0894F, 0.199F, 0.2647F, 1, 1, 1, -0.101F, false));

		Action6 = new ModelRenderer(this);
		Action6.setRotationPoint(-3.8F, -36.2F, -25.9F);
		action2.addChild(Action6);
		Action6.cubeList.add(new ModelBox(Action6, 135, 531, 0.0F, 0.2F, -0.3F, 2, 1, 1, -0.1F, false));
		...
		Action4.cubeList.add(new ModelBox(Action4, 308, 533, -0.1399F, 0.2F, -0.4137F, 1, 1, 1, -0.1F, false));
		...
		Action5_r1.cubeList.add(new ModelBox(Action5_r1, 142, 531, -1.1953F, -0.6F, -0.4567F, 2, 1, 1, -0.199F, false));
		...
		Action5_r2.cubeList.add(new ModelBox(Action5_r2, 313, 533, -0.5659F, -0.6F, -0.4077F, 1, 1, 1, -0.199F, false));
		Action5_r2.cubeList.add(new ModelBox(Action5_r2, 318, 533, -0.3659F, -0.6F, -0.4077F, 1, 1, 1, -0.199F, false));
		...
		Action4_r1.cubeList.add(new ModelBox(Action4_r1, 149, 531, -1.1953F, -0.5F, -0.4567F, 2, 1, 1, -0.099F, false));
		...
		Action3_r1.cubeList.add(new ModelBox(Action3_r1, 323, 533, -0.3659F, -0.5F, -0.4077F, 1, 1, 1, -0.099F, false));

		Action8 = new ModelRenderer(this);
		Action8.setRotationPoint(-4.5F, -36.2F, -26.5F);
		action2.addChild(Action8);
		Action8.cubeList.add(new ModelBox(Action8, 156, 531, 0.2F, 0.2F, -0.2F, 2, 1, 1, -0.1F, false));
	}
