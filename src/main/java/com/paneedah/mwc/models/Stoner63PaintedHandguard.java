...
public class Stoner63PaintedHandguard extends ModelBase {
	...
	public Stoner63PaintedHandguard() {
		textureWidth = 576;
		textureHeight = 576;
		...
		handguard.cubeList.add(new ModelBox(handguard, 543, 67, -4.0F, -37.7071F, -62.7071F, 5, 1, 1, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 544, 540, -4.0F, -37.7071F, -38.2929F, 5, 1, 1, 0.0F, false));
		...
		cube_r1.cubeList.add(new ModelBox(cube_r1, 502, 380, 1.5F, -1.5F, -11.0F, 1, 1, 24, 0.0F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(1.7071F, -37.4142F, -51.0F);
		handguard.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, 0.0F, -0.7854F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 319, 502, -1.5F, -0.5F, -11.0F, 1, 1, 24, 0.0F, false));

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(1.0F, -40.7071F, -50.0F);
		handguard.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.0F, 0.0F, 0.7854F);
		cube_r3.cubeList.add(new ModelBox(cube_r3, 448, 511, -0.5F, -0.5F, -12.0F, 1, 1, 24, 0.0F, false));

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-4.0F, -40.7071F, -50.0F);
		handguard.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.0F, 0.0F, 0.7854F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 502, 406, -0.5F, -0.5F, -12.0F, 1, 1, 24, 0.0F, false));
		...
		cube_r5.cubeList.add(new ModelBox(cube_r5, 136, 554, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, false));
		...
		cube_r6.cubeList.add(new ModelBox(cube_r6, 141, 554, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, false));

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(1.0F, -38.7071F, -62.0F);
		handguard.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.0F, 0.7854F, 0.0F);
		cube_r7.cubeList.add(new ModelBox(cube_r7, 131, 554, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, false));

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(1.0F, -38.7071F, -38.0F);
		handguard.addChild(cube_r8);
		setRotationAngle(cube_r8, 0.0F, 0.7854F, 0.0F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 282, 553, -0.5F, -2.0F, -0.5F, 1, 4, 1, 0.0F, false));
		...
		cube_r9.cubeList.add(new ModelBox(cube_r9, 540, 508, -2.0F, -1.0F, 26.0F, 5, 1, 1, 0.0F, false));
		...
		cube_r10.cubeList.add(new ModelBox(cube_r10, 534, 276, -2.0F, -1.0F, 26.0F, 5, 1, 1, 0.0F, false));
	}
