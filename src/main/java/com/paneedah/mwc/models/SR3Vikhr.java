...
public class SR3Vikhr extends ModelWithAttachments {
	...
	public SR3Vikhr() {
		...
		gun.addChild(gun52);
		gun52.cubeList.add(new ModelBox(gun52, 130, 0, 0.0F, 0.5F, 0.0F, 3, 5, 3, 0.0F, false));

		gun51 = new ModelRenderer(this);
		gun51.setRotationPoint(-0.8F, -35.0F, -0.6F);
		gun.addChild(gun51);
		gun51.cubeList.add(new ModelBox(gun51, 49, 32, 0.0F, 0.5F, 0.0F, 1, 5, 3, 0.001F, false));
		...
		gun31.cubeList.add(new ModelBox(gun31, 68, 123, 0.0F, 0.0F, 0.0F, 2, 2, 1, 0.0F, false));
		...
		bone23.cubeList.add(new ModelBox(bone23, 181, 121, 0.05F, 0.95F, -0.35F, 5, 1, 1, 0.0F, false));
		...
		gun166.cubeList.add(new ModelBox(gun166, 102, 7, -0.1F, 2.825F, 7.55F, 1, 1, 3, -0.15F, false));
		gun166.cubeList.add(new ModelBox(gun166, 101, 7, -0.45F, 2.4F, 7.75F, 1, 1, 3, -0.35F, false));
		...
		gun25.cubeList.add(new ModelBox(gun25, 102, 7, -0.85F, 2.825F, 7.55F, 1, 1, 3, -0.15F, false));
		gun25.cubeList.add(new ModelBox(gun25, 52, 117, -0.45F, 2.4F, 7.75F, 1, 1, 3, -0.35F, false));
		...
		gun179.setRotationPoint(3.9F, 2.75F, 3.5F);
		bone23.addChild(gun179);
		setRotationAngle(gun179, -1.2654F, 0.0F, 0.0F);
		gun179.cubeList.add(new ModelBox(gun179, 192, 244, -0.376F, -1.125F, 1.0F, 1, 1, 1, 0.125F, false));
		gun179.cubeList.add(new ModelBox(gun179, 153, 245, -0.376F, -2.375F, -0.25F, 1, 1, 1, 0.125F, false));
		...
		ironsights.cubeList.add(new ModelBox(ironsights, 163, 109, -2.1F, -0.9F, 57.8F, 2, 3, 11, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 164, 109, -2.9F, -0.9F, 57.8F, 2, 3, 11, -0.299F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 158, 108, -2.9F, -1.1F, 60.75F, 1, 1, 6, -0.301F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 158, 16, -1.1F, -1.1F, 60.75F, 1, 1, 6, -0.301F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 117, 182, -2.9F, -3.96F, 64.37F, 1, 3, 2, -0.301F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 86, 73, -3.0F, -1.56F, 64.87F, 3, 2, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 86, 60, -3.0F, -1.76F, 64.87F, 3, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 86, 52, -3.0F, -1.96F, 64.87F, 3, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 125, 161, -1.0F, -2.16F, 64.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 67, -1.4F, -2.16F, 64.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 65, -1.6F, -2.16F, 64.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 61, -1.7F, -2.16F, 64.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 45, -1.7F, -2.26F, 64.87F, 1, 1, 1, -0.402F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 47, -1.6F, -2.26F, 64.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 51, -1.4F, -2.26F, 64.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 136, 159, -2.3F, -2.26F, 64.87F, 1, 1, 1, -0.402F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 159, 140, -2.4F, -2.26F, 64.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 159, 142, -2.6F, -2.26F, 64.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 160, 124, -3.0F, -2.26F, 65.72F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 160, 126, -2.3F, -2.16F, 64.87F, 1, 1, 1, -0.401F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 128, 160, -2.4F, -2.16F, 64.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 139, 160, -3.0F, -2.16F, 64.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 161, 24, -2.6F, -2.16F, 64.87F, 1, 1, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 0, 182, -1.1F, -3.96F, 64.37F, 1, 3, 2, -0.301F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 1, 181, -1.1F, -1.2F, 32.8F, 1, 5, 2, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 4, 183, -2.9F, -1.2F, 32.8F, 1, 5, 2, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 1, 181, -1.1F, 4.3F, 32.8F, 1, 2, 2, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 4, 183, -2.9F, 4.3F, 32.8F, 1, 2, 2, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 65, 21, -2.0F, -2.2F, 32.6F, 1, 2, 1, -0.4F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 2, 185, -1.1F, -1.2F, 32.4F, 1, 5, 1, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 121, 183, -2.9F, -1.2F, 32.4F, 1, 5, 1, -0.3F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 73, 81, -2.5F, -1.3F, 32.5F, 2, 1, 2, -0.201F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 2, 183, -2.5F, -0.5F, 32.6F, 2, 7, 2, -0.201F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 1, 182, -3.0F, 1.7F, 29.9F, 3, 3, 3, 0.049F, false));
		ironsights.cubeList.add(new ModelBox(ironsights, 0, 181, -2.5F, 2.2F, 27.3F, 2, 2, 4, 0.049F, false));
		...
		cube_r45.cubeList.add(new ModelBox(cube_r45, 113, 181, 0.398F, -8.8221F, 3.0699F, 1, 3, 5, -0.302F, false));
		cube_r45.cubeList.add(new ModelBox(cube_r45, 114, 182, -1.402F, -8.8221F, 3.0699F, 1, 3, 5, -0.302F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-1.499F, -3.6902F, 53.1199F);
		ironsights.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.9774F, 0.0F, 0.0F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 113, 181, 0.398F, 9.2918F, 1.7353F, 1, 3, 5, -0.302F, false));
		cube_r2.cubeList.add(new ModelBox(cube_r2, 114, 182, -1.402F, 9.2918F, 1.7353F, 1, 3, 5, -0.302F, false));
		...
		ironsights_r1.cubeList.add(new ModelBox(ironsights_r1, 1, 181, -0.5F, -0.5F, -1.0F, 1, 1, 2, -0.3F, false));
		...
		ironsights_r2.cubeList.add(new ModelBox(ironsights_r2, 1, 181, -0.5F, 0.5F, -1.0F, 1, 2, 2, -0.3F, false));
		...
		ironsights_r3.cubeList.add(new ModelBox(ironsights_r3, 4, 183, -0.5F, -1.5F, -1.0F, 1, 1, 2, -0.3F, false));
		...
		ironsights_r4.cubeList.add(new ModelBox(ironsights_r4, 4, 183, -0.5F, 0.5F, -1.0F, 1, 2, 2, -0.3F, false));
