...
public class SVDS extends ModelWithAttachments
{
	...
	public SVDS() {
		...
		gun.cubeList.add(new ModelBox(gun, 191, 192, -3.0F, -1.0F, -1.0F, 3, 5, 1, 0.0F, false));
		...
		gun.cubeList.add(new ModelBox(gun, 136, 155, -3.7F, 4.0F, -8.0F, 1, 1, 3, 0.0F, false));
		gun.cubeList.add(new ModelBox(gun, 111, 146, -3.3F, 4.0F, -8.0F, 4, 1, 3, 0.001F, false));
		gun.cubeList.add(new ModelBox(gun, 56, 72, -3.7F, 4.0F, -5.0F, 1, 1, 3, 0.0F, false));
		gun.cubeList.add(new ModelBox(gun, 62, 39, -3.3F, 4.0F, -5.0F, 4, 1, 3, 0.001F, false));
		gun.cubeList.add(new ModelBox(gun, 107, 84, -3.7F, 4.0F, -2.0F, 1, 1, 2, 0.0F, false));
		gun.cubeList.add(new ModelBox(gun, 63, 40, -3.3F, 4.0F, -2.0F, 4, 1, 2, 0.001F, false));
