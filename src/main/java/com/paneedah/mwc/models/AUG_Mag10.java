...
public class AUG_Mag10 extends ModelBase {
	...
	public AUG_Mag10() {
		...
		cube_r1_r1.setRotationPoint(0.0F, 1.6721F, -3.1984F);
		cube_r1.addChild(cube_r1_r1);
		setRotationAngle(cube_r1_r1, 0.1745F, 0.0F, 0.0F);
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 14, 25, -1.5F, -2.039F, -2.1824F, 3, 3, 8, 0.0F, false));
		cube_r1_r1.cubeList.add(new ModelBox(cube_r1_r1, 0, 0, -1.5F, -0.039F, -2.4824F, 3, 1, 1, 0.0F, false));
		...
		cube_r5_r1.setRotationPoint(0.0F, -9.1136F, -3.2956F);
		cube_r5.addChild(cube_r5_r1);
		setRotationAngle(cube_r5_r1, 0.1745F, 0.0F, 0.0F);
		cube_r5_r1.cubeList.add(new ModelBox(cube_r5_r1, 20, 47, -1.75F, -0.0818F, -2.4255F, 1, 1, 8, 0.0F, false));
		cube_r5_r1.cubeList.add(new ModelBox(cube_r5_r1, 48, 13, 0.75F, -0.0818F, -2.4255F, 1, 1, 8, 0.0F, false));
		...
		cube_r6_r1.setRotationPoint(0.0F, -9.366F, -2.4894F);
		cube_r6.addChild(cube_r6_r1);
		setRotationAngle(cube_r6_r1, 0.1745F, 0.0F, 0.0F);
		cube_r6_r1.cubeList.add(new ModelBox(cube_r6_r1, 28, 11, -1.75F, -1.5083F, -2.0801F, 1, 1, 8, -0.1F, false));
		cube_r6_r1.cubeList.add(new ModelBox(cube_r6_r1, 28, 20, 0.75F, -1.5083F, -2.0801F, 1, 1, 8, -0.1F, false));
