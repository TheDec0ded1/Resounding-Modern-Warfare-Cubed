...
public class Type562Handguard extends ModelBase {
	...
	public Type562Handguard() {
		...
		gun193.cubeList.add(new ModelBox(gun193, 83, 25, 0.0F, -0.5F, 0.0F, 3, 1, 1, 0.0F, false));
		...
		gun192.cubeList.add(new ModelBox(gun192, 97, 124, -0.001F, 0.4291F, 0.2567F, 3, 2, 5, 0.0F, false));
		...
		gun190.cubeList.add(new ModelBox(gun190, 41, 77, -0.001F, 0.2607F, 0.4267F, 5, 1, 1, 0.0F, false));
		...
		gun189.cubeList.add(new ModelBox(gun189, 117, 79, -0.001F, 0.4291F, 0.2567F, 5, 2, 5, 0.0F, false));
		gun189.cubeList.add(new ModelBox(gun189, 121, 83, -0.001F, 0.4291F, 5.2567F, 5, 2, 1, 0.0F, false));

		gun188 = new ModelRenderer(this);
		gun188.setRotationPoint(-4.0F, -33.5F, -38.5F);
		handguard.addChild(gun188);
		gun188.cubeList.add(new ModelBox(gun188, 47, 23, 0.001F, -0.5F, 0.0F, 5, 3, 1, 0.0F, false));
		...
		gun164.cubeList.add(new ModelBox(gun164, 41, 57, 0.001F, 0.3F, 0.0F, 5, 1, 12, 0.0F, false));
		gun164.cubeList.add(new ModelBox(gun164, 41, 57, -0.001F, 2.036F, 0.3231F, 5, 1, 12, 0.0F, false));
		...
		gun161.cubeList.add(new ModelBox(gun161, 0, 70, 0.0F, -0.2F, 0.0F, 5, 1, 7, 0.0F, false));
		gun161.cubeList.add(new ModelBox(gun161, 2, 72, 0.0F, -0.2F, -5.0F, 5, 1, 5, 0.0F, false));
