...
public class MP540Mag extends ModelBase {
	...
	public MP540Mag() {
		...
		magazine30.cubeList.add(new ModelBox(magazine30, 128, 120, -1.0F, -11.375F, 4.65F, 2, 2, 2, 0.0F, false));
		...
		bone23.cubeList.add(new ModelBox(bone23, 118, 90, -2.1F, 0.4992F, -1.9F, 4, 2, 2, 0.0F, false));
		bone23.cubeList.add(new ModelBox(bone23, 186, 191, -2.1F, 9.4992F, -1.9F, 4, 2, 2, 0.0F, false));
		bone23.cubeList.add(new ModelBox(bone23, 231, 152, -2.0F, -1.0008F, -3.75F, 4, 1, 5, -0.25F, false));
		bone23.cubeList.add(new ModelBox(bone23, 145, 244, -2.0F, 14.9992F, -3.75F, 4, 1, 5, -0.25F, false));
		...
		cube_r21.cubeList.add(new ModelBox(cube_r21, 222, 101, -6.1311F, -4.6048F, -1.0054F, 1, 1, 2, 0.0F, false));

		cube_r22 = new ModelRenderer(this);
		cube_r22.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone23.addChild(cube_r22);
		setRotationAngle(cube_r22, 0.0F, 0.0F, -0.3491F);
		cube_r22.cubeList.add(new ModelBox(cube_r22, 142, 139, 2.312F, -5.6309F, -1.0054F, 1, 1, 2, 0.0F, false));
