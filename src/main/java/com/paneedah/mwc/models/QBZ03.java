...
public class QBZ03 extends ModelWithAttachments {
	...
	public QBZ03() {
		...
		gun.cubeList.add(new ModelBox(gun, 396, 11, -2.0F, -31.1F, -7.6F, 1, 1, 1, 0.0F, false));
		gun.cubeList.add(new ModelBox(gun, 153, 372, -2.5F, -32.1F, -6.2F, 2, 5, 2, 0.0F, false));
		gun.cubeList.add(new ModelBox(gun, 351, 376, -2.5F, -28.1F, -10.2F, 2, 1, 4, 0.0F, false));
		...
		gun.cubeList.add(new ModelBox(gun, 140, 389, -0.5132F, -36.0096F, -24.3F, 2, 1, 2, -0.3F, false));
		gun.cubeList.add(new ModelBox(gun, 389, 81, -4.4868F, -36.0096F, -24.3F, 2, 1, 2, -0.3F, false));
		gun.cubeList.add(new ModelBox(gun, 371, 218, -4.3F, -33.1071F, -24.2414F, 1, 1, 9, -0.3F, false));
		gun.cubeList.add(new ModelBox(gun, 350, 291, -4.3F, -35.5071F, -25.2414F, 1, 3, 2, -0.3F, false));
		gun.cubeList.add(new ModelBox(gun, 389, 75, 0.3F, -35.5071F, -25.2414F, 1, 3, 2, -0.3F, false));
		gun.cubeList.add(new ModelBox(gun, 123, 390, 0.3F, -36.0071F, -25.2414F, 1, 2, 2, -0.3F, false));
		gun.cubeList.add(new ModelBox(gun, 389, 377, -4.3F, -36.0071F, -25.2414F, 1, 2, 2, -0.3F, false));
		...
		gun.cubeList.add(new ModelBox(gun, 383, 291, -2.6F, -34.9292F, -3.6572F, 4, 2, 2, -0.25F, false));
		gun.cubeList.add(new ModelBox(gun, 389, 367, -0.75F, -34.4292F, -26.7072F, 2, 1, 2, 0.0F, false));
		gun.cubeList.add(new ModelBox(gun, 259, 395, -4.05F, -34.7292F, -0.6072F, 2, 1, 1, 0.0F, false));
		gun.cubeList.add(new ModelBox(gun, 174, 397, -4.85F, -33.4292F, 2.3928F, 1, 1, 1, -0.2F, false));
		gun.cubeList.add(new ModelBox(gun, 179, 397, -4.85F, -35.2292F, 3.7928F, 1, 1, 1, -0.2F, false));
		gun.cubeList.add(new ModelBox(gun, 395, 396, 0.85F, -33.4292F, 2.3928F, 1, 1, 1, -0.2F, false));
		gun.cubeList.add(new ModelBox(gun, 389, 35, -1.75F, -35.9292F, 1.7928F, 4, 1, 1, -0.2F, false));
		gun.cubeList.add(new ModelBox(gun, 383, 382, -2.55F, -34.4292F, -2.8072F, 4, 1, 2, -0.2F, false));
		gun.cubeList.add(new ModelBox(gun, 389, 371, 1.25F, -37.4292F, 1.2928F, 1, 3, 2, -0.3F, false));
		gun.cubeList.add(new ModelBox(gun, 389, 72, -4.95F, -35.9292F, 1.7928F, 4, 1, 1, -0.2F, false));
		gun.cubeList.add(new ModelBox(gun, 189, 397, 0.85F, -35.2292F, 3.7928F, 1, 1, 1, -0.2F, false));
		...
		barrelandreciever_r1.cubeList.add(new ModelBox(barrelandreciever_r1, 35, 396, -2.8F, -0.5F, -0.5F, 1, 1, 1, -0.3F, false));
		barrelandreciever_r1.cubeList.add(new ModelBox(barrelandreciever_r1, 396, 38, 1.8F, -0.5F, -0.5F, 1, 1, 1, -0.3F, false));
		...
		barrelandreciever_r2.cubeList.add(new ModelBox(barrelandreciever_r2, 25, 396, -2.8F, -0.5F, -0.3F, 1, 1, 1, -0.3F, false));
		barrelandreciever_r2.cubeList.add(new ModelBox(barrelandreciever_r2, 30, 396, 1.8F, -0.5F, -0.3F, 1, 1, 1, -0.3F, false));
		...
		handguard_r3.cubeList.add(new ModelBox(handguard_r3, 296, 389, -1.0F, -0.5F, -0.5F, 2, 1, 2, 0.0F, false));
		...
		handguard_r4.cubeList.add(new ModelBox(handguard_r4, 0, 383, -1.0F, -0.5F, -3.5F, 2, 1, 5, 0.0F, false));
		...
		handguard_r5.cubeList.add(new ModelBox(handguard_r5, 326, 382, -0.5F, -1.5F, -0.5F, 1, 2, 1, 0.0F, false));
		...
		handguard_r6.cubeList.add(new ModelBox(handguard_r6, 20, 396, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0.0F, false));
		...
		handguard_r7.cubeList.add(new ModelBox(handguard_r7, 15, 396, -0.5F, -0.5F, -0.5F, 1, 1, 1, 0.0F, false));
	}
