...
public class AK47T2Stock extends ModelBase {
	...
	public AK47T2Stock() {
		...
		stock.setRotationPoint(0.0F, 24.7F, 2.4F);
		

		gun368_r1 = new ModelRenderer(this);
		gun368_r1.setRotationPoint(-1.5F, -33.499F, 1.499F);
		stock.addChild(gun368_r1);
		setRotationAngle(gun368_r1, -0.1745F, 0.0F, 0.0F);
		gun368_r1.cubeList.add(new ModelBox(gun368_r1, 0, 54, -2.0F, -2.8F, -2.0F, 4, 5, 4, 0.0F, false));
		gun368_r1.cubeList.add(new ModelBox(gun368_r1, 0, 54, -2.0F, -2.4F, -2.0F, 4, 5, 4, 0.0F, false));
