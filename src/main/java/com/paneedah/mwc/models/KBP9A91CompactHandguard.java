...
public class KBP9A91CompactHandguard extends ModelBase {
	...
	public KBP9A91CompactHandguard() {
		...
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 44, 152, -1.8F, -4.9F, -13.0F, 1, 1, 12, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 21, 23, -1.8F, -2.9F, -15.0F, 1, 4, 1, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 0, 23, -1.95F, -4.0F, -1.25F, 1, 1, 1, 0.05F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 62, 15, -1.95F, -4.5F, -4.35F, 1, 1, 3, 0.05F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 21, 23, -1.8F, -3.9F, -15.0F, 1, 1, 1, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 109, 52, -1.8F, -3.9F, -1.0F, 1, 1, 1, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 21, 104, -1.8F, 0.7F, -15.0F, 1, 1, 1, -0.002F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 109, 48, -3.0F, 1.7F, -15.0F, 1, 1, 1, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 0, 7, -4.2F, -2.9F, -15.0F, 1, 4, 1, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 91, 82, -4.2F, 0.7F, -15.0F, 1, 1, 1, -0.002F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 74, 149, -4.2F, -4.9F, -13.0F, 1, 1, 12, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 85, 160, -4.2F, -4.9F, -14.0F, 1, 1, 1, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 55, 163, -1.8F, -4.9F, -14.0F, 1, 1, 1, 0.0F, false));
		...
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 0, 7, -4.2F, -3.9F, -15.0F, 1, 1, 1, 0.0F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 30, 0, -4.05F, -4.5F, -4.35F, 1, 1, 3, 0.05F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 0, 16, -4.05F, -4.0F, -1.25F, 1, 1, 1, 0.05F, false));
		Handguard_COMPACT.cubeList.add(new ModelBox(Handguard_COMPACT, 93, 21, -4.2F, -3.9F, -1.0F, 1, 1, 1, 0.0F, false));
		...
		cube_r30.cubeList.add(new ModelBox(cube_r30, 0, 152, 1.28F, -6.4F, -12.05F, 1, 1, 9, 0.05F, false));
		cube_r30.cubeList.add(new ModelBox(cube_r30, 8, 160, 1.2625F, -6.0F, -13.0498F, 1, 4, 1, 0.05F, false));
		cube_r30.cubeList.add(new ModelBox(cube_r30, 8, 160, 1.2625F, -6.4F, -13.0498F, 1, 1, 1, 0.05F, false));
		...
		cube_r32.cubeList.add(new ModelBox(cube_r32, 93, 19, 0.0F, -0.3071F, -0.2929F, 1, 1, 1, 0.002F, false));
		cube_r32.cubeList.add(new ModelBox(cube_r32, 93, 11, 0.0F, -0.7071F, -0.2929F, 1, 1, 1, 0.001F, false));
		cube_r32.cubeList.add(new ModelBox(cube_r32, 100, 108, 2.4F, -0.7071F, -0.2929F, 1, 1, 1, 0.001F, false));
		cube_r32.cubeList.add(new ModelBox(cube_r32, 94, 108, 2.4F, -0.3071F, -0.2929F, 1, 1, 1, 0.002F, false));
		...
		cube_r33.cubeList.add(new ModelBox(cube_r33, 93, 5, 0.0F, 0.0F, -1.4142F, 1, 1, 1, 0.001F, false));
		cube_r33.cubeList.add(new ModelBox(cube_r33, 91, 84, 0.0F, 0.4F, -1.4142F, 1, 1, 1, 0.002F, false));
		cube_r33.cubeList.add(new ModelBox(cube_r33, 106, 108, 2.4F, 0.4F, -1.4142F, 1, 1, 1, 0.002F, false));
		cube_r33.cubeList.add(new ModelBox(cube_r33, 109, 36, 2.4F, 0.0F, -1.4142F, 1, 1, 1, 0.001F, false));
		...
		cube_r34.cubeList.add(new ModelBox(cube_r34, 24, 91, 0.0F, 0.55F, -2.0F, 1, 1, 1, -0.002F, false));
		cube_r34.cubeList.add(new ModelBox(cube_r34, 74, 89, 0.0F, 0.0F, -2.0F, 1, 1, 1, -0.001F, false));
		...
		cube_r36.cubeList.add(new ModelBox(cube_r36, 109, 40, -1.0F, 0.55F, -2.0F, 1, 1, 1, -0.002F, false));
		cube_r36.cubeList.add(new ModelBox(cube_r36, 109, 45, -1.0F, 0.0F, -2.0F, 1, 1, 1, -0.001F, false));
		...
		cube_r37.cubeList.add(new ModelBox(cube_r37, 0, 175, -2.28F, -6.4F, -12.05F, 1, 1, 9, 0.05F, false));
		cube_r37.cubeList.add(new ModelBox(cube_r37, 8, 183, -2.2625F, -6.0F, -13.0498F, 1, 4, 1, 0.05F, false));
		cube_r37.cubeList.add(new ModelBox(cube_r37, 8, 183, -2.2625F, -6.4F, -13.0498F, 1, 1, 1, 0.05F, false));
