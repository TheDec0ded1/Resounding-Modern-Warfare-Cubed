...
//        .withDrawSound("mg42_reload")
        ...
        .withRecoilParam(new RecoilParam(
         ...
         .withCompatibleAttachment(Attachments.M249HandGuard, (model) -> {
         })
         .withCompatibleAttachment(Attachments2.MinimiHandguard, true, (model) -> {
         })
         .withCompatibleAttachment(Attachments.M249UpperHandGuard, (model) -> {
         })
         .withCompatibleAttachment(Attachments.M249Stock, (model) -> {
         })
         .withCompatibleAttachment(Attachments.M249ParaStock, (model) -> {
         })
         .withCompatibleAttachment(Attachments2.MinimiStock, true, (model) -> {
         })
...
//            GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.MinimiHatch, true, (model) -> {
...
//                .setupCustomKeyedPart(AuxiliaryAttachments.M249Belt2, "m249", "belt2")
                .setupCustomKeyedPart(AuxiliaryAttachments.MinimiHatch, "m249", "hatch")
