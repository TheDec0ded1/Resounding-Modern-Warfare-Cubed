...
public class G36CHG extends ModelBase {
	...
	public G36CHG() {
		...
		handguard.cubeList.add(new ModelBox(handguard, 62, 82, -2.55F, -33.0F, -42.75F, 2, 2, 2, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 57, 65, -2.55F, -33.0F, -54.75F, 2, 2, 2, 0.0F, false));
