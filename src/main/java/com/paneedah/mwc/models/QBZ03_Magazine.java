...
public class QBZ03_Magazine extends ModelBase {
	...
	public QBZ03_Magazine() {
		...
		segment.cubeList.add(new ModelBox(segment, 395, 281, -2.0F, -2.1554F, 6.121F, 2, 1, 1, 0.0F, false));
		...
		segment2.cubeList.add(new ModelBox(segment2, 284, 388, -1.0F, -0.8639F, 1.3547F, 2, 5, 1, 0.0F, false));
		segment2.cubeList.add(new ModelBox(segment2, 358, 291, -2.0F, -0.8119F, -6.4573F, 4, 5, 8, 0.0F, false));
		segment2.cubeList.add(new ModelBox(segment2, 194, 391, -2.5F, -0.4441F, -6.0412F, 1, 4, 1, -0.2F, false));
		segment2.cubeList.add(new ModelBox(segment2, 199, 391, 1.5F, -0.4441F, -6.0412F, 1, 4, 1, -0.2F, false));
		segment2.cubeList.add(new ModelBox(segment2, 0, 390, -2.5F, -0.6969F, -3.1523F, 1, 5, 1, -0.2F, false));
		segment2.cubeList.add(new ModelBox(segment2, 5, 390, 1.5F, -0.6969F, -3.1523F, 1, 5, 1, -0.2F, false));
		segment2.cubeList.add(new ModelBox(segment2, 204, 391, 1.5F, -0.9583F, -0.1637F, 1, 4, 1, -0.2F, false));
		segment2.cubeList.add(new ModelBox(segment2, 209, 391, -2.5F, -0.9583F, -0.1637F, 1, 4, 1, -0.2F, false));
		...
		segment3.cubeList.add(new ModelBox(segment3, 351, 388, -1.0F, -1.0882F, 0.7922F, 2, 5, 1, 0.0F, false));
		...
		segment3.cubeList.add(new ModelBox(segment3, 214, 391, 1.5F, -1.0702F, -6.6406F, 1, 4, 1, -0.2F, false));
		segment3.cubeList.add(new ModelBox(segment3, 219, 391, -2.5F, -1.0702F, -6.6406F, 1, 4, 1, -0.2F, false));
		segment3.cubeList.add(new ModelBox(segment3, 10, 390, 1.5F, -1.6979F, -3.8093F, 1, 5, 1, -0.2F, false));
		segment3.cubeList.add(new ModelBox(segment3, 44, 390, -2.5F, -1.6979F, -3.8093F, 1, 5, 1, -0.2F, false));
		segment3.cubeList.add(new ModelBox(segment3, 347, 28, 1.5F, -2.3472F, -0.8804F, 1, 6, 1, -0.2F, false));
		segment3.cubeList.add(new ModelBox(segment3, 291, 388, -2.5F, -2.3472F, -0.8804F, 1, 6, 1, -0.2F, false));
		...
		segment4.cubeList.add(new ModelBox(segment4, 49, 390, 1.5F, -2.5425F, -2.2826F, 1, 5, 1, -0.2F, false));
		segment4.cubeList.add(new ModelBox(segment4, 54, 390, 1.5F, -2.7651F, -5.224F, 1, 5, 1, -0.2F, false));
		segment4.cubeList.add(new ModelBox(segment4, 381, 144, 1.5F, 0.307F, -8.6239F, 1, 1, 8, -0.2F, false));
		segment4.cubeList.add(new ModelBox(segment4, 103, 390, 1.5F, -3.0136F, -8.0688F, 1, 5, 1, -0.2F, false));
		segment4.cubeList.add(new ModelBox(segment4, 108, 390, -2.5F, -2.5425F, -2.2826F, 1, 5, 1, -0.2F, false));
		segment4.cubeList.add(new ModelBox(segment4, 190, 381, -2.5F, 0.307F, -8.6239F, 1, 1, 8, -0.2F, false));
		segment4.cubeList.add(new ModelBox(segment4, 113, 390, -2.5F, -2.7651F, -5.224F, 1, 5, 1, -0.2F, false));
		segment4.cubeList.add(new ModelBox(segment4, 118, 390, -2.5F, -3.0136F, -8.0688F, 1, 5, 1, -0.2F, false));
		...
		cube_r4.cubeList.add(new ModelBox(cube_r4, 358, 388, -2.0F, -3.5896F, 5.8724F, 2, 5, 1, 0.0F, false));
		...
		bone3.cubeList.add(new ModelBox(bone3, 344, 386, -2.0F, -3.5896F, 5.8724F, 2, 5, 1, 0.0F, false));
		bone3.cubeList.add(new ModelBox(bone3, 295, 28, -3.0F, 1.2933F, -2.2675F, 4, 1, 9, 0.1F, false));
		bone3.cubeList.add(new ModelBox(bone3, 372, 389, 0.5F, -4.2146F, 4.4877F, 1, 5, 1, -0.2F, false));
		bone3.cubeList.add(new ModelBox(bone3, 209, 381, 0.5F, 0.135F, -1.9535F, 1, 1, 8, -0.2F, false));
		bone3.cubeList.add(new ModelBox(bone3, 391, 0, 0.5F, -3.7952F, 1.5679F, 1, 5, 1, -0.2F, false));
		bone3.cubeList.add(new ModelBox(bone3, 97, 391, 0.5F, -3.4221F, -1.2633F, 1, 4, 1, -0.2F, false));
		bone3.cubeList.add(new ModelBox(bone3, 377, 389, -3.5F, -4.2146F, 4.4877F, 1, 5, 1, -0.2F, false));
		bone3.cubeList.add(new ModelBox(bone3, 25, 382, -3.5F, 0.135F, -1.9535F, 1, 1, 8, -0.2F, false));
		bone3.cubeList.add(new ModelBox(bone3, 391, 7, -3.5F, -3.7952F, 1.5679F, 1, 5, 1, -0.2F, false));
		bone3.cubeList.add(new ModelBox(bone3, 189, 391, -3.5F, -3.4221F, -1.2633F, 1, 4, 1, -0.2F, false));
	}
