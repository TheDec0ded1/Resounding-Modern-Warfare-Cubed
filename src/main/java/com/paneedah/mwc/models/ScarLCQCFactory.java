...
public class ScarLCQCFactory implements GunFactory {
...
//          GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Attachments2.ScarLReceiverB, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.ScarLCQCBody, true, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.ScarLCQCBodyB, (model) -> {
//          GL11.glTranslatef(0f, 0f, 1f);
        })
