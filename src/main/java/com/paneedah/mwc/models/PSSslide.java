...
public class PSSslide extends ModelWithAttachments {
	...
	private final ModelRenderer slide74;
	private final ModelRenderer slide76;
	...
	public PSSslide() {
		...
		slide.setRotationPoint(0.0F, 24.4F, 0.1F);
		slide.cubeList.add(new ModelBox(slide, 0, 65, -2.55F, -36.1F, 0.698F, 2, 3, 1, 0.0F, false));
		slide.cubeList.add(new ModelBox(slide, 80, 2, -2.0F, -36.1F, 0.998F, 1, 1, 1, -0.2F, false));
		...
		slide96.cubeList.add(new ModelBox(slide96, 80, 4, -1.4658F, 0.1816F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		slide95.cubeList.add(new ModelBox(slide95, 67, 36, -1.4658F, 0.1816F, -3.0F, 1, 1, 2, 0.0F, false));
		...
		slide94.cubeList.add(new ModelBox(slide94, 80, 8, -1.4658F, 0.1816F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		slide93.cubeList.add(new ModelBox(slide93, 15, 15, -1.4658F, 0.1806F, 15.0F, 1, 1, 6, 0.0F, false));
		...
		slide92.cubeList.add(new ModelBox(slide92, 49, 68, 0.4658F, 0.1816F, 15.0F, 1, 1, 12, 0.0F, false));
		...
		slide85.cubeList.add(new ModelBox(slide85, 80, 64, 0.2F, -8.1317F, 6.8603F, 1, 1, 1, 0.0F, false));
		slide85.cubeList.add(new ModelBox(slide85, 80, 64, 0.2F, -20.8597F, 19.5868F, 1, 1, 1, 0.0F, false));

		slide83 = new ModelRenderer(this);
		slide83.setRotationPoint(-2.2F, -37.1F, -30.2F);
		slide.addChild(slide83);
		slide83.cubeList.add(new ModelBox(slide83, 35, 69, 0.2F, -0.9F, 11.6F, 1, 1, 1, 0.0F, false));
		slide83.cubeList.add(new ModelBox(slide83, 35, 69, 0.2F, -0.9F, 30.6F, 1, 1, 1, 0.0F, false));
		slide83.cubeList.add(new ModelBox(slide83, 40, 94, 0.2F, -1.7F, 11.2F, 1, 2, 2, -0.4F, false));
		slide83.cubeList.add(new ModelBox(slide83, 41, 95, 0.0F, -1.7F, 30.7F, 1, 2, 1, -0.4F, false));
		slide83.cubeList.add(new ModelBox(slide83, 41, 95, -0.2F, -1.7F, 30.7F, 1, 2, 1, -0.4F, false));
		slide83.cubeList.add(new ModelBox(slide83, 41, 95, 0.4F, -1.7F, 30.7F, 1, 2, 1, -0.4F, false));
		slide83.cubeList.add(new ModelBox(slide83, 41, 95, 0.6F, -1.7F, 30.7F, 1, 2, 1, -0.4F, false));
		...
		slide81.cubeList.add(new ModelBox(slide81, 45, 68, -0.199F, 0.0F, 1.1F, 1, 1, 2, 0.0F, false));
		slide81.cubeList.add(new ModelBox(slide81, 5, 53, -2.001F, 0.0F, 1.1F, 1, 1, 2, 0.0F, false));
		slide81.cubeList.add(new ModelBox(slide81, 20, 78, -1.801F, -0.2F, 0.3F, 1, 1, 1, -0.2F, false));
		slide81.cubeList.add(new ModelBox(slide81, 3, 78, -0.399F, -0.2F, 0.3F, 1, 1, 1, -0.2F, false));
		...
		slide80.cubeList.add(new ModelBox(slide80, 80, 66, -0.2F, 0.0F, 0.8F, 1, 1, 1, 0.0F, false));
		...
		slide79.cubeList.add(new ModelBox(slide79, 0, 81, 0.2F, 0.0F, 0.8F, 1, 1, 1, 0.0F, false));
		...
		slide73.cubeList.add(new ModelBox(slide73, 42, 22, -0.499F, 0.0F, 0.0F, 1, 2, 1, 0.0F, false));
		slide73.cubeList.add(new ModelBox(slide73, 14, 27, -3.299F, 0.0F, 0.0F, 1, 2, 1, 0.0F, false));
		slide73.cubeList.add(new ModelBox(slide73, 14, 30, -1.0F, -0.0738F, -0.0675F, 1, 2, 1, 0.0F, false));
		slide73.cubeList.add(new ModelBox(slide73, 15, 22, -2.8F, -0.0738F, -0.0675F, 1, 2, 1, 0.0F, false));
		...
		slide72.cubeList.add(new ModelBox(slide72, 4, 81, -0.5F, 0.0F, 0.8F, 1, 1, 1, 0.0F, false));
		...
		slide71.cubeList.add(new ModelBox(slide71, 81, 12, 0.5F, 0.0F, 0.8F, 1, 1, 1, 0.0F, false));
		...
		slide68.cubeList.add(new ModelBox(slide68, 81, 22, -0.5F, -1.128F, 1.24F, 1, 1, 1, 0.0F, false));
		...
		slide67.cubeList.add(new ModelBox(slide67, 54, 69, -0.5F, -1.6744F, 0.0792F, 1, 1, 2, 0.0F, false));
		...
		slide66.cubeList.add(new ModelBox(slide66, 81, 25, -0.5F, -0.7778F, 1.4849F, 1, 1, 1, 0.0F, false));
		...
		slide65.cubeList.add(new ModelBox(slide65, 26, 81, -0.5F, -0.7778F, 1.4849F, 1, 1, 1, 0.0F, false));

		slide64 = new ModelRenderer(this);
		slide64.setRotationPoint(-3.8F, -35.5F, -6.5F);
		slide.addChild(slide64);
		slide64.cubeList.add(new ModelBox(slide64, 14, 65, 0.5F, 0.0F, 0.0F, 1, 2, 8, 0.0F, false));
		slide64.cubeList.add(new ModelBox(slide64, 67, 13, 0.499F, 1.4F, 0.0F, 1, 1, 8, 0.0F, false));
		...
		slide63.cubeList.add(new ModelBox(slide63, 42, 40, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide62.cubeList.add(new ModelBox(slide62, 19, 53, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide61.cubeList.add(new ModelBox(slide61, 39, 53, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide60.cubeList.add(new ModelBox(slide60, 54, 0, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide59.cubeList.add(new ModelBox(slide59, 54, 5, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide58.cubeList.add(new ModelBox(slide58, 54, 13, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide57.cubeList.add(new ModelBox(slide57, 54, 18, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide56.cubeList.add(new ModelBox(slide56, 54, 26, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide55.cubeList.add(new ModelBox(slide55, 54, 33, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide54.cubeList.add(new ModelBox(slide54, 54, 38, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide53.cubeList.add(new ModelBox(slide53, 19, 59, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide52.cubeList.add(new ModelBox(slide52, 27, 59, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide51.cubeList.add(new ModelBox(slide51, 60, 0, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide50.cubeList.add(new ModelBox(slide50, 60, 5, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide49.cubeList.add(new ModelBox(slide49, 60, 13, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide48.cubeList.add(new ModelBox(slide48, 60, 18, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide47.cubeList.add(new ModelBox(slide47, 60, 33, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide46.cubeList.add(new ModelBox(slide46, 60, 38, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide45.cubeList.add(new ModelBox(slide45, 67, 26, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide44.cubeList.add(new ModelBox(slide44, 69, 53, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide43.cubeList.add(new ModelBox(slide43, 69, 56, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));

		slide42 = new ModelRenderer(this);
		slide42.setRotationPoint(-0.2F, -35.5F, -6.5F);
		slide.addChild(slide42);
		slide42.cubeList.add(new ModelBox(slide42, 16, 65, -0.5F, 0.0F, 0.0F, 1, 2, 2, 0.0F, false));
		slide42.cubeList.add(new ModelBox(slide42, 16, 65, -0.5F, 0.0F, 2.0F, 1, 2, 2, 0.0F, false));
		slide42.cubeList.add(new ModelBox(slide42, 34, 65, -0.499F, 1.4F, 0.0F, 1, 1, 2, 0.0F, false));

		slide41 = new ModelRenderer(this);
		slide41.setRotationPoint(-0.2F, -35.5F, -0.5F);
		slide.addChild(slide41);
		slide41.cubeList.add(new ModelBox(slide41, 26, 53, -0.5F, 0.0F, 0.0F, 1, 2, 2, 0.0F, false));
		slide41.cubeList.add(new ModelBox(slide41, 55, 66, -0.499F, 1.4F, 0.0F, 1, 1, 2, 0.0F, false));

		slide40 = new ModelRenderer(this);
		slide40.setRotationPoint(-0.3F, -35.5F, -4.0F);
		slide.addChild(slide40);
		slide40.cubeList.add(new ModelBox(slide40, 67, 13, -0.5F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));
		slide40.cubeList.add(new ModelBox(slide40, 67, 13, -0.5F, 1.0F, 0.0F, 1, 1, 3, 0.0F, false));
		slide40.cubeList.add(new ModelBox(slide40, 67, 13, -0.5F, 0.0F, -0.6F, 1, 1, 3, 0.0F, false));

		slide38 = new ModelRenderer(this);
		slide38.setRotationPoint(-0.1F, -35.5F, -4.9F);
		slide.addChild(slide38);
		slide38.cubeList.add(new ModelBox(slide38, 9, 73, -0.497F, 0.0F, 1.799F, 1, 2, 1, 0.0F, false));

		slide37 = new ModelRenderer(this);
		slide37.setRotationPoint(-0.1F, -35.5F, -1.1F);
		slide.addChild(slide37);
		slide37.cubeList.add(new ModelBox(slide37, 74, 64, -0.499F, 0.0F, 1.599F, 1, 2, 1, 0.0F, false));
		...
		slide36.cubeList.add(new ModelBox(slide36, 12, 75, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide35.cubeList.add(new ModelBox(slide35, 20, 75, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide34.cubeList.add(new ModelBox(slide34, 27, 75, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide33.cubeList.add(new ModelBox(slide33, 34, 75, -3.0405F, 0.0F, 3.7477F, 1, 2, 1, 0.0F, false));
		...
		slide32.cubeList.add(new ModelBox(slide32, 75, 53, -3.0405F, 0.0F, 3.7477F, 1, 2, 1, 0.0F, false));
		...
		slide31.cubeList.add(new ModelBox(slide31, 75, 58, -3.0405F, 0.0F, 3.7477F, 1, 2, 1, 0.0F, false));

		slide74 = new ModelRenderer(this);
		slide74.setRotationPoint(0.9F, -35.5F, 1.3F);
		slide.addChild(slide74);
		setRotationAngle(slide74, 0.0F, -2.3562F, 0.0F);
		slide74.cubeList.add(new ModelBox(slide74, 75, 58, -3.0405F, 0.0F, 3.7477F, 1, 2, 1, 0.0F, false));

		slide76 = new ModelRenderer(this);
		slide76.setRotationPoint(0.9F, -35.5F, 1.7F);
		slide.addChild(slide76);
		setRotationAngle(slide76, 0.0F, -2.3562F, 0.0F);
		slide76.cubeList.add(new ModelBox(slide76, 75, 58, -3.0405F, 0.0F, 3.7477F, 1, 2, 1, 0.0F, false));
		...
		slide30.cubeList.add(new ModelBox(slide30, 0, 76, 0.3536F, 0.0F, 0.3536F, 1, 2, 1, 0.0F, false));
		...
		slide16.cubeList.add(new ModelBox(slide16, 31, 84, -1.4727F, 0.4315F, 20.0F, 1, 1, 1, 0.0F, false));
		slide16.cubeList.add(new ModelBox(slide16, 21, 74, -1.6243F, 0.6903F, 21.0F, 1, 1, 11, 0.0F, false));
		...
		slide15.cubeList.add(new ModelBox(slide15, 74, 20, -1.4043F, 0.6913F, 20.001F, 1, 1, 12, 0.0F, false));
		...
		slide14.cubeList.add(new ModelBox(slide14, 22, 108, -1.1639F, -0.4278F, 20.0F, 1, 1, 1, 0.0F, false));
		slide14.cubeList.add(new ModelBox(slide14, 12, 98, -1.2651F, -0.7102F, 21.0F, 1, 1, 11, 0.0F, false));
		...
		slide13.cubeList.add(new ModelBox(slide13, 30, 18, 0.5538F, 0.604F, -2.0F, 1, 1, 2, 0.0F, false));
		slide13.cubeList.add(new ModelBox(slide13, 23, 11, 0.5538F, 0.604F, 0.0F, 1, 1, 9, 0.0F, false));
		...
		slide11.cubeList.add(new ModelBox(slide11, 63, 64, 0.3538F, 0.605F, -0.001F, 1, 1, 9, 0.0F, false));
		slide11.cubeList.add(new ModelBox(slide11, 70, 71, 0.3538F, 0.605F, -2.001F, 1, 1, 2, 0.0F, false));
		...
		slide9.cubeList.add(new ModelBox(slide9, 18, 40, 0.4527F, 0.4315F, 20.0F, 1, 1, 1, 0.0F, false));
		...
		slide7.cubeList.add(new ModelBox(slide7, 111, 52, 0.1768F, -0.4124F, 20.0F, 1, 1, 1, 0.0F, false));
		slide7.cubeList.add(new ModelBox(slide7, 101, 42, 0.2442F, -0.6007F, 21.0F, 1, 1, 11, 0.0F, false));
		...
		slide6.cubeList.add(new ModelBox(slide6, 48, 94, 0.0F, -0.5F, 0.001F, 1, 1, 6, 0.0F, false));

		slide5 = new ModelRenderer(this);
		slide5.setRotationPoint(-2.0F, -37.0F, -30.5F);
		slide.addChild(slide5);
		slide5.cubeList.add(new ModelBox(slide5, 97, 58, 0.0F, 0.0F, 11.9F, 1, 1, 15, 0.0F, false));
		slide5.cubeList.add(new ModelBox(slide5, 97, 58, 0.0F, -0.5F, 11.9F, 1, 1, 15, 0.0F, false));

		slide4 = new ModelRenderer(this);
		slide4.setRotationPoint(-3.9F, -35.5F, -24.5F);
		slide.addChild(slide4);
		slide4.cubeList.add(new ModelBox(slide4, 112, 88, 0.5F, 0.0F, 14.0F, 1, 2, 4, 0.0F, false));

		slide3 = new ModelRenderer(this);
		slide3.setRotationPoint(-0.1F, -35.5F, -24.5F);
		slide.addChild(slide3);
		slide3.cubeList.add(new ModelBox(slide3, 114, 108, -0.5F, 0.0F, 14.0F, 1, 2, 4, 0.0F, false));
		slide3.cubeList.add(new ModelBox(slide3, 44, 120, -0.499F, 1.4F, 13.999F, 1, 1, 4, 0.0F, false));
		slide3.cubeList.add(new ModelBox(slide3, 40, 116, -0.499F, 1.4F, 17.999F, 1, 1, 8, 0.0F, false));
		slide3.cubeList.add(new ModelBox(slide3, 89, 118, -3.299F, 1.4F, 13.999F, 1, 1, 4, 0.0F, false));
		slide3.cubeList.add(new ModelBox(slide3, 85, 114, -3.299F, 1.4F, 17.999F, 1, 1, 8, 0.0F, false));

		slide2 = new ModelRenderer(this);
		slide2.setRotationPoint(-0.1F, -35.5F, 1.5F);
		slide.addChild(slide2);
		slide2.cubeList.add(new ModelBox(slide2, 80, 0, -0.5F, 1.4F, 0.0F, 1, 1, 1, 0.0F, false));
		slide2.cubeList.add(new ModelBox(slide2, 75, 77, -3.3F, 1.4F, 0.0F, 1, 1, 1, 0.0F, false));
		slide2.cubeList.add(new ModelBox(slide2, 78, 24, -0.501F, 0.7F, 0.0F, 1, 1, 1, 0.0F, false));
		slide2.cubeList.add(new ModelBox(slide2, 71, 77, -3.301F, 0.7F, 0.0F, 1, 1, 1, 0.0F, false));
	}
