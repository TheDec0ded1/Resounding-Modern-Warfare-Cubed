...
public class G36EHG extends ModelBase {
	...
	public G36EHG() {
		...
		handguard.cubeList.add(new ModelBox(handguard, 62, 82, 0.75F, -36.5F, -57.75F, 1, 2, 2, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 57, 65, 0.75F, -36.5F, -69.75F, 1, 2, 2, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 162, 119, -2.0F, -32.45F, -55.452F, 1, 1, 15, 0.3F, false));
		handguard.cubeList.add(new ModelBox(handguard, 161, 118, -2.0F, -32.45F, -70.452F, 1, 1, 16, 0.3F, false));
		handguard.cubeList.add(new ModelBox(handguard, 53, 0, -4.0F, -41.0F, -43.75F, 5, 5, 3, 0.002F, false));
		handguard.cubeList.add(new ModelBox(handguard, 57, 59, -4.75F, -36.5F, -57.75F, 1, 2, 2, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 10, 59, -4.75F, -36.5F, -69.75F, 1, 2, 2, 0.0F, false));
		...
		cube_r74.cubeList.add(new ModelBox(cube_r74, 71, 65, -0.5F, -3.0F, -8.0F, 1, 1, 1, 0.0F, false));
		cube_r74.cubeList.add(new ModelBox(cube_r74, 71, 65, -0.5F, -3.0F, -12.0F, 1, 1, 1, 0.0F, false));
		cube_r74.cubeList.add(new ModelBox(cube_r74, 71, 65, -0.5F, -3.0F, -16.0F, 1, 1, 1, 0.0F, false));
		...
		cube_r90.cubeList.add(new ModelBox(cube_r90, 34, 118, -0.5F, -3.0F, -9.5F, 1, 1, 1, 0.0F, false));
		cube_r90.cubeList.add(new ModelBox(cube_r90, 34, 118, -0.5F, -3.0F, -13.5F, 1, 1, 1, 0.0F, false));
		cube_r90.cubeList.add(new ModelBox(cube_r90, 34, 118, -0.5F, -3.0F, -17.5F, 1, 1, 1, 0.0F, false));
