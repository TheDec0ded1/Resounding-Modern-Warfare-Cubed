...
public class SVUAction extends ModelWithAttachments {
	...
	public SVUAction() {
		...
		action.setRotationPoint(-3.5F, -11.75F, 25.0F);
		...
		action.cubeList.add(new ModelBox(action, 0, 47, 0.3F, 0.5F, -20.0F, 1, 1, 20, -0.001F, false));
		...
		cube_r97.cubeList.add(new ModelBox(cube_r97, 0, 24, 0.4838F, -0.0594F, -20.0F, 1, 2, 20, -0.001F, false));
