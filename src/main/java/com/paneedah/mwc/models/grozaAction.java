...
public class grozaAction extends ModelWithAttachments {
	...
	public grozaAction() {
		...
		action.setRotationPoint(0.0F, 24.0F, 43.0F);
		...
		action17.cubeList.add(new ModelBox(action17, 157, 4, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		action16.cubeList.add(new ModelBox(action16, 157, 9, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		action15.cubeList.add(new ModelBox(action15, 157, 13, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		...
		action14.cubeList.add(new ModelBox(action14, 121, 22, 0.0F, -0.001F, 0.0F, 2, 1, 1, 0.0F, false));

		action12 = new ModelRenderer(this);
		action12.setRotationPoint(-3.8F, -36.2F, -33.5F);
		action.addChild(action12);
		action12.cubeList.add(new ModelBox(action12, 122, 21, 0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));

		action11 = new ModelRenderer(this);
		action11.setRotationPoint(-3.8F, -36.5F, -33.5F);
		action.addChild(action11);
		action11.cubeList.add(new ModelBox(action11, 130, 21, -0.001F, 0.0F, -0.001F, 1, 1, 2, 0.0F, false));
		...
		action10.cubeList.add(new ModelBox(action10, 122, 10, -1.0F, 0.0F, -0.001F, 1, 1, 7, 0.0F, false));
		...
		action9.cubeList.add(new ModelBox(action9, 141, 7, -1.0F, 0.0F, 0.0F, 1, 1, 8, 0.0F, false));
		...
		action8.cubeList.add(new ModelBox(action8, 128, 13, 0.0F, 0.0F, -0.001F, 1, 1, 15, 0.0F, false));
		...
		action7.cubeList.add(new ModelBox(action7, 123, 2, 0.0F, 0.0F, 0.0F, 1, 2, 12, 0.0F, false));
		...
		action6.cubeList.add(new ModelBox(action6, 137, 4, -1.0F, 0.0F, 0.0F, 1, 2, 12, 0.0F, false));
		...
		action4.cubeList.add(new ModelBox(action4, 122, 0, -1.0F, 0.0F, -0.002F, 1, 1, 18, 0.0F, false));
		...
		action5.cubeList.add(new ModelBox(action5, 121, 7, 0.0F, 0.0F, -0.001F, 1, 1, 18, 0.0F, false));

		action2 = new ModelRenderer(this);
		action2.setRotationPoint(-3.5F, -37.0F, -33.5F);
		action.addChild(action2);
		action2.cubeList.add(new ModelBox(action2, 121, 7, 0.0F, 0.0F, 0.0F, 1, 2, 8, 0.0F, false));

		action1 = new ModelRenderer(this);
		action1.setRotationPoint(-3.3F, -37.0F, -25.5F);
		action.addChild(action1);
		action1.cubeList.add(new ModelBox(action1, 145, 13, 0.0F, 0.0F, 0.0F, 1, 2, 7, 0.0F, false));

		action3 = new ModelRenderer(this);
		action3.setRotationPoint(-0.5F, -37.0F, -33.5F);
		action.addChild(action3);
		action3.cubeList.add(new ModelBox(action3, 122, 21, 0.0F, 0.0F, 0.0F, 1, 2, 15, 0.0F, false));
	}
