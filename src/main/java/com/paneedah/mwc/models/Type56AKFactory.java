...
public class Type56AKFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments2.AK47BlondeStock, true, (model) -> {
      })
        .withCompatibleAttachment(Attachments2.AK47BlondeGrip, true, (model) -> {
      })
        ...
        .withCompatibleAttachment(Attachments2.Type56BlondeHandguard, true, (model) -> {
      })
...
//            GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Attachments2.Type56Handguard, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
...
//          GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Type56AKAction, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        ...
        .withCompatibleAttachment(Attachments2.Type56Iron, true, (model) -> {
            if(model instanceof AKiron3) {
                GL11.glTranslatef(-0.195F, -1.06F, -5.96F);
                GL11.glScaled(0.9F, 0.55F, 0.5F);
            } else if(model instanceof Type56iron2) {
...
//            GL11.glRotatef(-10F, 1f, 0f, 0f);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new Type56AK())
            .withActionPiece(AuxiliaryAttachments.Type56AKAction)
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernAnimations("ak47", AuxiliaryAttachments.Type56AKAction)
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.Type56AKAction.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.Type56AKAction.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.Type56AKAction.getRenderablePart(),
