...
public class AKSUStock extends ModelBase {
	...
	public AKSUStock() {
		...
		gun234.cubeList.add(new ModelBox(gun234, 135, 23, 0.0F, -8.8966F, -0.109F, 4, 4, 6, 0.0F, false));
		...
		gun366_r1.cubeList.add(new ModelBox(gun366_r1, 116, 0, -3.502F, -29.0847F, 5.7092F, 4, 2, 25, 0.0F, false));
	}
