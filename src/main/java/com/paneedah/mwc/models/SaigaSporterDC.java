...
public class SaigaSporterDC extends ModelBase {
	...
	public SaigaSporterDC() {
		...
		DustCover40.cubeList.add(new ModelBox(DustCover40, 0, 155, 0.001F, 0.0F, 0.0F, 2, 2, 2, 0.0F, false));
		...
		DustCover39.cubeList.add(new ModelBox(DustCover39, 154, 97, -0.001F, 0.0F, 0.0F, 2, 2, 2, 0.0F, false));
		...
		DustCover43.cubeList.add(new ModelBox(DustCover43, 125, 26, 0.0F, 0.0F, 0.0F, 1, 1, 4, 0.0F, false));
		...
		DustCover41.cubeList.add(new ModelBox(DustCover41, 68, 124, 0.0F, 0.0F, 0.0F, 1, 1, 4, 0.0F, false));
		...
		DustCover42.cubeList.add(new ModelBox(DustCover42, 98, 30, 0.0F, 0.0F, 0.0F, 1, 1, 5, 0.0F, false));
		...
		DustCover8.cubeList.add(new ModelBox(DustCover8, 98, 65, 0.0F, 0.0F, 0.0F, 2, 1, 3, 0.0F, false));

		DustCover9 = new ModelRenderer(this);
		DustCover9.setRotationPoint(-3.9F, -37.5F, -21.5F);
		dustcover.addChild(DustCover9);
		DustCover9.cubeList.add(new ModelBox(DustCover9, 153, 84, 0.0F, 0.0F, 0.0F, 1, 1, 3, 0.0F, false));
		...
		DustCover10.cubeList.add(new ModelBox(DustCover10, 57, 69, 0.0F, 0.0F, 0.0F, 1, 1, 9, 0.0F, false));
		...
		DustCover44.cubeList.add(new ModelBox(DustCover44, 74, 170, 0.0F, 0.0F, 0.0F, 1, 1, 12, 0.0F, false));
		...
		DustCover5.cubeList.add(new ModelBox(DustCover5, 49, 206, 0.0F, 0.0F, -0.001F, 1, 2, 22, 0.0F, false));
		...
		DustCover22.cubeList.add(new ModelBox(DustCover22, 171, 155, 0.0F, 0.0F, 0.0F, 1, 1, 26, 0.0F, false));
		...
		DustCover35.cubeList.add(new ModelBox(DustCover35, 57, 58, 0.0F, 0.0F, 0.0F, 1, 1, 9, 0.0F, false));
		...
		DustCover3.cubeList.add(new ModelBox(DustCover3, 162, 112, 0.0F, 0.0F, -0.001F, 2, 1, 34, 0.0F, false));
		...
		DustCover2.cubeList.add(new ModelBox(DustCover2, 171, 0, 0.0F, 0.0F, 0.0F, 1, 1, 34, 0.0F, false));
		...
		DustCover36.cubeList.add(new ModelBox(DustCover36, 57, 159, 0.001F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
		...
		DustCover12.cubeList.add(new ModelBox(DustCover12, 161, 88, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));

		DustCover11 = new ModelRenderer(this);
		DustCover11.setRotationPoint(-3.8F, -37.5F, -19.1F);
		dustcover.addChild(DustCover11);
		DustCover11.cubeList.add(new ModelBox(DustCover11, 57, 30, 0.001F, 0.0F, 0.0F, 1, 1, 9, 0.0F, false));
