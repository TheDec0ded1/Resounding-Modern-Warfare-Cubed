...
public class MinimiHatch extends ModelWithAttachments {
	...
	private final ModelRenderer Hatch7;
	private final ModelRenderer Hatch44;
	private final ModelRenderer Hatch45;
	private final ModelRenderer Hatch10;
	private final ModelRenderer Hatch43;
	private final ModelRenderer Hatch42;
	private final ModelRenderer Hatch40;
	private final ModelRenderer Hatch41;
	...
	public MinimiHatch() {
		...
		Hatch7 = new ModelRenderer(this);
		Hatch7.setRotationPoint(-1.5F, -35.0F, 40.0F);
		hatch.addChild(Hatch7);
		Hatch7.cubeList.add(new ModelBox(Hatch7, 264, 267, -2.001F, -9.6F, -44.0F, 4, 1, 6, 0.0F, false));

		Hatch44 = new ModelRenderer(this);
		Hatch44.setRotationPoint(2.5F, -36.0F, 40.75F);
		hatch.addChild(Hatch44);
		Hatch44.cubeList.add(new ModelBox(Hatch44, 269, 272, -2.101F, -9.6F, -44.0F, 1, 1, 1, 0.1F, false));

		Hatch45 = new ModelRenderer(this);
		Hatch45.setRotationPoint(2.4F, -36.0F, 44.35F);
		hatch.addChild(Hatch45);
		Hatch45.cubeList.add(new ModelBox(Hatch45, 269, 272, -2.001F, -9.6F, -44.0F, 1, 1, 1, 0.1F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 269, 272, -5.901F, -9.1F, -44.0F, 4, 1, 1, 0.0F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -4.901F, -9.6F, -44.0F, 2, 1, 1, 0.0F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -3.901F, -11.2F, -43.925F, 1, 2, 1, -0.4F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -4.901F, -11.2F, -43.925F, 2, 1, 1, -0.4F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -4.901F, -10.2F, -43.925F, 2, 1, 1, -0.4F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -4.101F, -11.0F, -43.925F, 1, 1, 1, -0.4F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -4.701F, -11.0F, -43.925F, 1, 1, 1, -0.4F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -4.701F, -10.4F, -43.925F, 1, 1, 1, -0.4F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -4.101F, -10.4F, -43.925F, 1, 1, 1, -0.4F, false));
		Hatch45.cubeList.add(new ModelBox(Hatch45, 174, 243, -4.901F, -11.2F, -43.925F, 1, 2, 1, -0.4F, false));

		Hatch10 = new ModelRenderer(this);
		Hatch10.setRotationPoint(-1.5F, -34.5F, 40.0F);
		hatch.addChild(Hatch10);
		Hatch10.cubeList.add(new ModelBox(Hatch10, 172, 246, 1.399F, -12.7F, -44.4F, 1, 3, 3, -0.4F, false));
		Hatch10.cubeList.add(new ModelBox(Hatch10, 172, 246, -2.401F, -12.7F, -44.4F, 1, 3, 3, -0.4F, false));
		Hatch10.cubeList.add(new ModelBox(Hatch10, 172, 246, -2.401F, -11.7F, -40.6F, 1, 2, 3, -0.4F, false));
		Hatch10.cubeList.add(new ModelBox(Hatch10, 172, 246, 1.399F, -11.7F, -40.6F, 1, 2, 3, -0.4F, false));
		Hatch10.cubeList.add(new ModelBox(Hatch10, 173, 247, 1.399F, -12.2F, -39.6F, 1, 2, 2, -0.4F, false));
		Hatch10.cubeList.add(new ModelBox(Hatch10, 173, 247, -2.401F, -12.2F, -39.6F, 1, 2, 2, -0.4F, false));
		Hatch10.cubeList.add(new ModelBox(Hatch10, 173, 247, -2.401F, -12.9F, -40.6F, 1, 2, 2, -0.4F, false));
		Hatch10.cubeList.add(new ModelBox(Hatch10, 173, 247, 1.399F, -12.9F, -40.6F, 1, 2, 2, -0.4F, false));

		Hatch43 = new ModelRenderer(this);
		Hatch43.setRotationPoint(-1.501F, -46.7112F, 5.8926F);
		hatch.addChild(Hatch43);
		setRotationAngle(Hatch43, -0.6981F, 0.0F, 0.0F);
		Hatch43.cubeList.add(new ModelBox(Hatch43, 172, 246, -2.4F, 2.5189F, -5.4481F, 1, 2, 3, -0.4F, false));
		Hatch43.cubeList.add(new ModelBox(Hatch43, 172, 246, 1.4F, 2.5189F, -5.4481F, 1, 2, 3, -0.4F, false));

		Hatch42 = new ModelRenderer(this);
		Hatch42.setRotationPoint(-1.5F, -46.5F, 40.0F);
		hatch.addChild(Hatch42);
		setRotationAngle(Hatch42, 0.2182F, 0.0F, 0.0F);
		Hatch42.cubeList.add(new ModelBox(Hatch42, 172, 246, 1.399F, -10.2164F, -43.292F, 1, 2, 3, -0.4F, false));
		Hatch42.cubeList.add(new ModelBox(Hatch42, 172, 246, -2.401F, -10.2164F, -43.292F, 1, 2, 3, -0.4F, false));
		Hatch42.cubeList.add(new ModelBox(Hatch42, 172, 246, -2.401F, -10.2164F, -41.242F, 1, 2, 3, -0.4F, false));
		Hatch42.cubeList.add(new ModelBox(Hatch42, 172, 246, 1.399F, -10.2164F, -41.242F, 1, 2, 3, -0.4F, false));

		Hatch40 = new ModelRenderer(this);
		Hatch40.setRotationPoint(-1.5F, -34.5F, 40.0F);
		hatch.addChild(Hatch40);
		setRotationAngle(Hatch40, -0.7854F, 0.0F, 0.0F);
		Hatch40.cubeList.add(new ModelBox(Hatch40, 173, 247, 1.399F, 20.2355F, -36.4355F, 1, 2, 2, -0.4F, false));
		Hatch40.cubeList.add(new ModelBox(Hatch40, 173, 247, -2.401F, 21.5855F, -37.6855F, 1, 2, 2, -0.4F, false));
		Hatch40.cubeList.add(new ModelBox(Hatch40, 173, 247, -2.401F, 20.3355F, -36.3855F, 1, 2, 2, -0.4F, false));
		Hatch40.cubeList.add(new ModelBox(Hatch40, 173, 247, 1.399F, 21.5855F, -37.6355F, 1, 2, 2, -0.4F, false));

		Hatch41 = new ModelRenderer(this);
		Hatch41.setRotationPoint(-1.5F, -36.5F, 40.0F);
		hatch.addChild(Hatch41);
		setRotationAngle(Hatch41, -0.7854F, 0.0F, 0.0F);
		Hatch41.cubeList.add(new ModelBox(Hatch41, 173, 247, 1.399F, 20.2355F, -36.4355F, 1, 2, 2, -0.4F, false));
		Hatch41.cubeList.add(new ModelBox(Hatch41, 173, 247, -2.401F, 20.3355F, -36.3855F, 1, 2, 2, -0.4F, false));
		Hatch41.cubeList.add(new ModelBox(Hatch41, 173, 247, 1.399F, 21.5855F, -37.6355F, 1, 2, 2, -0.4F, false));
		Hatch41.cubeList.add(new ModelBox(Hatch41, 173, 247, -2.401F, 21.5855F, -37.6355F, 1, 2, 2, -0.4F, false));
