...
public class SOBRVest extends ModelBiped {
	...
	public SOBRVest() {
		...
		vest.cubeList.add(new ModelBox(vest, 83, 41, -1.5F, 7.2F, -4.95F, 3, 4, 2, 0.0F, false));
		vest.cubeList.add(new ModelBox(vest, 88, 31, -1.6F, 8.2F, -5.05F, 3, 1, 2, 0.0F, false));
		vest.cubeList.add(new ModelBox(vest, 86, 10, -1.6F, 9.7F, -5.05F, 3, 1, 2, 0.0F, false));
		vest.cubeList.add(new ModelBox(vest, 117, 53, -0.5F, 2.1F, -4.45F, 2, 3, 1, 0.0F, false));
		...
		setRotationAngle(bone19, 0.0F, -0.9338F, 0.0F);
		bone19.cubeList.add(new ModelBox(bone19, 84, 70, 0.8903F, 7.2F, -5.0868F, 3, 4, 2, 0.0F, false));
		bone19.cubeList.add(new ModelBox(bone19, 87, 0, 0.9693F, 8.2F, -5.2041F, 3, 1, 2, 0.0F, false));
		bone19.cubeList.add(new ModelBox(bone19, 57, 19, 0.9693F, 9.7F, -5.2041F, 3, 1, 2, 0.0F, false));

		bone17 = new ModelRenderer(this);
		bone17.setRotationPoint(0.0F, 0.0F, 0.0F);
		vest.addChild(bone17);
		setRotationAngle(bone17, 0.0F, -0.192F, 0.0F);
		bone17.cubeList.add(new ModelBox(bone17, 54, 85, 1.3523F, 1.3F, -3.5654F, 2, 9, 1, 0.0F, false));
		bone17.cubeList.add(new ModelBox(bone17, 84, 70, 0.8903F, 7.2F, -5.0868F, 3, 4, 2, 0.0F, false));
		bone17.cubeList.add(new ModelBox(bone17, 87, 0, 0.9693F, 8.2F, -5.2041F, 3, 1, 2, 0.0F, false));
		bone17.cubeList.add(new ModelBox(bone17, 57, 19, 0.9693F, 9.7F, -5.2041F, 3, 1, 2, 0.0F, false));
		bone17.cubeList.add(new ModelBox(bone17, 115, 41, 0.7949F, 2.1F, -4.5776F, 2, 3, 1, 0.0F, false));
		...
		bone20.cubeList.add(new ModelBox(bone20, 83, 13, -3.9278F, 7.2F, -5.0874F, 3, 4, 2, 0.0F, false));
		bone20.cubeList.add(new ModelBox(bone20, 88, 49, -4.0069F, 8.1F, -5.2046F, 3, 1, 2, 0.0F, false));
		bone20.cubeList.add(new ModelBox(bone20, 86, 82, -4.0069F, 9.6F, -5.2046F, 3, 1, 2, 0.0F, false));
		bone20.cubeList.add(new ModelBox(bone20, 111, 32, -2.1324F, 2.1F, -4.3782F, 2, 3, 1, 0.0F, false));

		bone26 = new ModelRenderer(this);
		bone26.setRotationPoint(1.1F, 2.8F, 0.0F);
		vest.addChild(bone26);
		setRotationAngle(bone26, 0.0F, -3.0369F, 0.0F);
		bone26.cubeList.add(new ModelBox(bone26, 68, 59, -5.2718F, 6.2F, -3.1308F, 2, 5, 4, 0.0F, false));
		...
		bone21.cubeList.add(new ModelBox(bone21, 24, 24, 1.3423F, 3.1511F, -3.9747F, 1, 1, 1, 0.0F, false));
		...
		bone22.cubeList.add(new ModelBox(bone22, 0, 16, -1.6677F, 3.0732F, -3.739F, 1, 1, 1, 0.0F, false));
		...
		vest.addChild(patch);
		setRotationAngle(patch, 0.0349F, 0.0F, 0.0F);
		

		bone6 = new ModelRenderer(this);
		bone6.setRotationPoint(0.0F, 0.0F, 0.0F);
		patch.addChild(bone6);
		bone6.cubeList.add(new ModelBox(bone6, 45, 110, -2.0F, -2.0F, -0.4F, 4, 2, 1, 0.0F, false));

		bone7 = new ModelRenderer(this);
		bone7.setRotationPoint(0.0F, 0.0F, 1.0F);
		patch.addChild(bone7);
		bone7.cubeList.add(new ModelBox(bone7, 71, 115, -1.7F, -2.3F, -0.975F, 4, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 71, 115, -2.3F, -2.3F, -0.975F, 2, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 111, 106, -2.3F, -0.7F, -0.975F, 2, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 111, 106, -1.7F, -0.7F, -0.975F, 4, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 95, 118, -2.3F, -2.1F, -0.975F, 1, 2, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 95, 118, -2.3F, -0.9F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, 1.3F, -0.9F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, 1.3F, -2.1F, -0.975F, 1, 2, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.5F, -2.0F, -0.975F, 1, 2, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.9F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.9F, -1.525F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.7F, -1.525F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.7F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 112, 106, 0.1F, -1.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 113, 106, 0.1F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 59, 123, -0.1F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 112, 121, -0.1F, -1.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, 0.2414F, -1.8586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 118, 114, 0.2414F, -1.6586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 77, 115, 0.2414F, -1.4586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 95, 119, 0.2414F, -1.1414F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 91, 106, 0.2414F, -1.2914F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 112, 121, -0.2414F, -1.1414F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 118, 120, -0.2414F, -1.2914F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -0.2414F, -1.4586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 118, 114, -0.2414F, -1.6586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 119, 85, -0.2414F, -1.8586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 112, 121, 0.7F, -1.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 112, 106, 0.9F, -1.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 95, 119, 1.0414F, -1.1414F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 91, 106, 1.0414F, -1.2914F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 77, 115, 1.0414F, -1.4586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 118, 114, 1.0414F, -1.6586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, 1.0414F, -1.8586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 113, 106, 0.9F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 59, 123, 0.7F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 119, 85, 0.5586F, -1.8586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 112, 121, 0.5586F, -1.1414F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -2.0414F, -1.6664F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -2.0414F, -1.8586F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -0.8F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.0F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.125F, -2.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -0.6F, -2.0F, -0.975F, 1, 2, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -0.8F, -1.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.0F, -1.0F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.1414F, -1.1414F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.1414F, -1.3336F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -1.0F, -1.475F, -0.975F, 1, 1, 1, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 107, 113, -0.8F, -1.475F, -0.975F, 1, 1, 1, -0.4F, false));

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(-0.3879F, -0.7214F, -0.475F);
		bone7.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0F, 0.0F, 0.7854F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 107, 113, -0.8F, -0.5F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-0.6F, -0.5414F, -0.475F);
		bone7.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, 0.0F, 0.7854F);
		cube_r2.cubeList.add(new ModelBox(cube_r2, 107, 113, -0.5F, -0.5F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(-1.5F, -1.0664F, -0.475F);
		bone7.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.0F, 0.0F, 0.7854F);
		cube_r3.cubeList.add(new ModelBox(cube_r3, 107, 113, -0.5F, -0.5F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-1.2879F, -1.2464F, -0.475F);
		bone7.addChild(cube_r4);
		setRotationAngle(cube_r4, 0.0F, 0.0F, 0.7854F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 107, 113, -0.8F, -0.5F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(2.1607F, -0.3979F, -0.475F);
		bone7.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.0F, 0.0F, -0.7854F);
		cube_r5.cubeList.add(new ModelBox(cube_r5, 107, 113, -0.5F, -2.0F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(1.1464F, -1.8121F, -0.475F);
		bone7.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.0F, 0.0F, -0.7854F);
		cube_r6.cubeList.add(new ModelBox(cube_r6, 79, 122, -0.5F, 0.0F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(1.1464F, -0.895F, -0.475F);
		bone7.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.0F, 0.0F, -0.7854F);
		cube_r7.cubeList.add(new ModelBox(cube_r7, 103, 126, -0.5F, 0.0F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(2.1607F, 0.5192F, -0.475F);
		bone7.addChild(cube_r8);
		setRotationAngle(cube_r8, 0.0F, 0.0F, -0.7854F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 72, 111, -0.5F, -2.0F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(0.3464F, -0.895F, -0.475F);
		bone7.addChild(cube_r9);
		setRotationAngle(cube_r9, 0.0F, 0.0F, -0.7854F);
		cube_r9.cubeList.add(new ModelBox(cube_r9, 103, 126, -0.5F, 0.0F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r10 = new ModelRenderer(this);
		cube_r10.setRotationPoint(1.3607F, 0.5192F, -0.475F);
		bone7.addChild(cube_r10);
		setRotationAngle(cube_r10, 0.0F, 0.0F, -0.7854F);
		cube_r10.cubeList.add(new ModelBox(cube_r10, 72, 111, -0.5F, -2.0F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r11 = new ModelRenderer(this);
		cube_r11.setRotationPoint(1.3607F, -0.3979F, -0.475F);
		bone7.addChild(cube_r11);
		setRotationAngle(cube_r11, 0.0F, 0.0F, -0.7854F);
		cube_r11.cubeList.add(new ModelBox(cube_r11, 107, 113, -0.5F, -2.0F, -0.5F, 1, 1, 1, -0.4F, false));

		cube_r12 = new ModelRenderer(this);
		cube_r12.setRotationPoint(0.3464F, -1.8121F, -0.475F);
		bone7.addChild(cube_r12);
		setRotationAngle(cube_r12, 0.0F, 0.0F, -0.7854F);
		cube_r12.cubeList.add(new ModelBox(cube_r12, 79, 122, -0.5F, 0.0F, -0.5F, 1, 1, 1, -0.4F, false));

		holster = new ModelRenderer(this);
		holster.setRotationPoint(-1.1F, 10.0F, -2.4F);
		vest.addChild(holster);
		setRotationAngle(holster, -0.1034F, 0.2807F, 1.3727F);
		holster.cubeList.add(new ModelBox(holster, 76, 50, -0.6482F, 3.1437F, 1.5609F, 5, 2, 2, 0.0F, false));
		holster.cubeList.add(new ModelBox(holster, 50, 9, -0.4529F, 3.0041F, 3.146F, 2, 2, 1, 0.0F, false));
