...
public class FELIN extends ModelWithAttachments {
	...
	public FELIN() {
		...
		cube_r7.cubeList.add(new ModelBox(cube_r7, 4, 4, -3.601F, -21.4448F, -3.8309F, 3, 6, 42, 0.0F, false));
		cube_r7.cubeList.add(new ModelBox(cube_r7, 4, 56, -1.401F, -21.4438F, -3.8304F, 1, 6, 42, 0.0F, false));
		cube_r7.cubeList.add(new ModelBox(cube_r7, 136, 87, -3.5F, -21.8436F, -3.7304F, 3, 1, 9, 0.1F, false));
		cube_r7.cubeList.add(new ModelBox(cube_r7, 29, 143, -3.0F, -21.6437F, 5.1696F, 2, 1, 22, 0.0F, false));
		cube_r7.cubeList.add(new ModelBox(cube_r7, 43, 157, -0.8148F, -19.1885F, -10.8312F, 2, 1, 8, 0.0F, false));
		cube_r7.cubeList.add(new ModelBox(cube_r7, 43, 157, -5.1852F, -19.1885F, -10.8312F, 2, 1, 8, 0.0F, false));
		...
		cube_r9.cubeList.add(new ModelBox(cube_r9, 115, 156, -3.8148F, -19.1885F, -10.8312F, 3, 1, 7, 0.0F, false));
		...
		cube_r12.cubeList.add(new ModelBox(cube_r12, 140, 48, -1.3493F, -0.2918F, -11.5F, 1, 4, 21, 0.0F, false));
		...
		cube_r30.cubeList.add(new ModelBox(cube_r30, 137, 134, 0.3493F, -0.2918F, -11.5F, 1, 4, 21, 0.0F, false));
		...
		bipod.setRotationPoint(0.0F, 1.0F, 7.0F);
		gun.addChild(bipod);
		...
		bone104.cubeList.add(new ModelBox(bone104, 123, 177, 5.0F, -40.25F, -28.75F, 1, 1, 14, 0.0F, false));
		bone104.cubeList.add(new ModelBox(bone104, 129, 183, 5.0F, -36.2061F, -3.8157F, 1, 1, 8, 0.0F, false));
		bone104.cubeList.add(new ModelBox(bone104, 138, 41, 5.0257F, -36.3516F, 1.75F, 1, 1, 2, 0.0F, false));
		bone104.cubeList.add(new ModelBox(bone104, 91, 118, 4.2772F, -37.6016F, 3.49F, 2, 4, 1, 0.0F, false));
		bone104.cubeList.add(new ModelBox(bone104, 137, 60, 5.0247F, -35.8516F, 1.75F, 1, 1, 2, 0.0F, false));
		...
		bone105_r1.setRotationPoint(5.5F, -35.3339F, -2.705F);
		bone104.addChild(bone105_r1);
		setRotationAngle(bone105_r1, -0.3491F, 0.0F, 0.0F);
		bone105_r1.cubeList.add(new ModelBox(bone105_r1, 125, 179, -0.5F, -0.5F, -13.0F, 1, 1, 12, 0.0F, false));
		...
		cube_r51.cubeList.add(new ModelBox(cube_r51, 52, 20, -0.8346F, 2.135F, 4.5F, 1, 4, 1, 0.0F, false));
		...
		bone106.cubeList.add(new ModelBox(bone106, 36, 11, -2.3769F, 2.6484F, 4.3517F, 1, 3, 1, 0.0F, false));

		cube_r54 = new ModelRenderer(this);
		cube_r54.setRotationPoint(0.0F, -1.25F, -0.0375F);
		bone106.addChild(cube_r54);
		setRotationAngle(cube_r54, -0.2618F, 0.0F, 0.0F);
		cube_r54.cubeList.add(new ModelBox(cube_r54, 102, 53, -2.3774F, 2.2707F, 5.1877F, 1, 1, 1, 0.0F, false));

		cube_r55 = new ModelRenderer(this);
		cube_r55.setRotationPoint(0.0F, 1.25F, -0.0375F);
		bone106.addChild(cube_r55);
		setRotationAngle(cube_r55, 0.2618F, 0.0F, 0.0F);
		cube_r55.cubeList.add(new ModelBox(cube_r55, 11, 104, -2.3774F, 4.7434F, 3.0404F, 1, 1, 1, 0.0F, false));
		...
		bone108.cubeList.add(new ModelBox(bone108, 95, 176, -6.0F, -40.25F, -28.75F, 1, 1, 14, 0.0F, false));
		bone108.cubeList.add(new ModelBox(bone108, 101, 182, -6.0F, -36.2061F, -3.8157F, 1, 1, 8, 0.0F, false));
		bone108.cubeList.add(new ModelBox(bone108, 137, 48, -6.0257F, -36.3516F, 2.75F, 1, 1, 2, 0.0F, false));
		bone108.cubeList.add(new ModelBox(bone108, 59, 118, -6.2772F, -37.6016F, 4.49F, 2, 4, 1, 0.0F, false));
		bone108.cubeList.add(new ModelBox(bone108, 130, 135, -6.0247F, -35.8516F, 2.75F, 1, 1, 2, 0.0F, false));
		...
		bone109_r1.setRotationPoint(-5.5F, -35.3339F, -2.705F);
		bone108.addChild(bone109_r1);
		setRotationAngle(bone109_r1, -0.3491F, 0.0F, 0.0F);
		bone109_r1.cubeList.add(new ModelBox(bone109_r1, 97, 178, -0.5F, -0.5F, -13.0F, 1, 1, 12, 0.0F, false));
		...
		cube_r65.cubeList.add(new ModelBox(cube_r65, 52, 0, -0.1654F, 2.135F, 5.5F, 1, 4, 1, 0.0F, false));
		...
		bone109.cubeList.add(new ModelBox(bone109, 35, 28, 1.6781F, 2.6484F, 5.3055F, 1, 3, 1, 0.0F, false));

		cube_r68 = new ModelRenderer(this);
		cube_r68.setRotationPoint(0.0F, -1.25F, -0.0375F);
		bone109.addChild(cube_r68);
		setRotationAngle(cube_r68, -0.2618F, 0.0F, 0.0F);
		cube_r68.cubeList.add(new ModelBox(cube_r68, 34, 86, 1.6781F, 2.0239F, 6.109F, 1, 1, 1, 0.0F, false));

		cube_r69 = new ModelRenderer(this);
		cube_r69.setRotationPoint(0.0F, 1.25F, -0.0375F);
		bone109.addChild(cube_r69);
		setRotationAngle(cube_r69, 0.2618F, 0.0F, 0.0F);
		cube_r69.cubeList.add(new ModelBox(cube_r69, 88, 0, 1.6781F, 4.9902F, 3.9616F, 1, 1, 1, 0.0F, false));
		...
		barrel.setRotationPoint(0.5F, 0.1F, 0.0F);
		gun.addChild(barrel);
		...
		rails2.setRotationPoint(-0.5F, -38.45F, -61.9F);
		gun.addChild(rails2);
		rails2.cubeList.add(new ModelBox(rails2, 31, 135, -2.0F, -0.3F, 20.6F, 2, 1, 7, -0.1F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -1.0F, -0.8F, 26.2F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -1.0F, -0.8F, 25.8F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -2.0F, -0.8F, 26.2F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -2.0F, -0.8F, 25.8F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -1.0F, -0.8F, 24.6F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -1.0F, -0.8F, 24.2F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -2.0F, -0.8F, 24.6F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -2.0F, -0.8F, 24.2F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -1.0F, -0.8F, 23.0F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -1.0F, -0.8F, 22.6F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -2.0F, -0.8F, 23.0F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -2.0F, -0.8F, 22.6F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -1.0F, -0.8F, 21.4F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -1.0F, -0.8F, 21.0F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -2.0F, -0.8F, 21.4F, 1, 1, 1, -0.301F, false));
		rails2.cubeList.add(new ModelBox(rails2, 190, 175, -2.0F, -0.8F, 21.0F, 1, 1, 1, -0.301F, false));

		cube_r199 = new ModelRenderer(this);
		cube_r199.setRotationPoint(-2.2F, 0.2F, 0.0F);
		rails2.addChild(cube_r199);
		setRotationAngle(cube_r199, 0.0F, 0.0F, 0.2793F);
		

		cube_r200 = new ModelRenderer(this);
		cube_r200.setRotationPoint(0.2F, 0.2F, 0.0F);
		rails2.addChild(cube_r200);
		setRotationAngle(cube_r200, 0.0F, 0.0F, -0.2793F);
		

		cube_r201 = new ModelRenderer(this);
		cube_r201.setRotationPoint(0.2F, 0.2F, 0.0F);
		rails2.addChild(cube_r201);
		setRotationAngle(cube_r201, 0.5236F, 0.0F, -0.2793F);
		

		cube_r202 = new ModelRenderer(this);
		cube_r202.setRotationPoint(-2.2F, 0.2F, 0.0F);
		rails2.addChild(cube_r202);
		setRotationAngle(cube_r202, 0.5236F, 0.0F, 0.2793F);
		

		cube_r203 = new ModelRenderer(this);
		cube_r203.setRotationPoint(-2.2F, 0.2F, -1.0F);
		rails2.addChild(cube_r203);
		setRotationAngle(cube_r203, -0.4712F, 0.0F, 0.2793F);
		

		cube_r204 = new ModelRenderer(this);
		cube_r204.setRotationPoint(-0.5F, 4.4F, 27.0F);
		rails2.addChild(cube_r204);
		setRotationAngle(cube_r204, 0.2269F, 0.0F, 0.0F);
		

		cube_r205 = new ModelRenderer(this);
		cube_r205.setRotationPoint(-1.7F, -0.5F, 7.3F);
		rails2.addChild(cube_r205);
		setRotationAngle(cube_r205, 0.0F, 0.0F, 0.8029F);
		cube_r205.cubeList.add(new ModelBox(cube_r205, 190, 175, -0.3F, -0.3F, 14.1F, 1, 1, 1, -0.302F, false));
		cube_r205.cubeList.add(new ModelBox(cube_r205, 190, 175, -0.3F, -0.3F, 13.7F, 1, 1, 1, -0.302F, false));
		cube_r205.cubeList.add(new ModelBox(cube_r205, 190, 175, -0.3F, -0.3F, 15.3F, 1, 1, 1, -0.302F, false));
		cube_r205.cubeList.add(new ModelBox(cube_r205, 190, 175, -0.3F, -0.3F, 15.7F, 1, 1, 1, -0.302F, false));
		cube_r205.cubeList.add(new ModelBox(cube_r205, 190, 175, -0.3F, -0.3F, 16.9F, 1, 1, 1, -0.302F, false));
		cube_r205.cubeList.add(new ModelBox(cube_r205, 190, 175, -0.3F, -0.3F, 17.3F, 1, 1, 1, -0.302F, false));
		cube_r205.cubeList.add(new ModelBox(cube_r205, 190, 175, -0.3F, -0.3F, 18.5F, 1, 1, 1, -0.302F, false));
		cube_r205.cubeList.add(new ModelBox(cube_r205, 190, 175, -0.3F, -0.3F, 18.9F, 1, 1, 1, -0.302F, false));

		cube_r206 = new ModelRenderer(this);
		cube_r206.setRotationPoint(-0.3F, -0.5F, 7.3F);
		rails2.addChild(cube_r206);
		setRotationAngle(cube_r206, 0.0F, 0.0F, -0.8029F);
		cube_r206.cubeList.add(new ModelBox(cube_r206, 190, 175, -0.7F, -0.3F, 14.1F, 1, 1, 1, -0.302F, false));
		cube_r206.cubeList.add(new ModelBox(cube_r206, 190, 175, -0.7F, -0.3F, 13.7F, 1, 1, 1, -0.302F, false));
		cube_r206.cubeList.add(new ModelBox(cube_r206, 190, 175, -0.7F, -0.3F, 15.7F, 1, 1, 1, -0.302F, false));
		cube_r206.cubeList.add(new ModelBox(cube_r206, 190, 175, -0.7F, -0.3F, 15.3F, 1, 1, 1, -0.302F, false));
		cube_r206.cubeList.add(new ModelBox(cube_r206, 190, 175, -0.7F, -0.3F, 17.3F, 1, 1, 1, -0.302F, false));
		cube_r206.cubeList.add(new ModelBox(cube_r206, 190, 175, -0.7F, -0.3F, 16.9F, 1, 1, 1, -0.302F, false));
		cube_r206.cubeList.add(new ModelBox(cube_r206, 190, 175, -0.7F, -0.3F, 18.5F, 1, 1, 1, -0.302F, false));
		cube_r206.cubeList.add(new ModelBox(cube_r206, 190, 175, -0.7F, -0.3F, 18.9F, 1, 1, 1, -0.302F, false));

		gun2 = new ModelRenderer(this);
		gun2.setRotationPoint(-3.25F, 2.55F, 12.0F);
		rails2.addChild(gun2);
		setRotationAngle(gun2, -0.0873F, 0.0F, 0.0F);
		

		gun3 = new ModelRenderer(this);
		gun3.setRotationPoint(-3.25F, 3.05F, 17.95F);
		rails2.addChild(gun3);
		setRotationAngle(gun3, -0.8198F, -0.0596F, 0.0638F);
		

		carryhandle2 = new ModelRenderer(this);
		carryhandle2.setRotationPoint(-0.5F, -66.9F, 0.1F);
		

		bone12 = new ModelRenderer(this);
		bone12.setRotationPoint(-0.1F, 0.0F, -36.8F);
		carryhandle2.addChild(bone12);
		bone12.cubeList.add(new ModelBox(bone12, 52, 20, 0.0F, 45.4F, 36.5F, 1, 6, 5, -0.3F, false));
		bone12.cubeList.add(new ModelBox(bone12, 105, 98, -0.001F, 45.9F, 10.3F, 1, 2, 27, -0.3F, false));
		bone12.cubeList.add(new ModelBox(bone12, 51, 113, -2.401F, 46.0F, 10.7F, 3, 1, 28, -0.3F, false));
		bone12.cubeList.add(new ModelBox(bone12, 49, 71, -0.402F, 44.4946F, 3.5944F, 1, 3, 4, -0.3F, false));
		bone12.cubeList.add(new ModelBox(bone12, 48, 70, -0.402F, 46.4191F, 3.5981F, 1, 6, 5, -0.3F, false));
		bone12.cubeList.add(new ModelBox(bone12, 50, 72, -0.402F, 45.517F, 7.837F, 1, 7, 3, -0.3F, false));
		bone12.cubeList.add(new ModelBox(bone12, 50, 72, -0.002F, 45.4999F, 8.4656F, 1, 5, 3, -0.3F, false));
		bone12.cubeList.add(new ModelBox(bone12, 0, 12, -2.4F, 45.5F, 10.3F, 3, 7, 1, -0.3F, false));

		bone13_r1 = new ModelRenderer(this);
		bone13_r1.setRotationPoint(-1.302F, 47.8551F, 9.6847F);
		bone12.addChild(bone13_r1);
		setRotationAngle(bone13_r1, 1.2654F, 0.0F, 0.0F);
		bone13_r1.cubeList.add(new ModelBox(bone13_r1, 48, 70, 0.9F, -3.5F, -2.5F, 1, 4, 5, -0.3F, false));

		bone12_r1 = new ModelRenderer(this);
		bone12_r1.setRotationPoint(-0.902F, 49.2946F, 7.0944F);
		bone12.addChild(bone12_r1);
		setRotationAngle(bone12_r1, -1.0472F, 0.0F, 0.0F);
		bone12_r1.cubeList.add(new ModelBox(bone12_r1, 48, 70, 0.9F, -3.5F, -2.5F, 1, 7, 5, -0.3F, false));
		...
		cube_r168_r1 = new ModelRenderer(this);
		cube_r168_r1.setRotationPoint(-1.902F, 47.8472F, -15.254F);
		cube_r168.addChild(cube_r168_r1);
		setRotationAngle(cube_r168_r1, 0.5236F, 0.0F, 0.0F);
		cube_r168_r1.cubeList.add(new ModelBox(cube_r168_r1, 125, 116, 0.9F, -1.2723F, -0.5807F, 1, 2, 2, -0.3F, false));
		...
		cube_r169.cubeList.add(new ModelBox(cube_r169, 23, 11, -0.003F, 47.4896F, 1.6754F, 1, 4, 2, -0.3F, false));

		cube_r170_r1 = new ModelRenderer(this);
		cube_r170_r1.setRotationPoint(-0.899F, 28.7775F, -19.091F);
		cube_r169.addChild(cube_r170_r1);
		setRotationAngle(cube_r170_r1, 0.4363F, 0.0F, 0.0F);
		cube_r170_r1.cubeList.add(new ModelBox(cube_r170_r1, 63, 98, 0.9F, 25.1594F, 3.6468F, 1, 2, 4, -0.3F, false));
		cube_r170_r1.cubeList.add(new ModelBox(cube_r170_r1, 101, 6, 0.9F, 23.8076F, 1.3154F, 1, 2, 7, -0.3F, false));
		...
		bone13.cubeList.add(new ModelBox(bone13, 104, 56, -0.001F, 45.9F, -26.5F, 1, 2, 27, -0.3F, false));
		bone13.cubeList.add(new ModelBox(bone13, 49, 53, 0.398F, 44.4946F, -33.2056F, 1, 3, 4, -0.3F, false));
		bone13.cubeList.add(new ModelBox(bone13, 48, 52, 0.398F, 46.4191F, -33.2019F, 1, 6, 5, -0.3F, false));
		bone13.cubeList.add(new ModelBox(bone13, 50, 54, 0.398F, 45.517F, -28.963F, 1, 7, 3, -0.3F, false));
		bone13.cubeList.add(new ModelBox(bone13, 50, 54, -0.002F, 45.4999F, -28.3344F, 1, 5, 3, -0.3F, false));
		bone13.cubeList.add(new ModelBox(bone13, 80, 65, 0.8F, 46.5F, -32.85F, 2, 5, 2, 0.0F, false));
		bone13.cubeList.add(new ModelBox(bone13, 52, 0, 0.0F, 45.4F, -0.3F, 1, 6, 5, -0.3F, false));
		bone13.cubeList.add(new ModelBox(bone13, 91, 59, 0.4F, 46.2F, -0.3F, 3, 8, 3, -0.3F, false));
		bone13.cubeList.add(new ModelBox(bone13, 91, 59, 0.4F, 46.2F, 1.7F, 3, 8, 3, -0.3F, false));
		bone13.cubeList.add(new ModelBox(bone13, 92, 60, 0.4F, 47.4F, 3.3F, 3, 8, 2, -0.3F, false));

		bone14_r1 = new ModelRenderer(this);
		bone14_r1.setRotationPoint(2.298F, 47.8551F, -27.1153F);
		bone13.addChild(bone14_r1);
		setRotationAngle(bone14_r1, 1.2654F, 0.0F, 0.0F);
		bone14_r1.cubeList.add(new ModelBox(bone14_r1, 48, 52, -1.9F, -3.5F, -2.5F, 1, 4, 5, -0.3F, false));

		bone13_r2 = new ModelRenderer(this);
		bone13_r2.setRotationPoint(1.898F, 49.2946F, -29.7056F);
		bone13.addChild(bone13_r2);
		setRotationAngle(bone13_r2, -1.0472F, 0.0F, 0.0F);
		bone13_r2.cubeList.add(new ModelBox(bone13_r2, 48, 52, -1.9F, -3.5F, -2.5F, 1, 7, 5, -0.3F, false));
		...
		cube_r177_r1 = new ModelRenderer(this);
		cube_r177_r1.setRotationPoint(0.898F, 47.8472F, -15.254F);
		cube_r177.addChild(cube_r177_r1);
		setRotationAngle(cube_r177_r1, 0.5236F, 0.0F, 0.0F);
		cube_r177_r1.cubeList.add(new ModelBox(cube_r177_r1, 125, 26, -1.9F, -1.2723F, -0.5807F, 1, 2, 2, -0.3F, false));
		...
		cube_r179.cubeList.add(new ModelBox(cube_r179, 0, 23, -0.003F, 47.4896F, 1.6754F, 1, 4, 2, -0.3F, false));

		cube_r180_r1 = new ModelRenderer(this);
		cube_r180_r1.setRotationPoint(1.901F, 28.7775F, -19.091F);
		cube_r179.addChild(cube_r180_r1);
		setRotationAngle(cube_r180_r1, 0.4363F, 0.0F, 0.0F);
		cube_r180_r1.cubeList.add(new ModelBox(cube_r180_r1, 85, 46, -1.9F, 25.1594F, 3.6468F, 1, 2, 4, -0.3F, false));
		cube_r180_r1.cubeList.add(new ModelBox(cube_r180_r1, 89, 66, -1.9F, 23.8076F, 1.3154F, 1, 2, 7, -0.3F, false));
		...
		bone7.cubeList.add(new ModelBox(bone7, 68, 38, 4.0F, 42.6F, -35.7F, 2, 1, 2, -0.05F, false));
		bone7.cubeList.add(new ModelBox(bone7, 68, 38, 4.0F, 42.6F, -33.8F, 2, 1, 2, -0.05F, false));
		bone7.cubeList.add(new ModelBox(bone7, 68, 38, 4.0F, 42.6F, -32.5F, 2, 1, 2, -0.05F, false));
		bone7.cubeList.add(new ModelBox(bone7, 125, 80, 4.5F, 42.2F, -35.3F, 1, 1, 2, -0.2F, false));
		bone7.cubeList.add(new ModelBox(bone7, 63, 121, 4.5F, 41.1F, -35.3F, 1, 2, 2, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 134, 85, 4.5F, 40.95F, -1.75F, 1, 1, 2, -0.35F, false));
		bone7.cubeList.add(new ModelBox(bone7, 134, 129, 4.2F, 40.95F, -1.75F, 1, 1, 2, -0.35F, false));
		bone7.cubeList.add(new ModelBox(bone7, 134, 121, 4.8F, 40.95F, -1.75F, 1, 1, 2, -0.35F, false));
		bone7.cubeList.add(new ModelBox(bone7, 42, 123, 3.9F, 41.15F, -1.7F, 1, 2, 2, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 121, 99, 5.1F, 41.15F, -1.7F, 1, 2, 2, -0.4F, false));
		bone7.cubeList.add(new ModelBox(bone7, 23, 69, 4.0F, 42.3F, -1.8F, 2, 1, 2, -0.3F, false));
		bone7.cubeList.add(new ModelBox(bone7, 72, 6, 4.0F, 42.5F, -1.799F, 2, 1, 2, -0.3F, false));
		...
		cube_r189.cubeList.add(new ModelBox(cube_r189, 134, 109, 37.6889F, 36.6887F, -0.001F, 1, 1, 2, -0.4F, false));
		cube_r189.cubeList.add(new ModelBox(cube_r189, 134, 103, 37.4889F, 36.6887F, -0.001F, 1, 1, 2, -0.4F, false));
		...
		cube_r190.cubeList.add(new ModelBox(cube_r190, 134, 117, -38.6889F, 36.6887F, -0.001F, 1, 1, 2, -0.4F, false));
		cube_r190.cubeList.add(new ModelBox(cube_r190, 134, 114, -38.4889F, 36.6887F, -0.001F, 1, 1, 2, -0.4F, false));
		...
		cube_r191.cubeList.add(new ModelBox(cube_r191, 133, 80, -37.7589F, 37.6927F, -0.048F, 1, 1, 2, -0.35F, false));
		cube_r191.cubeList.add(new ModelBox(cube_r191, 58, 134, -37.7039F, 37.6937F, -0.049F, 1, 1, 2, -0.35F, false));
		...
		cube_r192.cubeList.add(new ModelBox(cube_r192, 134, 88, -37.8889F, 37.6887F, -0.001F, 1, 1, 2, -0.4F, false));
		cube_r192.cubeList.add(new ModelBox(cube_r192, 134, 91, -37.6889F, 37.6887F, -0.001F, 1, 1, 2, -0.4F, false));
		...
		cube_r193.cubeList.add(new ModelBox(cube_r193, 134, 97, 36.6889F, 37.6887F, -0.001F, 1, 1, 2, -0.4F, false));
		cube_r193.cubeList.add(new ModelBox(cube_r193, 134, 100, 36.8889F, 37.6887F, -0.001F, 1, 1, 2, -0.4F, false));
		...
		cube_r194.cubeList.add(new ModelBox(cube_r194, 125, 101, 36.7589F, 37.6927F, -0.048F, 1, 1, 2, -0.35F, false));
		cube_r194.cubeList.add(new ModelBox(cube_r194, 133, 76, 36.7039F, 37.6937F, -0.049F, 1, 1, 2, -0.35F, false));

		rails = new ModelRenderer(this);
		rails.setRotationPoint(0.0F, 45.45F, -25.2F);
		carryhandle2.addChild(rails);
		rails.cubeList.add(new ModelBox(rails, 11, 115, -2.0F, 0.3F, -0.6F, 2, 1, 27, -0.1F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 25.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 25.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 25.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 25.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 24.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 23.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 24.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 23.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 22.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 22.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 22.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 22.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 17.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 17.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 17.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 17.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 18.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 19.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 19.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 18.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 20.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 20.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 20.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 20.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 12.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 12.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 12.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 12.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 14.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 14.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 14.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 14.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 16.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 15.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 16.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 15.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 8.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 7.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 8.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 7.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 9.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 9.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 9.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 9.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 11.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 10.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 11.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 10.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 3.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 2.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 3.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 2.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 4.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 4.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 4.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 4.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 0.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, -0.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 0.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, -0.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, -0.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, -0.8F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 1.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 1.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 1.6F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 1.2F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 6.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -1.0F, -0.2F, 6.0F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 6.4F, 1, 1, 1, -0.301F, false));
		rails.cubeList.add(new ModelBox(rails, 190, 175, -2.0F, -0.2F, 6.0F, 1, 1, 1, -0.301F, false));

		cube_r149 = new ModelRenderer(this);
		cube_r149.setRotationPoint(-2.2F, 0.2F, 0.0F);
		rails.addChild(cube_r149);
		setRotationAngle(cube_r149, 0.0F, 0.0F, 0.2793F);
		

		cube_r150 = new ModelRenderer(this);
		cube_r150.setRotationPoint(0.2F, 0.2F, 0.0F);
		rails.addChild(cube_r150);
		setRotationAngle(cube_r150, 0.0F, 0.0F, -0.2793F);
		

		cube_r151 = new ModelRenderer(this);
		cube_r151.setRotationPoint(0.2F, 0.2F, 0.0F);
		rails.addChild(cube_r151);
		setRotationAngle(cube_r151, 0.5236F, 0.0F, -0.2793F);
		

		cube_r152 = new ModelRenderer(this);
		cube_r152.setRotationPoint(-2.2F, 0.2F, 0.0F);
		rails.addChild(cube_r152);
		setRotationAngle(cube_r152, 0.5236F, 0.0F, 0.2793F);
		

		cube_r195 = new ModelRenderer(this);
		cube_r195.setRotationPoint(-2.2F, 0.2F, -1.0F);
		rails.addChild(cube_r195);
		setRotationAngle(cube_r195, -0.4712F, 0.0F, 0.2793F);
		

		cube_r196 = new ModelRenderer(this);
		cube_r196.setRotationPoint(-0.5F, 4.4F, 27.0F);
		rails.addChild(cube_r196);
		setRotationAngle(cube_r196, 0.2269F, 0.0F, 0.0F);
		

		cube_r197 = new ModelRenderer(this);
		cube_r197.setRotationPoint(-1.7F, -0.5F, 7.3F);
		rails.addChild(cube_r197);
		setRotationAngle(cube_r197, 0.0F, 0.0F, 0.8029F);
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -0.9F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -1.3F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -5.7F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -6.1F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -8.1F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -7.7F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -7.3F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -2.5F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -2.9F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -4.5F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, -4.1F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 3.9F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 3.5F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 2.3F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 1.9F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 0.3F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 0.7F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 8.7F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 8.3F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 7.1F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 6.7F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 5.1F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 5.5F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 13.5F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 13.1F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 11.9F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 11.5F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 9.9F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 10.3F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 14.7F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 15.1F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 16.3F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 16.7F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 17.9F, 1, 1, 1, -0.302F, false));
		cube_r197.cubeList.add(new ModelBox(cube_r197, 190, 175, 0.1316F, 0.1168F, 18.3F, 1, 1, 1, -0.302F, false));

		cube_r198 = new ModelRenderer(this);
		cube_r198.setRotationPoint(-0.3F, -0.5F, 7.3F);
		rails.addChild(cube_r198);
		setRotationAngle(cube_r198, 0.0F, 0.0F, -0.8029F);
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -0.9F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -1.3F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -5.7F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -6.1F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -8.1F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -7.3F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -7.7F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -2.5F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -2.9F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -4.1F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, -4.5F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 3.9F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 3.5F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 2.3F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 1.9F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 0.7F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 0.3F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 8.7F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 8.3F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 7.1F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 6.7F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 5.5F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 5.1F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 13.5F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 13.1F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 11.9F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 11.5F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 10.3F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 9.9F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 15.1F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 14.7F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 16.7F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 16.3F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 17.9F, 1, 1, 1, -0.302F, false));
		cube_r198.cubeList.add(new ModelBox(cube_r198, 190, 175, -1.1316F, 0.1168F, 18.3F, 1, 1, 1, -0.302F, false));

		gun138 = new ModelRenderer(this);
		gun138.setRotationPoint(-3.25F, 2.55F, 12.0F);
		rails.addChild(gun138);
		setRotationAngle(gun138, -0.0873F, 0.0F, 0.0F);
		

		gun165 = new ModelRenderer(this);
		gun165.setRotationPoint(-3.25F, 3.05F, 17.95F);
		rails.addChild(gun165);
