...
public class QZS92silencer extends ModelBase {
	...
	public QZS92silencer() {
		textureWidth = 256;
		textureHeight = 256;

		suppressor = new ModelRenderer(this);
		suppressor.setRotationPoint(-1.0F, -18.1F, -89.8F);
		...
		cube_r10.cubeList.add(new ModelBox(cube_r10, 20, 133, -1.6904F, 1.6253F, 37.0F, 2, 2, 2, 0.05F, false));

		cube_r11 = new ModelRenderer(this);
		cube_r11.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone8.addChild(cube_r11);
		setRotationAngle(cube_r11, 0.0F, 0.0F, 0.4363F);
		cube_r11.cubeList.add(new ModelBox(cube_r11, 110, 133, -0.3096F, 1.6253F, 37.0F, 2, 2, 2, 0.051F, false));
		...
		cube_r12.cubeList.add(new ModelBox(cube_r12, 134, 36, 3.6253F, -1.6904F, 37.0F, 2, 2, 2, 0.052F, false));

		cube_r13 = new ModelRenderer(this);
		cube_r13.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone7.addChild(cube_r13);
		setRotationAngle(cube_r13, 0.0F, 0.0F, -0.4363F);
		cube_r13.cubeList.add(new ModelBox(cube_r13, 145, 108, 1.6253F, 1.6903F, 37.0F, 2, 2, 2, 0.05F, false));
		...
		cube_r14.cubeList.add(new ModelBox(cube_r14, 124, 133, -5.6253F, -1.6904F, 37.0F, 2, 2, 2, 0.05F, false));

		cube_r15 = new ModelRenderer(this);
		cube_r15.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone9.addChild(cube_r15);
		setRotationAngle(cube_r15, 0.0F, 0.0F, 0.4363F);
		cube_r15.cubeList.add(new ModelBox(cube_r15, 134, 32, -3.6253F, 1.6903F, 37.0F, 2, 2, 2, 0.052F, false));
		...
		cube_r16.cubeList.add(new ModelBox(cube_r16, 145, 112, 1.6904F, 3.6253F, 37.0F, 2, 2, 2, 0.051F, false));

		cube_r17 = new ModelRenderer(this);
		cube_r17.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone10.addChild(cube_r17);
		setRotationAngle(cube_r17, 0.0F, 0.0F, -0.4363F);
		cube_r17.cubeList.add(new ModelBox(cube_r17, 109, 157, -3.6904F, 3.6253F, 37.0F, 2, 2, 2, 0.05F, false));
		...
		cube_r34.cubeList.add(new ModelBox(cube_r34, 176, 20, -1.6904F, 2.6253F, 29.0F, 2, 1, 4, 0.2F, false));

		cube_r35 = new ModelRenderer(this);
		cube_r35.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone11.addChild(cube_r35);
		setRotationAngle(cube_r35, 0.0F, 0.0F, 0.4363F);
		cube_r35.cubeList.add(new ModelBox(cube_r35, 37, 176, -0.3096F, 2.6253F, 29.0F, 2, 1, 4, 0.2F, false));
		...
		cube_r36.cubeList.add(new ModelBox(cube_r36, 176, 10, 3.6253F, -1.6904F, 29.0F, 2, 1, 4, 0.2F, false));

		cube_r37 = new ModelRenderer(this);
		cube_r37.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone12.addChild(cube_r37);
		setRotationAngle(cube_r37, 0.0F, 0.0F, -0.4363F);
		cube_r37.cubeList.add(new ModelBox(cube_r37, 176, 15, 1.6253F, 1.6903F, 29.0F, 2, 1, 4, 0.2F, false));
		...
		bone24.addChild(cube_r38);
		setRotationAngle(cube_r38, 0.0F, 0.0F, -0.4363F);
		cube_r38.cubeList.add(new ModelBox(cube_r38, 176, 0, -5.6253F, -1.6904F, 29.0F, 2, 1, 4, 0.2F, false));

		cube_r39 = new ModelRenderer(this);
		cube_r39.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone24.addChild(cube_r39);
		setRotationAngle(cube_r39, 0.0F, 0.0F, 0.4363F);
		cube_r39.cubeList.add(new ModelBox(cube_r39, 176, 5, -3.6253F, 1.6903F, 29.0F, 2, 1, 4, 0.2F, false));
		...
		bone25.addChild(cube_r40);
		setRotationAngle(cube_r40, 0.0F, 0.0F, 0.4363F);
		cube_r40.cubeList.add(new ModelBox(cube_r40, 29, 174, 1.6904F, 3.6253F, 29.0F, 2, 1, 4, 0.2F, false));

		cube_r41 = new ModelRenderer(this);
		cube_r41.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone25.addChild(cube_r41);
		setRotationAngle(cube_r41, 0.0F, 0.0F, -0.4363F);
		cube_r41.cubeList.add(new ModelBox(cube_r41, 175, 162, -3.6904F, 3.6253F, 29.0F, 2, 1, 4, 0.2F, false));
		...
		cube_r81.cubeList.add(new ModelBox(cube_r81, 49, 21, 3.6253F, -1.6904F, 35.0F, 2, 1, 20, 0.05F, false));

		cube_r82 = new ModelRenderer(this);
		cube_r82.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone31.addChild(cube_r82);
		setRotationAngle(cube_r82, 0.0F, 0.0F, -0.4363F);
		cube_r82.cubeList.add(new ModelBox(cube_r82, 49, 47, 1.6253F, 1.6903F, 35.0F, 2, 1, 20, 0.05F, false));
		...
		cube_r83.cubeList.add(new ModelBox(cube_r83, 0, 46, -5.6253F, -1.6904F, 35.0F, 2, 1, 20, 0.05F, false));

		cube_r84 = new ModelRenderer(this);
		cube_r84.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone32.addChild(cube_r84);
		setRotationAngle(cube_r84, 0.0F, 0.0F, 0.4363F);
		cube_r84.cubeList.add(new ModelBox(cube_r84, 49, 0, -3.6253F, 1.6903F, 35.0F, 2, 1, 20, 0.05F, false));
		...
		cube_r85.cubeList.add(new ModelBox(cube_r85, 0, 0, 1.6904F, 3.6253F, 35.0F, 2, 1, 20, 0.05F, false));

		cube_r86 = new ModelRenderer(this);
		cube_r86.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone33.addChild(cube_r86);
		setRotationAngle(cube_r86, 0.0F, 0.0F, -0.4363F);
		cube_r86.cubeList.add(new ModelBox(cube_r86, 0, 21, -3.6904F, 3.6253F, 35.0F, 2, 1, 20, 0.05F, false));
	}
