...
public class QBZ03_Stock extends ModelBase {
	...
	public QBZ03_Stock() {
		...
		stock.cubeList.add(new ModelBox(stock, 15, 383, -4.0F, -38.0F, 5.0F, 2, 5, 2, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 317, 390, -4.7F, -38.0F, 5.0F, 1, 5, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 0, 397, -2.05F, -39.25F, 5.0F, 1, 1, 1, 0.0F, false));
		...
		folding.cubeList.add(new ModelBox(folding, 201, 224, -1.5F, -4.1531F, -10.0548F, 3, 2, 3, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 387, 349, -2.2071F, -3.446F, -10.0548F, 1, 2, 3, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 387, 343, 1.2071F, -3.446F, -10.0548F, 1, 2, 3, 0.0F, false));
		...
		folding.cubeList.add(new ModelBox(folding, 394, 312, -2.2071F, 1.954F, 6.8452F, 1, 1, 2, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 388, 61, -1.5F, 2.6611F, 6.8452F, 3, 1, 2, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 394, 304, 1.2071F, 1.954F, 6.8452F, 1, 1, 2, 0.0F, false));
		...
		folding.cubeList.add(new ModelBox(folding, 397, 192, -2.2071F, 0.954F, 9.6452F, 1, 1, 1, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 397, 189, 1.2071F, 0.954F, 9.6452F, 1, 1, 1, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 243, 382, -0.5F, 7.3438F, 14.0904F, 1, 2, 6, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 389, 65, -0.5F, 1.3438F, 9.7904F, 1, 4, 2, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 265, 370, -0.5F, -0.1318F, 10.2531F, 1, 2, 10, 0.0F, false));
		folding.cubeList.add(new ModelBox(folding, 305, 389, -0.5F, 1.6682F, 19.6531F, 1, 6, 1, 0.0F, false));

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(0.0F, -0.7714F, 8.5796F);
		folding.addChild(cube_r5);
		setRotationAngle(cube_r5, -0.7418F, 0.0F, 0.0F);
		cube_r5.cubeList.add(new ModelBox(cube_r5, 310, 390, -0.5F, -1.0F, 3.0F, 1, 2, 2, 0.0F, false));
		...
		cube_r7.cubeList.add(new ModelBox(cube_r7, 103, 383, -1.4571F, 0.6642F, -1.0F, 1, 1, 5, 0.0F, false));
		cube_r7.cubeList.add(new ModelBox(cube_r7, 258, 383, 0.6642F, -1.4571F, -1.0F, 1, 1, 5, 0.0F, false));

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(0.0F, 2.4649F, 9.3908F);
		folding.addChild(cube_r8);
		setRotationAngle(cube_r8, 0.4363F, 0.0F, 0.0F);
		cube_r8.cubeList.add(new ModelBox(cube_r8, 116, 383, -2.2071F, -0.8535F, -1.0F, 1, 1, 5, 0.0F, false));
		cube_r8.cubeList.add(new ModelBox(cube_r8, 371, 58, -1.5F, -0.1464F, -1.0F, 3, 1, 5, 0.0F, false));
		cube_r8.cubeList.add(new ModelBox(cube_r8, 271, 383, 1.2071F, -0.8535F, -1.0F, 1, 1, 5, 0.0F, false));

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(0.0F, 2.4469F, 6.0086F);
		folding.addChild(cube_r9);
		setRotationAngle(cube_r9, -0.1745F, 0.0F, 0.0F);
		cube_r9.cubeList.add(new ModelBox(cube_r9, 190, 368, -2.2071F, -0.8535F, -10.0F, 1, 1, 11, 0.0F, false));
		cube_r9.cubeList.add(new ModelBox(cube_r9, 350, 124, -1.5F, -0.1464F, -10.0F, 3, 1, 11, 0.0F, false));
		cube_r9.cubeList.add(new ModelBox(cube_r9, 364, 369, 1.2071F, -0.8535F, -10.0F, 1, 1, 11, 0.0F, false));
		...
		cube_r10.cubeList.add(new ModelBox(cube_r10, 215, 368, -1.4571F, 0.6642F, -10.0F, 1, 1, 11, 0.0F, false));
		cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 370, 0.6642F, -1.4571F, -10.0F, 1, 1, 11, 0.0F, false));

		cube_r11 = new ModelRenderer(this);
		cube_r11.setRotationPoint(0.0F, 2.8075F, 7.8452F);
		folding.addChild(cube_r11);
		setRotationAngle(cube_r11, 0.0F, 0.0F, 0.7854F);
		cube_r11.cubeList.add(new ModelBox(cube_r11, 394, 308, 0.6642F, -1.4571F, -1.0F, 1, 1, 2, 0.0F, false));
		cube_r11.cubeList.add(new ModelBox(cube_r11, 123, 395, -1.4571F, 0.6642F, -1.0F, 1, 1, 2, 0.0F, false));
		...
		cube_r15.cubeList.add(new ModelBox(cube_r15, 368, 382, -1.0F, -2.0F, -1.0F, 3, 2, 4, 0.0F, false));
		...
		cube_r16.cubeList.add(new ModelBox(cube_r16, 383, 300, 0.2071F, -1.2071F, -1.5F, 1, 1, 4, 0.0F, false));
		...
		cube_r17.cubeList.add(new ModelBox(cube_r17, 383, 306, -1.2071F, 0.2071F, -1.5F, 1, 1, 4, 0.0F, false));

		cube_r18 = new ModelRenderer(this);
		cube_r18.setRotationPoint(-1.5F, -3.446F, -9.0548F);
		folding.addChild(cube_r18);
		setRotationAngle(cube_r18, 0.0F, 0.0F, 0.7854F);
		cube_r18.cubeList.add(new ModelBox(cube_r18, 389, 30, -0.5F, -0.5F, -1.0F, 1, 1, 3, 0.0F, false));

		cube_r19 = new ModelRenderer(this);
		cube_r19.setRotationPoint(1.5F, -3.446F, -9.0548F);
		folding.addChild(cube_r19);
		setRotationAngle(cube_r19, 0.0F, 0.0F, 0.7854F);
		cube_r19.cubeList.add(new ModelBox(cube_r19, 59, 389, -0.5F, -0.5F, -1.0F, 1, 1, 3, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 386, 276, -1.5013F, -0.0427F, -1.0F, 3, 2, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 383, 312, -1.5013F, -10.6427F, -1.0F, 3, 3, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 394, 154, -0.8843F, -11.2718F, -1.0F, 1, 1, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 394, 300, -0.1027F, -11.2718F, -1.0F, 1, 1, 2, 0.0F, false));
		...
		cube_r22.cubeList.add(new ModelBox(cube_r22, 388, 57, -3.9976F, -0.9722F, 35.4657F, 3, 1, 2, 0.0F, false));
		...
		cube_r23.cubeList.add(new ModelBox(cube_r23, 343, 393, -1.6104F, -1.6104F, 35.4657F, 1, 1, 2, 0.0F, false));
		...
		cube_r24.cubeList.add(new ModelBox(cube_r24, 365, 389, -0.9722F, -3.9976F, 35.4657F, 1, 3, 2, 0.0F, false));
		...
		cube_r25.cubeList.add(new ModelBox(cube_r25, 59, 394, -1.6104F, -1.6104F, 35.4657F, 1, 1, 2, 0.0F, false));
		...
		cube_r26.cubeList.add(new ModelBox(cube_r26, 272, 393, -1.9976F, -0.9722F, 35.4657F, 1, 1, 2, 0.0F, false));
		...
		cube_r27.cubeList.add(new ModelBox(cube_r27, 296, 393, -0.9722F, -1.9976F, 35.4657F, 1, 1, 2, 0.0F, false));
		...
		cube_r28.cubeList.add(new ModelBox(cube_r28, 224, 393, -1.6104F, -1.6104F, 35.4657F, 1, 1, 2, 0.0F, false));
		...
		cube_r29.cubeList.add(new ModelBox(cube_r29, 231, 393, -1.6104F, -1.6104F, 35.4657F, 1, 1, 2, 0.0F, false));
	}
