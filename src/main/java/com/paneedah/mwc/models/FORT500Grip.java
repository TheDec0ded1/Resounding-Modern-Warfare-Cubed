...
public class FORT500Grip extends ModelBase {
	...
	public FORT500Grip() {
		...
		cube_r1.setRotationPoint(0.192F, -12.8806F, 25.0133F);
		stockPoliceMagnum.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.2618F, 0.0F, 0.0F);
		cube_r1.cubeList.add(new ModelBox(cube_r1, 245, 386, -2.775F, 9.25F, -1.0F, 1, 1, 3, 0.0F, false));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 245, 386, -0.625F, 9.25F, -1.0F, 1, 1, 3, 0.0F, false));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 245, 386, -2.775F, 7.25F, -1.0F, 1, 1, 3, 0.0F, false));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 245, 386, -0.625F, 7.25F, -1.0F, 1, 1, 3, 0.0F, false));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 245, 386, -2.775F, 5.25F, -1.0F, 1, 1, 3, 0.0F, false));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 245, 386, -0.625F, 5.25F, -1.0F, 1, 1, 3, 0.0F, false));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 246, 387, -2.775F, 3.25F, -1.0F, 1, 1, 2, 0.0F, false));
		cube_r1.cubeList.add(new ModelBox(cube_r1, 246, 387, -0.625F, 3.25F, -1.0F, 1, 1, 2, 0.0F, false));
		...
		stock23_r1.cubeList.add(new ModelBox(stock23_r1, 37, 71, -2.89F, -25.0949F, 14.8156F, 2, 5, 1, 0.0F, false));
		stock23_r1.cubeList.add(new ModelBox(stock23_r1, 79, 33, -1.1F, -25.0949F, 14.8156F, 2, 5, 1, 0.0F, false));
		...
		stock21_r1.cubeList.add(new ModelBox(stock21_r1, 121, 12, -2.9F, -26.0F, 15.6F, 2, 2, 4, 0.0F, false));
		stock21_r1.cubeList.add(new ModelBox(stock21_r1, 87, 100, -1.11F, -26.0F, 14.6F, 2, 2, 5, 0.0F, false));
		...
		stock2_r3.setRotationPoint(-2.4F, -17.2636F, 26.2496F);
		stockPoliceMagnum.addChild(stock2_r3);
		setRotationAngle(stock2_r3, -0.3249F, -0.2529F, -0.639F);
		stock2_r3.cubeList.add(new ModelBox(stock2_r3, 67, 57, -0.4F, 0.0F, -3.0F, 1, 1, 6, 0.1F, false));
		stock2_r3.cubeList.add(new ModelBox(stock2_r3, 72, 62, -0.4004F, -0.0003F, 2.7F, 1, 1, 1, 0.1F, false));
		...
		stock2_r4.setRotationPoint(0.4F, -17.2636F, 26.2496F);
		stockPoliceMagnum.addChild(stock2_r4);
		setRotationAngle(stock2_r4, -0.3249F, 0.2529F, 0.639F);
		stock2_r4.cubeList.add(new ModelBox(stock2_r4, 67, 68, -0.6F, 0.0F, -3.0F, 1, 1, 6, 0.1F, false));
		stock2_r4.cubeList.add(new ModelBox(stock2_r4, 72, 73, -0.6F, 0.0F, 2.7F, 1, 1, 1, 0.1F, false));

		stock2_r5 = new ModelRenderer(this);
		stock2_r5.setRotationPoint(0.0F, 2.5143F, -0.4142F);
		stockPoliceMagnum.addChild(stock2_r5);
		setRotationAngle(stock2_r5, -0.409F, 0.0F, 0.0F);
		stock2_r5.cubeList.add(new ModelBox(stock2_r5, 71, 9, -1.1F, -29.25F, 13.6F, 1, 1, 6, 0.0F, false));
		stock2_r5.cubeList.add(new ModelBox(stock2_r5, 71, 26, -1.9F, -29.25F, 13.6F, 1, 1, 6, 0.0F, false));
		stock2_r5.cubeList.add(new ModelBox(stock2_r5, 76, 31, -1.9003F, -29.2503F, 19.4F, 1, 1, 1, 0.0F, false));
		stock2_r5.cubeList.add(new ModelBox(stock2_r5, 76, 14, -1.1003F, -29.2503F, 19.4F, 1, 1, 1, 0.0F, false));
		...
		stock6_r1.cubeList.add(new ModelBox(stock6_r1, 27, 71, -2.0F, -24.0949F, 14.7156F, 2, 5, 2, 0.0F, false));
	}
