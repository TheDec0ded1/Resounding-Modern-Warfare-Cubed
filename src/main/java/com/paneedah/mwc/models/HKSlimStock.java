...
public class HKSlimStock extends ModelBase {
	...
	public HKSlimStock() {
		...
		gun417.cubeList.add(new ModelBox(gun417, 0, 46, 2.6F, 0.6F, 0.001F, 1, 2, 17, 0.0F, false));
		gun417.cubeList.add(new ModelBox(gun417, 0, 46, 1.4F, 0.6F, 0.001F, 1, 2, 17, 0.0F, false));
