...
public class RPK74MHandguard extends ModelBase {
	...
	public RPK74MHandguard() {
		...
		gun149.cubeList.add(new ModelBox(gun149, 57, 0, 0.0F, 2.0F, 0.0F, 5, 2, 12, 0.0F, false));
		...
		gun229.cubeList.add(new ModelBox(gun229, -1, 81, -1.0753F, -1.0458F, 0.0F, 1, 1, 12, 0.0F, false));
		...
		gun230.cubeList.add(new ModelBox(gun230, 59, 0, -1.0558F, 1.0655F, 0.0F, 1, 1, 12, 0.0F, false));
		...
		gun231.cubeList.add(new ModelBox(gun231, 61, 0, 1.0358F, -1.085F, 0.0F, 1, 1, 12, 0.0F, false));
		...
		gun242.cubeList.add(new ModelBox(gun242, 42, 22, 0.0F, 0.0F, 4.0F, 1, 1, 13, 0.0F, false));

		gun243 = new ModelRenderer(this);
		gun243.setRotationPoint(-4.2F, -11.6F, -53.5F);
		setRotationAngle(gun243, 0.0F, 0.0F, -0.7854F);
		gun243.cubeList.add(new ModelBox(gun243, 42, 4, 0.0F, 0.0F, 4.0F, 1, 1, 13, 0.0F, false));
		gun243.cubeList.add(new ModelBox(gun243, 42, 4, -1.2728F, 1.2728F, 4.0F, 1, 1, 13, 0.0F, false));

		gun244 = new ModelRenderer(this);
		gun244.setRotationPoint(-4.2F, -11.0F, -53.5F);
		setRotationAngle(gun244, 0.0F, 0.0F, -0.7854F);
		gun244.cubeList.add(new ModelBox(gun244, 23, 41, 0.0F, 0.0F, 4.0F, 1, 1, 13, 0.0F, false));
		gun244.cubeList.add(new ModelBox(gun244, 23, 41, -1.2728F, 1.2728F, 4.0F, 1, 1, 13, 0.0F, false));

		gun245 = new ModelRenderer(this);
		gun245.setRotationPoint(-4.2F, -10.4F, -53.5F);
		setRotationAngle(gun245, 0.0F, 0.0F, -0.7854F);
		gun245.cubeList.add(new ModelBox(gun245, 4, 40, 0.0F, 0.0F, 4.0F, 1, 1, 13, 0.0F, false));
		...
		gun248.cubeList.add(new ModelBox(gun248, 23, 23, 0.0F, 0.0F, 4.0F, 1, 1, 13, 0.0F, false));
		gun248.cubeList.add(new ModelBox(gun248, 23, 23, 1.6263F, -1.6264F, 4.0F, 1, 1, 13, 0.0F, false));

		gun249 = new ModelRenderer(this);
		gun249.setRotationPoint(1.2F, -11.6F, -53.5F);
		setRotationAngle(gun249, 0.0F, 0.0F, 2.3562F);
		gun249.cubeList.add(new ModelBox(gun249, 23, 5, 0.0F, 0.0F, 4.0F, 1, 1, 13, 0.0F, false));
		gun249.cubeList.add(new ModelBox(gun249, 23, 5, 1.6263F, -1.6264F, 4.0F, 1, 1, 13, 0.0F, false));

		gun250 = new ModelRenderer(this);
		gun250.setRotationPoint(1.2F, -11.0F, -53.5F);
		setRotationAngle(gun250, 0.0F, 0.0F, 2.3562F);
		gun250.cubeList.add(new ModelBox(gun250, 4, 22, 0.0F, 0.0F, 4.0F, 1, 1, 13, 0.0F, false));
