...
public class K1AG extends ModelBase {
	...
	public K1AG() {
		...
		Grip.cubeList.add(new ModelBox(Grip, 148, 20, -3.499F, -31.5598F, -5.3144F, 4, 3, 6, 0.0F, false));
		Grip.cubeList.add(new ModelBox(Grip, 123, 38, -3.5F, -31.7007F, -5.6818F, 4, 3, 1, 0.0F, false));
		...
		bone11.cubeList.add(new ModelBox(bone11, 200, 32, -2.001F, -7.1955F, -0.4447F, 4, 11, 5, 0.0F, false));

		bone12 = new ModelRenderer(this);
		bone12.setRotationPoint(-1.5F, -26.5F, -3.95F);
		Grip.addChild(bone12);
		setRotationAngle(bone12, -2.618F, 0.0F, 0.0F);
		bone12.cubeList.add(new ModelBox(bone12, 166, 92, -2.0F, -8.2282F, -2.6006F, 4, 11, 3, 0.0F, false));

		bone10 = new ModelRenderer(this);
		bone10.setRotationPoint(-1.5F, -27.0F, 1.3F);
		Grip.addChild(bone10);
		setRotationAngle(bone10, -2.4435F, 0.0F, 0.0F);
		bone10.cubeList.add(new ModelBox(bone10, 139, 45, -2.0F, -7.2282F, -0.6006F, 4, 9, 1, 0.0F, false));

		bone64 = new ModelRenderer(this);
		bone64.setRotationPoint(0.0F, 10.25F, -4.25F);
		Grip.addChild(bone64);
		bone64.cubeList.add(new ModelBox(bone64, 182, 100, -3.5F, -31.5598F, 3.9356F, 4, 3, 3, 0.0F, false));
		bone64.cubeList.add(new ModelBox(bone64, 176, 30, -3.499F, -32.8098F, 3.6856F, 4, 4, 3, 0.0F, false));

		bone9 = new ModelRenderer(this);
		bone9.setRotationPoint(-1.5F, -30.0F, 0.3F);
		Grip.addChild(bone9);
		setRotationAngle(bone9, 2.4871F, 0.0F, 0.0F);
		bone9.cubeList.add(new ModelBox(bone9, 226, 75, -2.0F, -1.2282F, -0.6006F, 4, 3, 3, 0.0F, false));
	}
