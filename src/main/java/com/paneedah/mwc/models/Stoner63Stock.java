...
public class Stoner63Stock extends ModelBase {
	...
	public Stoner63Stock() {
		textureWidth = 576;
		textureHeight = 576;

		stock = new ModelRenderer(this);
		stock.setRotationPoint(0.0F, -13.2087F, 38.1814F);
		stock.cubeList.add(new ModelBox(stock, 319, 547, -3.5F, 13.4971F, 0.268F, 4, 1, 3, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 434, 551, -3.499F, -3.1028F, -33.8816F, 4, 3, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 554, 464, -2.999F, -4.0028F, -33.8816F, 3, 1, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 216, 556, -2.999F, -4.0028F, -34.2816F, 3, 1, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 547, 117, -3.498F, -3.1028F, -34.2816F, 4, 8, 1, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 459, 69, -3.5F, -0.6538F, -28.1804F, 4, 5, 29, 0.0F, false));
		stock.cubeList.add(new ModelBox(stock, 458, 441, -3.0F, -1.5538F, -28.1804F, 3, 1, 32, 0.0F, false));
		...
		bone93.cubeList.add(new ModelBox(bone93, 27, 563, -1.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		bone93.cubeList.add(new ModelBox(bone93, 371, 563, -1.001F, 0.0F, -0.4F, 1, 1, 1, 0.0F, false));
		...
		bone94.cubeList.add(new ModelBox(bone94, 32, 563, 0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F, false));
		bone94.cubeList.add(new ModelBox(bone94, 563, 373, -0.001F, 0.0F, -0.4F, 1, 1, 1, 0.0F, false));
		...
		bone97.cubeList.add(new ModelBox(bone97, 458, 475, -1.0F, 0.0F, 0.0F, 1, 1, 32, 0.0F, false));
		...
		bone98.cubeList.add(new ModelBox(bone98, 381, 480, 0.0F, 0.0F, 0.0F, 1, 1, 32, 0.0F, false));

		bone12 = new ModelRenderer(this);
		bone12.setRotationPoint(0.0F, -3.9129F, -34.0743F);
		stock.addChild(bone12);
		setRotationAngle(bone12, -0.3927F, 0.0F, 0.0F);
		bone12.cubeList.add(new ModelBox(bone12, 530, 506, -3.5F, 0.4076F, 1.9617F, 4, 5, 6, 0.0F, false));
		bone12.cubeList.add(new ModelBox(bone12, 546, 551, -3.5F, 0.4076F, 0.9617F, 4, 2, 1, 0.0F, false));
		bone12.cubeList.add(new ModelBox(bone12, 182, 532, -3.0F, -0.5F, 1.0F, 3, 3, 7, 0.0F, false));
		...
		bone95.cubeList.add(new ModelBox(bone95, 377, 535, -1.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));
		...
		bone96.cubeList.add(new ModelBox(bone96, 394, 535, 0.0F, 0.0F, 0.0F, 1, 1, 7, 0.0F, false));
		...
		bone86.cubeList.add(new ModelBox(bone86, 393, 559, -0.5F, -0.75F, -0.5F, 1, 2, 1, 0.0F, false));

		bone13 = new ModelRenderer(this);
		bone13.setRotationPoint(0.0F, 0.0F, 0.0F);
		stock.addChild(bone13);
		setRotationAngle(bone13, -0.0873F, 0.0F, 0.0F);
		bone13.cubeList.add(new ModelBox(bone13, 257, 528, -3.5F, -1.185F, 0.4592F, 4, 15, 5, 0.0F, false));
		bone13.cubeList.add(new ModelBox(bone13, 502, 404, -3.501F, 4.251F, -18.5218F, 4, 5, 19, 0.0F, false));

		bone14 = new ModelRenderer(this);
		bone14.setRotationPoint(0.0F, -0.5F, 0.0F);
		stock.addChild(bone14);
		setRotationAngle(bone14, -0.7418F, 0.0F, 0.0F);
		bone14.cubeList.add(new ModelBox(bone14, 552, 432, -3.5F, -3.8949F, 2.9474F, 4, 1, 1, 0.0F, false));

		bone15 = new ModelRenderer(this);
		bone15.setRotationPoint(0.0F, -0.8801F, -0.6956F);
		stock.addChild(bone15);
		setRotationAngle(bone15, -0.1745F, 0.0F, 0.0F);
		bone15.cubeList.add(new ModelBox(bone15, 552, 435, -3.5F, -1.4474F, 4.3297F, 4, 1, 1, 0.0F, false));

		bone16 = new ModelRenderer(this);
		bone16.setRotationPoint(0.0F, 13.8699F, -0.9456F);
		stock.addChild(bone16);
		setRotationAngle(bone16, -1.309F, 0.0F, 0.0F);
		bone16.cubeList.add(new ModelBox(bone16, 552, 438, -3.5F, -4.9076F, 0.6964F, 4, 1, 1, 0.0F, false));
