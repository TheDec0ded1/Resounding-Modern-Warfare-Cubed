...
public class M16Mag extends ModelBase {
	...
	public M16Mag() {
		...
		gun1.cubeList.add(new ModelBox(gun1, 42, 42, -0.001F, 6.999F, -0.101F, 3, 3, 5, 0.0F, false));
		gun1.cubeList.add(new ModelBox(gun1, 43, 43, -0.001F, 9.999F, 1.099F, 3, 1, 4, 0.0F, false));
		gun1.cubeList.add(new ModelBox(gun1, 0, 0, 0.0F, 6.998F, 4.749F, 3, 4, 1, 0.0F, false));
		gun1.cubeList.add(new ModelBox(gun1, 16, 16, 0.5F, 6.999F, 4.999F, 2, 1, 1, 0.0F, false));

		gun2 = new ModelRenderer(this);
		gun2.setRotationPoint(1.0F, -2.0F, 1.0F);
		setRotationAngle(gun2, -1.7846F, 0.0F, 0.0F);
		gun2.cubeList.add(new ModelBox(gun2, 9, 9, 0.0F, 0.5449F, 0.9225F, 3, 5, 1, 0.0F, false));
		gun2.cubeList.add(new ModelBox(gun2, 9, 24, 0.0F, -0.4551F, 0.9225F, 3, 1, 1, 0.0F, false));
		...
		gun3.cubeList.add(new ModelBox(gun3, 4, 37, -0.099F, 7.0F, -0.1F, 1, 4, 1, 0.0F, false));
		gun3.cubeList.add(new ModelBox(gun3, 22, 16, -0.1F, 7.0F, -0.6F, 1, 4, 1, 0.0F, false));
		...
		gun4.cubeList.add(new ModelBox(gun4, 0, 37, 0.101F, 7.0F, -0.1F, 1, 4, 1, 0.0F, false));
		gun4.cubeList.add(new ModelBox(gun4, 6, 15, 0.1F, 7.0F, -0.6F, 1, 4, 1, 0.0F, false));
		gun4.cubeList.add(new ModelBox(gun4, 16, 0, -0.6F, 7.0F, 1.2F, 1, 4, 0, -0.2F, false));
		gun4.cubeList.add(new ModelBox(gun4, 0, 15, -2.6F, 6.8F, 1.0F, 2, 5, 1, -0.2F, false));
		gun4.cubeList.add(new ModelBox(gun4, 0, 15, -0.8F, 6.8F, 1.0F, 2, 5, 1, -0.2F, false));
		...
		gun6.setRotationPoint(3.2F, -9.7F, 1.8F);
		setRotationAngle(gun6, -1.7846F, 0.0F, 0.0F);
		gun6.cubeList.add(new ModelBox(gun6, 0, 8, 0.201F, -1.5431F, 8.7628F, 1, 6, 1, -0.2F, false));
		gun6.cubeList.add(new ModelBox(gun6, 16, 8, -2.599F, -1.5431F, 8.7628F, 1, 6, 1, -0.2F, false));
		...
		gun8.cubeList.add(new ModelBox(gun8, 34, 0, 0.0F, 7.0F, 0.0F, 1, 4, 1, 0.0F, false));
		gun8.cubeList.add(new ModelBox(gun8, 18, 27, 0.001F, 7.0F, 0.5F, 1, 4, 1, 0.0F, false));
		...
		gun9.cubeList.add(new ModelBox(gun9, 30, 27, 0.0F, 6.75F, 0.0F, 1, 4, 1, 0.0F, false));
		...
		gun11.cubeList.add(new ModelBox(gun11, 30, 0, 0.0F, 6.75F, 0.0F, 1, 4, 1, 0.0F, false));
		...
		gun13.cubeList.add(new ModelBox(gun13, 26, 27, 0.0F, 7.0F, 0.0F, 1, 4, 1, 0.0F, false));
		gun13.cubeList.add(new ModelBox(gun13, 14, 27, 0.001F, 7.0F, 0.5F, 1, 4, 1, 0.0F, false));
