...
public class AK47T1Grip extends ModelBase {
	...
	public AK47T1Grip() {
		...
		gun31.cubeList.add(new ModelBox(gun31, 38, 42, -0.1F, 6.0F, 2.0F, 1, 1, 1, 0.0F, false));
		gun31.cubeList.add(new ModelBox(gun31, 38, 42, 3.3F, 6.0F, 2.0F, 1, 1, 1, 0.0F, false));
		...
		grip.addChild(gun1);
		gun1.cubeList.add(new ModelBox(gun1, 2, 2, 0.0F, 0.0F, 0.0F, 4, 1, 7, 0.0F, false));
	}
