...
public class M16A2Stock extends ModelBase {
	...
	public M16A2Stock() {
		...
		m16stock.cubeList.add(new ModelBox(m16stock, 252, 210, -1.65F, -37.4F, 2.351F, 2, 2, 32, 0.001F, false));
		m16stock.cubeList.add(new ModelBox(m16stock, 224, 252, -3.35F, -37.4F, 2.352F, 2, 2, 32, 0.001F, false));
		...
		receiver16_r1.cubeList.add(new ModelBox(receiver16_r1, 292, 278, -0.001F, -1.4F, -0.0001F, 1, 1, 32, 0.0F, false));
		receiver16_r1.cubeList.add(new ModelBox(receiver16_r1, 156, 286, 0.0F, -1.0F, 0.0F, 2, 1, 32, 0.0F, false));
		...
		receiver19_r1.cubeList.add(new ModelBox(receiver19_r1, 226, 352, -3.001F, -0.0603F, 0.3421F, 3, 1, 23, 0.0F, false));
		...
		receiver18_r1.cubeList.add(new ModelBox(receiver18_r1, 356, 336, -3.0F, -0.0184F, 0.1908F, 3, 1, 9, 0.0F, false));
		...
		receiver23_r1.cubeList.add(new ModelBox(receiver23_r1, 424, 0, -0.0279F, 4.9859F, -29.8349F, 1, 5, 14, 0.0F, false));
		receiver23_r1.cubeList.add(new ModelBox(receiver23_r1, 428, 114, -0.0279F, 2.9859F, -15.8349F, 1, 8, 5, 0.0F, false));
		receiver23_r1.cubeList.add(new ModelBox(receiver23_r1, 70, 421, -0.0279F, 1.9859F, -10.8349F, 1, 10, 5, 0.0F, false));
		receiver23_r1.cubeList.add(new ModelBox(receiver23_r1, 64, 294, -0.0279F, 0.9859F, -5.8349F, 1, 12, 6, 0.0F, false));
		...
		receiver22_r1.cubeList.add(new ModelBox(receiver22_r1, 424, 19, -0.9721F, 4.9859F, -29.8349F, 1, 5, 14, 0.0F, false));
		receiver22_r1.cubeList.add(new ModelBox(receiver22_r1, 434, 264, -0.9721F, 2.9859F, -15.8349F, 1, 8, 5, 0.0F, false));
		receiver22_r1.cubeList.add(new ModelBox(receiver22_r1, 288, 421, -0.9721F, 1.9859F, -10.8349F, 1, 10, 5, 0.0F, false));
		receiver22_r1.cubeList.add(new ModelBox(receiver22_r1, 120, 402, -0.9721F, 0.9859F, -5.8349F, 1, 12, 6, 0.0F, false));
		...
		receiver21_r1.cubeList.add(new ModelBox(receiver21_r1, 226, 376, -0.0289F, 12.03F, -18.6335F, 1, 2, 22, 0.0F, false));
		...
		receiver20_r1.cubeList.add(new ModelBox(receiver20_r1, 378, 141, -0.9711F, 12.03F, -18.6335F, 1, 2, 22, 0.0F, false));
		...
		receiver19_r2.cubeList.add(new ModelBox(receiver19_r2, 150, 288, -0.0279F, 0.9859F, -0.835F, 2, 13, 1, 0.0F, false));
		...
		receiver18_r4.cubeList.add(new ModelBox(receiver18_r4, 78, 294, -1.9721F, 0.9859F, -0.835F, 2, 13, 1, 0.0F, false));
		...
		receiver19_r3.cubeList.add(new ModelBox(receiver19_r3, 0, 294, -0.0872F, 0.9962F, 0.0F, 1, 4, 31, 0.0F, false));
		...
		receiver18_r5.cubeList.add(new ModelBox(receiver18_r5, 292, 311, -0.9128F, 0.9962F, 0.0F, 1, 4, 31, 0.0F, false));
		...
		receiver16_r2.cubeList.add(new ModelBox(receiver16_r2, 224, 286, -2.0F, -1.0F, 0.0F, 2, 1, 32, 0.0F, false));
		receiver16_r2.cubeList.add(new ModelBox(receiver16_r2, 150, 319, -0.999F, -1.4F, -0.0001F, 1, 1, 32, 0.0F, false));
		...
		receiver17_r1.cubeList.add(new ModelBox(receiver17_r1, 84, 288, -1.4F, -0.001F, 0.0049F, 1, 2, 32, 0.0F, false));
		receiver17_r1.cubeList.add(new ModelBox(receiver17_r1, 216, 319, -1.0F, 0.0F, 0.002F, 1, 1, 32, 0.0F, false));
		...
		receiver17_r2.cubeList.add(new ModelBox(receiver17_r2, 320, 108, 0.0F, 0.0F, 0.0F, 1, 1, 32, 0.0F, false));
		receiver17_r2.cubeList.add(new ModelBox(receiver17_r2, 292, 244, 0.4F, -0.001F, 0.001F, 1, 2, 32, 0.0F, false));
	}
