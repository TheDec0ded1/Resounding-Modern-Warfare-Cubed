...
public class RK3 extends ModelBase {
	...
	public RK3() {
		...
		gun2.cubeList.add(new ModelBox(gun2, 47, 25, 0.0F, 0.0F, 0.0F, 4, 2, 2, 0.0F, false));

		gun3 = new ModelRenderer(this);
		gun3.setRotationPoint(-3.5F, -25.0F, -4.3F);
		rk3.addChild(gun3);
		setRotationAngle(gun3, -0.4856F, 0.0F, 0.0F);
		gun3.cubeList.add(new ModelBox(gun3, 47, 10, 0.0F, 0.0F, 0.0F, 4, 2, 2, 0.0F, false));
		...
		gun40_r1.cubeList.add(new ModelBox(gun40_r1, 77, 61, -4.0F, 0.0F, -2.0F, 4, 7, 2, 0.0F, false));

		gun5 = new ModelRenderer(this);
		gun5.setRotationPoint(-3.5F, -27.7F, -1.5F);
		rk3.addChild(gun5);
		setRotationAngle(gun5, 0.7041F, 0.0F, 0.0F);
		gun5.cubeList.add(new ModelBox(gun5, 95, 0, 0.001F, 1.0F, -1.0F, 4, 4, 2, 0.0F, false));
		...
		gun9.cubeList.add(new ModelBox(gun9, 77, 55, 0.001F, 0.0F, 0.0F, 4, 2, 1, 0.0F, false));

		gun8 = new ModelRenderer(this);
		gun8.setRotationPoint(-3.5F, -30.5F, -7.0F);
		rk3.addChild(gun8);
		gun8.cubeList.add(new ModelBox(gun8, 129, 88, 0.0F, 0.0F, 0.0F, 4, 4, 7, 0.0F, false));

		gun6 = new ModelRenderer(this);
		gun6.setRotationPoint(-3.5F, -15.5F, 3.0F);
		rk3.addChild(gun6);
		setRotationAngle(gun6, 2.491F, 0.0F, 0.0F);
		gun6.cubeList.add(new ModelBox(gun6, 95, 18, 0.001F, 0.0F, 0.0F, 4, 3, 2, 0.0F, false));

		gun7 = new ModelRenderer(this);
		gun7.setRotationPoint(-3.5F, -28.5F, -1.5F);
		rk3.addChild(gun7);
		setRotationAngle(gun7, 0.481F, 0.0F, 0.0F);
		gun7.cubeList.add(new ModelBox(gun7, 65, 75, -0.001F, 1.0F, 0.0F, 4, 3, 1, 0.0F, false));

		gun33 = new ModelRenderer(this);
		gun33.setRotationPoint(-3.5F, -17.5F, -1.0F);
		rk3.addChild(gun33);
		gun33.cubeList.add(new ModelBox(gun33, 138, 123, 0.0F, 0.0F, 0.0F, 4, 2, 4, 0.0F, false));
		...
		gun35.cubeList.add(new ModelBox(gun35, 0, 0, 0.002F, 0.0F, 0.0F, 4, 12, 5, 0.0F, false));

		gun1 = new ModelRenderer(this);
		gun1.setRotationPoint(-3.5F, -31.0F, -7.0F);
		rk3.addChild(gun1);
		gun1.cubeList.add(new ModelBox(gun1, 53, 93, 0.001F, 0.0F, -0.001F, 4, 1, 7, 0.0F, false));
	}
