...
public class M4RearSight extends ModelBase {
	...
	public M4RearSight() {
		...
		bone.cubeList.add(new ModelBox(bone, 6, 6, -2.5F, 13.0F, -6.0F, 7, 3, 14, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 58, 58, -4.0F, 13.2F, -6.0F, 10, 3, 10, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 0, 12, -2.49F, 9.0F, -6.0F, 7, 4, 1, 0.0F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 58, 199, 6.0F, 14.0F, -6.001F, 1, 2, 11, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 6, 50, -5.0F, 12.7F, -6.0F, 2, 4, 11, 0.0F, false));
		...
		bone14.cubeList.add(new ModelBox(bone14, 58, 129, -1.6464F, -0.3536F, 64.0F, 2, 1, 11, 0.0F, false));
		bone14.cubeList.add(new ModelBox(bone14, 131, 130, 0.7678F, 1.0607F, 64.0F, 1, 2, 11, 0.0F, false));
		...
		bone22.cubeList.add(new ModelBox(bone22, 94, 94, -1.0F, -10.0031F, 11.2365F, 4, 5, 5, 0.0F, false));
		bone22.cubeList.add(new ModelBox(bone22, 0, 23, 3.0F, -10.4697F, 10.653F, 2, 6, 6, 0.0F, false));
