...
public class TantalGrip extends ModelBase {
	...
	public TantalGrip() {
		...
		grip.addChild(gun10);
		gun10.cubeList.add(new ModelBox(gun10, 39, 14, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));
		...
		grip.addChild(gun8);
		gun8.cubeList.add(new ModelBox(gun8, 29, 9, 0.001F, 0.0F, -0.001F, 4, 4, 7, 0.0F, false));

		gun7 = new ModelRenderer(this);
		gun7.setRotationPoint(-3.5F, -18.8F, 4.2F);
		grip.addChild(gun7);
		setRotationAngle(gun7, -0.6692F, 0.0F, 0.0F);
		gun7.cubeList.add(new ModelBox(gun7, 37, 18, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));
		...
		gun5.cubeList.add(new ModelBox(gun5, 32, 10, 0.0F, 0.0F, 0.0F, 4, 12, 1, 0.0F, false));

		gun4 = new ModelRenderer(this);
		gun4.setRotationPoint(-3.5F, -17.5F, -1.0F);
		grip.addChild(gun4);
		gun4.cubeList.add(new ModelBox(gun4, 38, 11, 0.001F, 0.0F, 0.0F, 4, 2, 4, 0.0F, false));

		gun3 = new ModelRenderer(this);
		gun3.setRotationPoint(-3.5F, -30.0F, 2.0F);
		grip.addChild(gun3);
		setRotationAngle(gun3, -2.5281F, 0.0F, 0.0F);
		gun3.cubeList.add(new ModelBox(gun3, 20, 22, -0.001F, 0.0F, 0.0F, 4, 1, 3, 0.0F, false));
		...
		grip.addChild(gun1);
		gun1.cubeList.add(new ModelBox(gun1, 15, 10, 0.0F, 0.0F, 0.0F, 4, 1, 9, 0.0F, false));
	}
