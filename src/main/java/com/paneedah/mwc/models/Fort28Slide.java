...
public class Fort28Slide extends ModelWithAttachments {
	...
	public Fort28Slide() {
		...
		slide.cubeList.add(new ModelBox(slide, 13, 15, 0.0F, -1.5F, -19.55F, 1, 1, 3, 0.0F, false));
		slide.cubeList.add(new ModelBox(slide, 15, 17, 0.0F, -1.5F, -17.25F, 1, 1, 1, 0.0F, false));
		slide.cubeList.add(new ModelBox(slide, 75, 31, 4.2F, -1.5F, -19.55F, 1, 1, 2, -0.001F, false));
		...
		slide.cubeList.add(new ModelBox(slide, 14, 19, 1.42F, -2.92F, -19.55F, 2, 1, 1, 0.002F, false));
		slide.cubeList.add(new ModelBox(slide, 76, 29, 2.78F, -2.92F, -19.55F, 1, 1, 1, 0.003F, false));
		slide.cubeList.add(new ModelBox(slide, 14, 19, 1.42F, -2.92F, -18.55F, 2, 1, 1, 0.002F, false));
		slide.cubeList.add(new ModelBox(slide, 76, 29, 2.78F, -2.92F, -18.55F, 1, 1, 1, 0.003F, false));
		...
		cube_r5.cubeList.add(new ModelBox(cube_r5, 57, 77, -1.01F, 1.4F, -1.5F, 1, 1, 1, -0.1F, false));
		cube_r5.cubeList.add(new ModelBox(cube_r5, 16, 57, -1.01F, 0.0F, -1.5F, 1, 2, 1, -0.1F, false));
		cube_r5.cubeList.add(new ModelBox(cube_r5, 78, 66, -5.93F, 1.4F, -1.5F, 1, 1, 1, -0.1F, false));
		cube_r5.cubeList.add(new ModelBox(cube_r5, 73, 9, -5.93F, 0.0F, -1.5F, 1, 2, 1, -0.1F, false));
		...
		cube_r8.cubeList.add(new ModelBox(cube_r8, 47, 78, -5.73F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r8.cubeList.add(new ModelBox(cube_r8, 8, 72, -5.73F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		cube_r8.cubeList.add(new ModelBox(cube_r8, 44, 77, -1.21F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r8.cubeList.add(new ModelBox(cube_r8, 17, 65, -1.21F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		...
		cube_r9.cubeList.add(new ModelBox(cube_r9, 54, 71, -5.73F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		cube_r9.cubeList.add(new ModelBox(cube_r9, 30, 78, -5.73F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r9.cubeList.add(new ModelBox(cube_r9, 77, 34, -1.21F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r9.cubeList.add(new ModelBox(cube_r9, 69, 6, -1.21F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		...
		cube_r10.cubeList.add(new ModelBox(cube_r10, 78, 22, -5.73F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r10.cubeList.add(new ModelBox(cube_r10, 50, 71, -5.73F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		cube_r10.cubeList.add(new ModelBox(cube_r10, 33, 77, -1.21F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r10.cubeList.add(new ModelBox(cube_r10, 8, 69, -1.21F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		...
		cube_r11.cubeList.add(new ModelBox(cube_r11, 21, 71, -5.73F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		cube_r11.cubeList.add(new ModelBox(cube_r11, 78, 20, -5.73F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r11.cubeList.add(new ModelBox(cube_r11, 77, 27, -1.21F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r11.cubeList.add(new ModelBox(cube_r11, 69, 9, -1.21F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		...
		cube_r12.cubeList.add(new ModelBox(cube_r12, 17, 78, -5.73F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r12.cubeList.add(new ModelBox(cube_r12, 71, 18, -5.73F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		cube_r12.cubeList.add(new ModelBox(cube_r12, 27, 77, -1.21F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r12.cubeList.add(new ModelBox(cube_r12, 14, 69, -1.21F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		...
		cube_r13.cubeList.add(new ModelBox(cube_r13, 18, 69, -1.01F, -0.1336F, -1.6871F, 1, 2, 1, -0.3F, false));
		cube_r13.cubeList.add(new ModelBox(cube_r13, 20, 77, -1.01F, 1.2664F, -1.6871F, 1, 1, 1, -0.3F, false));
		cube_r13.cubeList.add(new ModelBox(cube_r13, 71, 15, -5.93F, -0.1336F, -1.6871F, 1, 2, 1, -0.3F, false));
		cube_r13.cubeList.add(new ModelBox(cube_r13, 78, 16, -5.93F, 1.2664F, -1.6871F, 1, 1, 1, -0.3F, false));
		cube_r13.cubeList.add(new ModelBox(cube_r13, 71, 15, -5.73F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		cube_r13.cubeList.add(new ModelBox(cube_r13, 78, 16, -5.73F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r13.cubeList.add(new ModelBox(cube_r13, 20, 77, -1.21F, -3.0462F, -23.8719F, 1, 1, 1, -0.3F, false));
		cube_r13.cubeList.add(new ModelBox(cube_r13, 18, 69, -1.21F, -4.4462F, -23.8719F, 1, 2, 1, -0.3F, false));
		...
		cube_r17.cubeList.add(new ModelBox(cube_r17, 31, 55, -1.0F, -2.0F, -23.05F, 1, 2, 2, 0.0F, false));
		...
		cube_r19.cubeList.add(new ModelBox(cube_r19, 76, 51, -1.0F, 0.5023F, -0.2837F, 1, 1, 1, -0.003F, false));
		cube_r19.cubeList.add(new ModelBox(cube_r19, 76, 48, -1.0F, -0.0977F, -0.2837F, 1, 1, 1, -0.002F, false));
		cube_r19.cubeList.add(new ModelBox(cube_r19, 78, 78, -5.2F, 0.5023F, -0.2837F, 1, 1, 1, -0.002F, false));
		cube_r19.cubeList.add(new ModelBox(cube_r19, 7, 79, -5.2F, -0.0977F, -0.2837F, 1, 1, 1, -0.001F, false));

		cube_r20 = new ModelRenderer(this);
		cube_r20.setRotationPoint(3.78F, -2.92F, 3.5F);
		slide.addChild(cube_r20);
		setRotationAngle(cube_r20, 0.2618F, 0.0F, 0.0F);
		cube_r20.cubeList.add(new ModelBox(cube_r20, 36, 24, -1.0F, 0.0F, -1.0F, 1, 1, 1, 0.001F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 11, 0, -0.65F, 0.45F, -1.1F, 1, 3, 1, 0.002F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 11, 0, 0.35F, 1.35F, -1.0F, 1, 2, 1, 0.002F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 17, 0, -2.71F, 0.45F, -1.1F, 1, 3, 1, 0.001F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 17, 0, -3.71F, 1.35F, -1.0F, 1, 2, 1, 0.001F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 54, 15, -2.36F, 0.0F, -1.0F, 2, 1, 1, 0.0F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 17, 0, -3.71F, 1.85F, -1.0F, 1, 2, 1, 0.001F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 11, 0, 0.35F, 1.85F, -1.0F, 1, 2, 1, 0.002F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 17, 0, -2.71F, 0.85F, -1.1F, 1, 3, 1, 0.001F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 54, 15, -2.36F, 0.85F, -1.2F, 2, 3, 1, 0.0F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 36, 24, -1.0F, 0.85F, -1.2F, 1, 3, 1, 0.001F, false));
		cube_r20.cubeList.add(new ModelBox(cube_r20, 11, 0, -0.65F, 0.85F, -1.1F, 1, 3, 1, 0.002F, false));
		...
		cube_r25.cubeList.add(new ModelBox(cube_r25, 67, 70, 0.0F, -2.0F, -23.05F, 1, 2, 1, 0.0F, false));
		cube_r25.cubeList.add(new ModelBox(cube_r25, 18, 73, 0.0F, -2.0F, -22.05F, 1, 2, 1, -0.001F, false));
