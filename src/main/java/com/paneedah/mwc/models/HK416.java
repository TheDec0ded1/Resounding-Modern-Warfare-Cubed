...
public class HK416 extends ModelWithAttachments {
	...
	public HK416() {
		...
		gun.cubeList.add(new ModelBox(gun, 21, 13, -3.5F, -28.0F, -21.2F, 4, 1, 3, 0.0F, false));
		...
		gun51_r1.setRotationPoint(-3.9F, -26.8F, -21.1F);
		gun.addChild(gun51_r1);
		setRotationAngle(gun51_r1, 1.4629F, 0.0F, 0.0F);
