...
public class RPK74MStock extends ModelBase {
	...
	public RPK74MStock() {
		...
		stock5.cubeList.add(new ModelBox(stock5, 28, 16, 0.0F, 0.3985F, 0.0349F, 2, 2, 1, 0.0F, false));

		stock6 = new ModelRenderer(this);
		stock6.setRotationPoint(-3.4F, -8.9F, 29.7F);
		setRotationAngle(stock6, -0.0873F, 0.0F, 0.0F);
		stock6.cubeList.add(new ModelBox(stock6, 51, 3, 0.0F, 0.3985F, 0.0349F, 3, 10, 2, 0.0F, false));

		stock7 = new ModelRenderer(this);
		stock7.setRotationPoint(-0.6F, -8.9F, 29.7F);
		setRotationAngle(stock7, -0.0873F, 0.0F, 0.0F);
		stock7.cubeList.add(new ModelBox(stock7, 28, 9, 0.0F, 0.3985F, 0.0359F, 1, 10, 2, 0.0F, false));

		stock8 = new ModelRenderer(this);
		stock8.setRotationPoint(-1.1F, -9.7F, 30.8F);
		setRotationAngle(stock8, -0.0873F, 0.0F, 0.0F);
		stock8.cubeList.add(new ModelBox(stock8, 29, 20, 0.0F, 0.3975F, 0.0359F, 1, 2, 1, 0.0F, false));
		...
		stock13.cubeList.add(new ModelBox(stock13, 30, 49, 0.0F, -4.0F, 0.0F, 4, 4, 2, 0.0F, false));

		stock14 = new ModelRenderer(this);
		stock14.setRotationPoint(-3.5F, -3.0F, 16.4F);
		setRotationAngle(stock14, 0.9515F, 0.0F, 0.0F);
		stock14.cubeList.add(new ModelBox(stock14, 30, 49, -0.001F, -4.0F, 0.0F, 4, 4, 2, 0.0F, false));
	}
