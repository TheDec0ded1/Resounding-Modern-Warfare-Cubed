...
public class SVDSHandguard extends ModelBase {
	...
	public SVDSHandguard() {
		...
		handguard.cubeList.add(new ModelBox(handguard, 49, 183, -2.15F, 2.05F, -76.1F, 1, 1, 35, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 94, 180, -1.85F, 2.05F, -76.1F, 1, 1, 35, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 144, 178, -1.85F, 1.75F, -76.1F, 1, 1, 35, 0.0F, false));
		...
		handguard.cubeList.add(new ModelBox(handguard, 144, 136, -2.0F, 2.2F, -76.1F, 1, 1, 35, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 143, 6, -2.0F, 1.6F, -76.1F, 1, 1, 35, 0.0F, false));
		...
		handguard.cubeList.add(new ModelBox(handguard, 142, 94, -2.15F, 1.75F, -76.1F, 1, 1, 35, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 142, 49, -1.7F, 1.9F, -76.1F, 1, 1, 35, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 6, 142, -2.3F, 1.9F, -76.1F, 1, 1, 35, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 54, 190, -1.65F, 2.25F, -80.0F, 1, 1, 4, -0.001F, false));
		handguard.cubeList.add(new ModelBox(handguard, 12, 190, -1.5F, 1.9F, -80.001F, 1, 1, 4, 0.001F, false));
		handguard.cubeList.add(new ModelBox(handguard, 98, 189, -1.65F, 1.55F, -80.0F, 1, 1, 4, -0.001F, false));
		handguard.cubeList.add(new ModelBox(handguard, 143, 186, -2.002F, 2.4F, -80.0F, 1, 1, 4, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 100, 167, -2.35F, 2.25F, -80.0F, 1, 1, 4, -0.001F, false));
		handguard.cubeList.add(new ModelBox(handguard, 55, 167, -2.5F, 1.9F, -80.001F, 1, 1, 4, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 12, 167, -2.35F, 1.55F, -80.0F, 1, 1, 4, -0.001F, false));
		handguard.cubeList.add(new ModelBox(handguard, 150, 161, -2.0F, 1.4F, -80.0F, 1, 1, 4, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 58, 0, -2.2F, -2.4F, -75.6F, 1, 2, 3, 0.0F, false));
		handguard.cubeList.add(new ModelBox(handguard, 13, 78, -2.2F, -1.4F, -75.6F, 1, 4, 1, 0.001F, false));
		handguard.cubeList.add(new ModelBox(handguard, 0, 78, -1.8F, -1.4F, -75.6F, 1, 4, 1, -0.001F, false));
		handguard.cubeList.add(new ModelBox(handguard, 0, 58, -1.8F, -2.4F, -75.6F, 1, 2, 3, 0.001F, false));
		...
		gun251_r1.cubeList.add(new ModelBox(gun251_r1, 121, 63, 0.0F, -8.5594F, 2.7815F, 1, 1, 5, 0.0F, false));
		gun251_r1.cubeList.add(new ModelBox(gun251_r1, 121, 71, -0.4F, -8.5594F, 2.7815F, 1, 1, 5, -0.001F, false));
