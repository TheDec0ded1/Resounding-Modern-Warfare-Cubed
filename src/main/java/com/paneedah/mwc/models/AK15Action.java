...
public class AK15Action extends ModelWithAttachments {
	...
	public AK15Action() {
		...
		action21.cubeList.add(new ModelBox(action21, 17, 59, 2.5028F, -4.999F, -1.4405F, 2, 1, 1, -0.2F, false));
		action21.cubeList.add(new ModelBox(action21, 17, 59, 2.5028F, -4.999F, -1.0405F, 2, 1, 1, -0.2F, false));
