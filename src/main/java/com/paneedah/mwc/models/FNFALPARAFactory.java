...
//            GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Attachments2.FNFALPHandguard, true, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
        .withCompatibleAttachment(Attachments2.FNFALIsraeliHandguard, (model) -> {
//            GL11.glTranslatef(0f, 0f, 1f);
        })
...
//            GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(Attachments2.FNFALParaStock, true, (model) -> {
//            GL11.glTranslatef(0.02f, 0.2f, -0.2f);
//            GL11.glScaled(1.2F, 1.2F, 1.2F);
        })
...
//            GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withCompatibleAttachment(Attachments2.FNFALGripWood, (model) -> {
//            GL11.glTranslatef(0.02f, 0.2f, -0.4f);
//            GL11.glScaled(1.2F, 1.2F, 1.2F);
        })
...
//            GL11.glTranslatef(0.9f, 3.8f, -3.5f);
        ...
        .withCompatibleAttachment(Magazines.FNFAL30Mag, (model) -> {
//        	GL11.glRotatef(35.000000f, 1f, 0f, 0f);
//        	GL11.glRotatef(-50.000000f, 0f, 0f, 1f);
//            GL11.glTranslatef(0.9f, 3.8f, -3.5f);
        })
        .withCompatibleAttachment(Magazines.FNFALL1A1Mag, (model) -> {
//        	GL11.glRotatef(35.000000f, 1f, 0f, 0f);
//        	GL11.glRotatef(-50.000000f, 0f, 0f, 1f);
//            GL11.glTranslatef(0.9f, 3.8f, -3.5f);
        })
        .withCompatibleAttachment(Attachments3.FNFALRearSights, true, (model) -> {
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning(
                ...
                .setupModernMagazineAnimations("fnfal", 
                		Magazines.FNFALMag, Magazines.FNFAL30Mag, Magazines.FNFALL1A1Mag)
