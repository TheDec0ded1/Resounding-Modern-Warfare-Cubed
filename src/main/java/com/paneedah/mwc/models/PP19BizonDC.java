...
public class PP19BizonDC extends ModelBase {
	...
	public PP19BizonDC() {
		...
		DustCover9.cubeList.add(new ModelBox(DustCover9, 127, 27, 0.0F, 0.5F, -7.0F, 1, 1, 2, 0.0F, false));
		...
		DustCover15.cubeList.add(new ModelBox(DustCover15, 147, 24, -0.001F, 0.0F, 8.0F, 1, 1, 3, 0.0F, false));
		...
		DustCover17.cubeList.add(new ModelBox(DustCover17, 141, 29, 0.0F, 0.0F, 8.0F, 1, 1, 4, 0.0F, false));
