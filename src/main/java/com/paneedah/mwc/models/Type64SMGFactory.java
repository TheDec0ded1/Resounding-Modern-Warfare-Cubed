...
public class Type64SMGFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Type64SMGAction, true, (model) -> {
        })
        .withCompatibleAttachment(Magazines.Type64SMGMag, (model) -> {
        })
        .withCompatibleAttachment(Magazines.Type64SMGMag2, (model) -> {
        })
...
//            GL11.glScaled(1.2F, 1.2F, 1.2F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withModel(new Type64SMG())
            .withActionPiece(AuxiliaryAttachments.Type64SMGAction)
            ...
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.Type64SMGAction.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, -1f);
                })

            .withFirstPersonCustomPositioning(AuxiliaryAttachments.Type64SMGAction.getRenderablePart(), (renderContext) -> {
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.Type64SMGAction.getRenderablePart(),
