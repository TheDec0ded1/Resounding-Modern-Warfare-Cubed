...
public class Type64SMGGrip extends ModelWithAttachments {
	...
	public Type64SMGGrip() {
		...
		grip.addChild(gun38);
		gun38.cubeList.add(new ModelBox(gun38, 74, 2, 0.0F, 0.0F, 0.0F, 1, 1, 2, 0.0F, false));
		...
		gun36.cubeList.add(new ModelBox(gun36, 6, 53, -0.001F, 0.0F, 0.0F, 1, 3, 2, 0.0F, false));

		gun35 = new ModelRenderer(this);
		gun35.setRotationPoint(-3.6F, -28.8F, -6.5F);
		grip.addChild(gun35);
		setRotationAngle(gun35, 0.4461F, 0.0F, 0.0F);
		gun35.cubeList.add(new ModelBox(gun35, 56, 8, 0.001F, 0.0F, 0.0F, 1, 3, 2, 0.0F, false));

		gun34 = new ModelRenderer(this);
		gun34.setRotationPoint(-3.6F, -29.8F, -6.5F);
		grip.addChild(gun34);
		gun34.cubeList.add(new ModelBox(gun34, 29, 11, 0.0F, 0.0F, 0.0F, 1, 1, 5, 0.0F, false));

		gun32 = new ModelRenderer(this);
		gun32.setRotationPoint(-0.4F, -27.5F, -5.9F);
		grip.addChild(gun32);
		setRotationAngle(gun32, 0.481F, 0.0F, 0.0F);
		gun32.cubeList.add(new ModelBox(gun32, 2, 47, 0.001F, 0.0F, 0.0F, 1, 13, 5, 0.0F, false));

		gun33 = new ModelRenderer(this);
		gun33.setRotationPoint(-0.4F, -29.8F, -6.5F);
		grip.addChild(gun33);
		gun33.cubeList.add(new ModelBox(gun33, 51, 5, 0.0F, 0.0F, 0.0F, 1, 1, 5, 0.0F, false));

		gun31 = new ModelRenderer(this);
		gun31.setRotationPoint(-3.6F, -27.5F, -5.9F);
		grip.addChild(gun31);
		setRotationAngle(gun31, 0.481F, 0.0F, 0.0F);
		gun31.cubeList.add(new ModelBox(gun31, 2, 48, -0.001F, 0.0F, 0.0F, 1, 13, 5, 0.0F, false));

		gun2 = new ModelRenderer(this);
		gun2.setRotationPoint(-3.5F, -29.2F, 0.67F);
		grip.addChild(gun2);
		setRotationAngle(gun2, -2.1564F, 0.0F, 0.0F);
		gun2.cubeList.add(new ModelBox(gun2, 150, 158, -0.002F, 0.0F, 0.0F, 4, 1, 2, 0.0F, false));

		gun3 = new ModelRenderer(this);
		gun3.setRotationPoint(-3.5F, -30.0F, -0.4F);
		grip.addChild(gun3);
		gun3.cubeList.add(new ModelBox(gun3, 50, 43, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		gun9 = new ModelRenderer(this);
		gun9.setRotationPoint(-3.5F, -26.5F, -7.0F);
		grip.addChild(gun9);
		setRotationAngle(gun9, 1.2269F, 0.0F, 0.0F);
		gun9.cubeList.add(new ModelBox(gun9, 30, 15, -0.001F, 0.0F, 0.0F, 4, 2, 1, 0.0F, false));

		gun8 = new ModelRenderer(this);
		gun8.setRotationPoint(-3.5F, -30.5F, -7.0F);
		grip.addChild(gun8);
		gun8.cubeList.add(new ModelBox(gun8, 24, 7, 0.001F, 0.0F, -0.001F, 4, 4, 7, 0.0F, false));

		gun7 = new ModelRenderer(this);
		gun7.setRotationPoint(-3.5F, -18.8F, 4.2F);
		grip.addChild(gun7);
		setRotationAngle(gun7, -0.6692F, 0.0F, 0.0F);
		gun7.cubeList.add(new ModelBox(gun7, 13, 43, 0.0F, 0.0F, 0.0F, 4, 1, 1, 0.0F, false));

		gun6 = new ModelRenderer(this);
		gun6.setRotationPoint(-3.5F, -15.5F, 3.0F);
		grip.addChild(gun6);
		setRotationAngle(gun6, 2.491F, 0.0F, 0.0F);
		gun6.cubeList.add(new ModelBox(gun6, 2, 60, 0.0F, 0.0F, 0.0F, 4, 3, 2, 0.0F, false));

		gun5 = new ModelRenderer(this);
		gun5.setRotationPoint(-3.5F, -28.5F, -1.5F);
		grip.addChild(gun5);
		setRotationAngle(gun5, 0.481F, 0.0F, 0.0F);
		gun5.cubeList.add(new ModelBox(gun5, 6, 53, 0.0F, 0.0F, 0.0F, 4, 12, 1, 0.0F, false));

		gun4 = new ModelRenderer(this);
		gun4.setRotationPoint(-3.5F, -17.5F, -1.0F);
		grip.addChild(gun4);
		gun4.cubeList.add(new ModelBox(gun4, 0, 53, 0.001F, 0.0F, 0.0F, 4, 2, 4, 0.0F, false));

		gun14 = new ModelRenderer(this);
		gun14.setRotationPoint(-3.5F, -30.0F, 2.0F);
		grip.addChild(gun14);
		setRotationAngle(gun14, -2.5281F, 0.0F, 0.0F);
		gun14.cubeList.add(new ModelBox(gun14, 1, 55, -0.001F, 0.0F, 0.0F, 4, 1, 3, 0.0F, false));

		gun15 = new ModelRenderer(this);
		gun15.setRotationPoint(-3.5F, -26.5F, -6.0F);
		grip.addChild(gun15);
		setRotationAngle(gun15, 0.481F, 0.0F, 0.0F);
		gun15.cubeList.add(new ModelBox(gun15, 25, 3, 0.0F, 0.0F, 0.0F, 4, 12, 5, 0.0F, false));

		gun1 = new ModelRenderer(this);
		gun1.setRotationPoint(-3.5F, -31.0F, -7.0F);
		grip.addChild(gun1);
		gun1.cubeList.add(new ModelBox(gun1, 128, 123, 0.0F, 0.0F, 0.0F, 4, 1, 9, 0.0F, false));
	}
