...
public class Dragunov20Mag extends ModelWithAttachments {
	...
	public Dragunov20Mag() {
		...
		cube_r101.cubeList.add(new ModelBox(cube_r101, 46, 57, -1.5F, -3.9507F, -2.6258F, 3, 4, 1, 0.001F, false));
		...
		cube_r106.cubeList.add(new ModelBox(cube_r106, 46, 47, -1.0F, 14.8153F, 1.3468F, 2, 8, 1, 0.001F, false));
		...
		cube_r107.cubeList.add(new ModelBox(cube_r107, 34, 66, -1.0F, 7.4125F, 1.7924F, 2, 5, 4, 0.2F, false));
		cube_r107.cubeList.add(new ModelBox(cube_r107, 138, 149, -1.0F, 7.4125F, 10.2924F, 2, 5, 2, 0.2F, false));

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-0.5F, -7.0F, 1.1F);
		mag.addChild(cube_r4);
		setRotationAngle(cube_r4, -0.0524F, 0.0F, 0.0F);
		cube_r4.cubeList.add(new ModelBox(cube_r4, 36, 68, -1.0F, 0.0F, 1.5F, 2, 10, 2, 0.2F, false));
		cube_r4.cubeList.add(new ModelBox(cube_r4, 138, 149, -1.0F, 0.0F, 8.0F, 2, 10, 2, 0.2F, false));
		...
		cube_r2.cubeList.add(new ModelBox(cube_r2, 36, 24, -1.0F, -3.9126F, -0.8315F, 1, 3, 1, 0.002F, false));
		cube_r2.cubeList.add(new ModelBox(cube_r2, 48, 20, -1.0F, -4.9126F, 1.8685F, 1, 4, 1, 0.002F, false));
		cube_r2.cubeList.add(new ModelBox(cube_r2, 71, 28, -3.2F, -4.9126F, 1.8685F, 1, 4, 1, 0.002F, false));
		cube_r2.cubeList.add(new ModelBox(cube_r2, 42, 24, -3.2F, -3.9126F, -0.8315F, 1, 3, 1, 0.002F, false));
		...
		cube_r3.cubeList.add(new ModelBox(cube_r3, 9, 0, -1.0F, -1.0F, 0.0F, 1, 1, 5, 0.003F, false));
		cube_r3.cubeList.add(new ModelBox(cube_r3, 78, 93, -3.2F, -1.0F, 0.0F, 1, 1, 5, 0.003F, false));
		...
		cube_r5.cubeList.add(new ModelBox(cube_r5, 48, 20, -2.0F, 5.4221F, 7.1174F, 3, 6, 5, 0.002F, false));
		cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 0, -1.5F, 5.4221F, 2.6174F, 2, 6, 1, 0.0F, false));
		cube_r5.cubeList.add(new ModelBox(cube_r5, 22, 24, -2.0F, 5.4221F, 13.1174F, 3, 6, 1, 0.002F, false));
		...
		cube_r114.cubeList.add(new ModelBox(cube_r114, 105, 82, 0.2447F, 13.8154F, -1.6667F, 1, 1, 4, 0.001F, false));
		cube_r114.cubeList.add(new ModelBox(cube_r114, 80, 9, 0.2447F, 12.2154F, -1.6667F, 1, 1, 4, 0.001F, false));
		...
		cube_r115.cubeList.add(new ModelBox(cube_r115, 53, 106, -1.2447F, 12.2154F, -1.6667F, 1, 1, 4, 0.001F, false));
		cube_r115.cubeList.add(new ModelBox(cube_r115, 69, 109, -1.2447F, 13.8154F, -1.6667F, 1, 1, 4, 0.001F, false));
		...
		bone.cubeList.add(new ModelBox(bone, 46, 57, -2.0F, -5.7033F, 6.726F, 3, 4, 1, 0.001F, false));
		bone.cubeList.add(new ModelBox(bone, 71, 28, -2.0F, -5.7033F, 1.926F, 3, 5, 5, 0.001F, false));

		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(0.0F, 0.0F, 0.0F);
		mag.addChild(bone2);
		setRotationAngle(bone2, -0.1745F, 0.0F, 0.0F);
		bone2.cubeList.add(new ModelBox(bone2, 22, 24, -2.0F, -3.1646F, 10.4216F, 3, 5, 1, 0.002F, false));

		bone3 = new ModelRenderer(this);
		bone3.setRotationPoint(0.0F, -14.0F, 0.6F);
		mag.addChild(bone3);
		setRotationAngle(bone3, -0.3054F, 0.0F, 0.0F);
		bone3.cubeList.add(new ModelBox(bone3, 112, 111, -1.5F, 13.6153F, 3.6468F, 2, 8, 1, 0.001F, false));
		bone3.cubeList.add(new ModelBox(bone3, 69, 101, -2.25F, 19.8153F, 7.2468F, 1, 1, 7, 0.001F, false));
		bone3.cubeList.add(new ModelBox(bone3, 69, 93, -2.25F, 18.2153F, 7.2468F, 1, 1, 7, 0.001F, false));
		bone3.cubeList.add(new ModelBox(bone3, 0, 102, 0.25F, 19.8153F, 7.2468F, 1, 1, 7, 0.001F, false));
		bone3.cubeList.add(new ModelBox(bone3, 21, 102, 0.25F, 18.2153F, 7.2468F, 1, 1, 7, 0.001F, false));
		bone3.cubeList.add(new ModelBox(bone3, 25, 0, -2.0F, 17.6153F, 7.1468F, 3, 4, 7, 0.001F, false));
		...
		cube_r104_r1.cubeList.add(new ModelBox(cube_r104_r1, 36, 24, 1.7553F, -7.9846F, -40.9167F, 1, 4, 4, 0.001F, false));
		...
		cube_r103_r1.cubeList.add(new ModelBox(cube_r103_r1, 56, 57, -5.7553F, -8.0846F, -40.9167F, 1, 4, 4, 0.001F, false));
	}
