...
import com.paneedah.weaponlib2.ai.*;
...
public class Entities {
    ...
    public static void init(CommonProxy commonProxy) {
        ...
        .withEquipmentOption(Guns.QBU88, EnumDifficulty.EASY, 0.1f, Magazines.QBU88Mag)
        .withEquipmentOption(Guns.QBZ03, EnumDifficulty.EASY, 0.1f, Magazines.QBZ03Mag)
        .withEquipmentOption(Guns.QBZ95, EnumDifficulty.EASY, 0.1f, Magazines.QBZ95Mag)
        .withEquipmentOption(Guns.QBZ95B, EnumDifficulty.EASY, 0.1f, Magazines.QBZ95Mag)
...
//        .withStepSound("step")
        ...
        .withAiTargetTask(1, e -> new EntityAIHurtByTarget((EntityCreature)e, true))
...
//        .withStepSound("step")
        ...
        new EntityConfiguration.Builder()
                ...
                .withBaseClass(EntityCustomMob.class)
                .withMaxHealth(80)
                .withEntityIdSupplier(() -> 10015)
                .withEquipmentOption(Guns.AK47, EnumDifficulty.EASY, 0.1f, Magazines.AK47Mag)
                .withEquipmentOption(Guns.AK47T1, EnumDifficulty.EASY, 0.001f, Magazines.AK47Mag)
                .withEquipmentOption(Guns.AK47T2, EnumDifficulty.EASY, 0.005f, Magazines.AK47Mag)
...
//        .withStepSound("step")
        ...
        new EntityConfiguration.Builder()
                .withName("swat_officer")
                .withBaseClass(EntityCustomMob.class)
                .withMaxHealth(80)
                .withEntityIdSupplier(() -> 10016)
                .withEquipmentOption(Guns.AK47, EnumDifficulty.EASY, 0.1f, Magazines.AK47Mag)
                .withEquipmentOption(Guns.AK47T1, EnumDifficulty.EASY, 0.001f, Magazines.AK47Mag)
                .withEquipmentOption(Guns.AK47T2, EnumDifficulty.EASY, 0.005f, Magazines.AK47Mag)
                .withEquipmentOption(Guns.AK74, EnumDifficulty.EASY, 0.1f, Magazines.AK74Mag)
                ...
                .withMaxTolerableLightBrightness(1f)
                .withSpawnEgg(0x5A674F, 0x464039)
                .withTexturedModelVariant("com.paneedah.mwc.models.SWAT_Officer", "swat_officer.png")
                .withHurtSound("hurt")
                .withAmbientSound("drawweapon")
//        .withStepSound("step")
                .withAiTask(1, e -> new EntityAISwimming(e))
